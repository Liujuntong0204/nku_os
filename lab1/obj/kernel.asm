...
void exception_handler(struct trapframe *tf) {
    ...
    802004d2:	b2250513          	addi	a0,a0,-1246 # 80200ff0 <etext+0x5c8>
    ...
    802004e2:	b3250513          	addi	a0,a0,-1230 # 80201010 <etext+0x5e8>
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    802005fc:	a3878793          	addi	a5,a5,-1480 # 80201030 <etext+0x608>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200658:	a10a8a93          	addi	s5,s5,-1520 # 80201064 <etext+0x63c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    80200660:	be4b8b93          	addi	s7,s7,-1052 # 80201240 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    ...
    802008b6:	7ae60613          	addi	a2,a2,1966 # 80201060 <etext+0x638>
    ...
    802008c8:	78c60613          	addi	a2,a2,1932 # 80201050 <etext+0x628>
    ...
    802008da:	77240413          	addi	s0,s0,1906 # 80201048 <etext+0x620>
    ...
    80200964:	6e840413          	addi	s0,s0,1768 # 80201048 <etext+0x620>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    ...
    8020097a:	6d3a0a13          	addi	s4,s4,1747 # 80201049 <etext+0x621>
