...
void exception_handler(struct trapframe *tf) {
    ...
    802004cc:	b2850513          	addi	a0,a0,-1240 # 80200ff0 <etext+0x5cc>
    ...
    802004dc:	b3850513          	addi	a0,a0,-1224 # 80201010 <etext+0x5ec>
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    802005f8:	a3c78793          	addi	a5,a5,-1476 # 80201030 <etext+0x60c>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200654:	a14a8a93          	addi	s5,s5,-1516 # 80201064 <etext+0x640>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    8020065c:	be8b8b93          	addi	s7,s7,-1048 # 80201240 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    ...
    802008b2:	7b260613          	addi	a2,a2,1970 # 80201060 <etext+0x63c>
    ...
    802008c4:	79060613          	addi	a2,a2,1936 # 80201050 <etext+0x62c>
    ...
    802008d6:	77640413          	addi	s0,s0,1910 # 80201048 <etext+0x624>
    ...
    80200960:	6ec40413          	addi	s0,s0,1772 # 80201048 <etext+0x624>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    ...
    80200976:	6d7a0a13          	addi	s4,s4,1751 # 80201049 <etext+0x625>
