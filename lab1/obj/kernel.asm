...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200428:	46a9                	li	a3,10
           ticks+=1;
    8020042a:	0785                	addi	a5,a5,1
    8020042c:	e31c                	sd	a5,0(a4)
           if(num==10)
    8020042e:	601c                	ld	a5,0(s0)
    80200430:	02d78e63          	beq	a5,a3,8020046c <interrupt_handler+0xa8>
           {
            sbi_shutdown();
           }
    ...
    8020043a:	02e7f7b3          	remu	a5,a5,a4
    8020043e:	cb99                	beqz	a5,80200454 <interrupt_handler+0x90>
            break;
        default:
            print_trapframe(tf);
            break;
    ...
    8020046a:	bfd9                	j	80200440 <interrupt_handler+0x7c>
}
...
void exception_handler(struct trapframe *tf) {
    ...
    8020048c:	02e79563          	bne	a5,a4,802004b6 <exception_handler+0x42>
             /* LAB1 CHALLENGE3   YOUR CODE : 2212422*/
    ...
    80200498:	bd9ff0ef          	jal	ra,80200070 <cprintf>
           cprintf("Illegal instruction caught at0x%08x\n", tf->epc);
    ...
    802004d6:	b9bff0ef          	jal	ra,80200070 <cprintf>
           cprintf(" ebreak caught at0x%08x\n", tf->epc);
