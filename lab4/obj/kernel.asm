...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	635040ef          	jal	ra,ffffffffc0204e7e <memset>
...
ffffffffc0200056:	e7e58593          	addi	a1,a1,-386 # ffffffffc0204ed0 <etext+0x4>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	e9650513          	addi	a0,a0,-362 # ffffffffc0204ef0 <etext+0x24>
...
ffffffffc02000ac:	e5050513          	addi	a0,a0,-432 # ffffffffc0204ef8 <etext+0x2c>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	10d040ef          	jal	ra,ffffffffc0204a80 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	0d7040ef          	jal	ra,ffffffffc0204a80 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	d3650513          	addi	a0,a0,-714 # ffffffffc0204f00 <etext+0x34>
void print_kerninfo(void) {
...
ffffffffc02001e4:	d4050513          	addi	a0,a0,-704 # ffffffffc0204f20 <etext+0x54>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	ce058593          	addi	a1,a1,-800 # ffffffffc0204ecc <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	d4c50513          	addi	a0,a0,-692 # ffffffffc0204f40 <etext+0x74>
...
ffffffffc020020c:	d5850513          	addi	a0,a0,-680 # ffffffffc0204f60 <etext+0x94>
...
ffffffffc0200220:	d6450513          	addi	a0,a0,-668 # ffffffffc0204f80 <etext+0xb4>
...
ffffffffc020024e:	d5650513          	addi	a0,a0,-682 # ffffffffc0204fa0 <etext+0xd4>
}
...
ffffffffc020025c:	d7860613          	addi	a2,a2,-648 # ffffffffc0204fd0 <etext+0x104>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	d8450513          	addi	a0,a0,-636 # ffffffffc0204fe8 <etext+0x11c>
void print_stackframe(void) {
...
ffffffffc0200278:	d8c60613          	addi	a2,a2,-628 # ffffffffc0205000 <etext+0x134>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	da458593          	addi	a1,a1,-604 # ffffffffc0205020 <etext+0x154>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	da450513          	addi	a0,a0,-604 # ffffffffc0205028 <etext+0x15c>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	da660613          	addi	a2,a2,-602 # ffffffffc0205038 <etext+0x16c>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	dc658593          	addi	a1,a1,-570 # ffffffffc0205060 <etext+0x194>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	d8650513          	addi	a0,a0,-634 # ffffffffc0205028 <etext+0x15c>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	dc260613          	addi	a2,a2,-574 # ffffffffc0205070 <etext+0x1a4>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	dda58593          	addi	a1,a1,-550 # ffffffffc0205090 <etext+0x1c4>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	d6a50513          	addi	a0,a0,-662 # ffffffffc0205028 <etext+0x15c>
...
ffffffffc02002fc:	da850513          	addi	a0,a0,-600 # ffffffffc02050a0 <etext+0x1d4>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	dae50513          	addi	a0,a0,-594 # ffffffffc02050c8 <etext+0x1fc>
...
ffffffffc0200348:	dac90913          	addi	s2,s2,-596 # ffffffffc02050f0 <etext+0x224>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	dac48493          	addi	s1,s1,-596 # ffffffffc02050f8 <etext+0x22c>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	daab0b13          	addi	s6,s6,-598 # ffffffffc0205100 <etext+0x234>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	cc2a0a13          	addi	s4,s4,-830 # ffffffffc0205020 <etext+0x154>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	2bd040ef          	jal	ra,ffffffffc0204e4a <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	2a9040ef          	jal	ra,ffffffffc0204e4a <strcmp>
...
ffffffffc02003e0:	289040ef          	jal	ra,ffffffffc0204e68 <strchr>
...
ffffffffc020041e:	24b040ef          	jal	ra,ffffffffc0204e68 <strchr>
...
ffffffffc020043c:	ce850513          	addi	a0,a0,-792 # ffffffffc0205120 <etext+0x254>
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	105040ef          	jal	ra,ffffffffc0204e90 <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	0e1040ef          	jal	ra,ffffffffc0204e90 <memcpy>
    return 0;
}
...
ffffffffc0200c2e:	38663603          	ld	a2,902(a2) # ffffffffc0206fb0 <nbase>
...
ffffffffc02016f4:	8c06b683          	ld	a3,-1856(a3) # ffffffffc0206fb0 <nbase>
...
ffffffffc0201968:	64c53503          	ld	a0,1612(a0) # ffffffffc0206fb0 <nbase>
...
ffffffffc0201bbe:	2c0030ef          	jal	ra,ffffffffc0204e7e <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	22e030ef          	jal	ra,ffffffffc0204e7e <memset>
    return page - pages + nbase;
...
ffffffffc0202352:	2e7020ef          	jal	ra,ffffffffc0204e38 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	2ed020ef          	jal	ra,ffffffffc0204e4a <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	26f020ef          	jal	ra,ffffffffc0204e02 <strlen>
...
ffffffffc0202e2c:	18860613          	addi	a2,a2,392 # ffffffffc0206fb0 <nbase>
...
ffffffffc0203cc2:	2f2a3a03          	ld	s4,754(s4) # ffffffffc0206fb0 <nbase>
...
ffffffffc0204080:	a9450513          	addi	a0,a0,-1388 # ffffffffc0206b10 <default_pmm_manager+0xef0>
...
ffffffffc0204092:	a3250513          	addi	a0,a0,-1486 # ffffffffc0206ac0 <default_pmm_manager+0xea0>
...
ffffffffc02040a2:	a9a50513          	addi	a0,a0,-1382 # ffffffffc0206b38 <default_pmm_manager+0xf18>
...
ffffffffc02040b2:	a4250513          	addi	a0,a0,-1470 # ffffffffc0206af0 <default_pmm_manager+0xed0>
...
ffffffffc02040e4:	a8060613          	addi	a2,a2,-1408 # ffffffffc0206b60 <default_pmm_manager+0xf40>
ffffffffc02040e8:	45b5                	li	a1,13
ffffffffc02040ea:	00003517          	auipc	a0,0x3
ffffffffc02040ee:	a9650513          	addi	a0,a0,-1386 # ffffffffc0206b80 <default_pmm_manager+0xf60>
...
ffffffffc020411e:	e9673703          	ld	a4,-362(a4) # ffffffffc0206fb0 <nbase>
...
ffffffffc0204158:	a4460613          	addi	a2,a2,-1468 # ffffffffc0206b98 <default_pmm_manager+0xf78>
ffffffffc020415c:	45d1                	li	a1,20
ffffffffc020415e:	00003517          	auipc	a0,0x3
ffffffffc0204162:	a2250513          	addi	a0,a0,-1502 # ffffffffc0206b80 <default_pmm_manager+0xf60>
...
ffffffffc0204174:	ae860613          	addi	a2,a2,-1304 # ffffffffc0205c58 <default_pmm_manager+0x38>
ffffffffc0204178:	00002517          	auipc	a0,0x2
ffffffffc020417c:	b0850513          	addi	a0,a0,-1272 # ffffffffc0205c80 <default_pmm_manager+0x60>
...
ffffffffc02041ac:	e0873703          	ld	a4,-504(a4) # ffffffffc0206fb0 <nbase>
...
ffffffffc02041e6:	9b660613          	addi	a2,a2,-1610 # ffffffffc0206b98 <default_pmm_manager+0xf78>
ffffffffc02041ea:	45e5                	li	a1,25
ffffffffc02041ec:	00003517          	auipc	a0,0x3
ffffffffc02041f0:	99450513          	addi	a0,a0,-1644 # ffffffffc0206b80 <default_pmm_manager+0xf60>
...
ffffffffc0204202:	a5a60613          	addi	a2,a2,-1446 # ffffffffc0205c58 <default_pmm_manager+0x38>
ffffffffc0204206:	00002517          	auipc	a0,0x2
ffffffffc020420a:	a7a50513          	addi	a0,a0,-1414 # ffffffffc0205c80 <default_pmm_manager+0x60>
...
ffffffffc0204214:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204216:	432000ef          	jal	ra,ffffffffc0204648 <do_exit>
...
ffffffffc0204250:	42f000ef          	jal	ra,ffffffffc0204e7e <memset>
...
ffffffffc020426e:	411000ef          	jal	ra,ffffffffc0204e7e <memset>
...
ffffffffc02042d8:	90c50513          	addi	a0,a0,-1780 # ffffffffc0206be0 <default_pmm_manager+0xfc0>
ffffffffc02042dc:	ea5fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02042e0:	00003517          	auipc	a0,0x3
ffffffffc02042e4:	91050513          	addi	a0,a0,-1776 # ffffffffc0206bf0 <default_pmm_manager+0xfd0>
...
ffffffffc020433c:	592000ef          	jal	ra,ffffffffc02048ce <switch_to>
    if (flag) {
...
ffffffffc020436c:	e84a                	sd	s2,16(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc020436e:	00011917          	auipc	s2,0x11
ffffffffc0204372:	25a90913          	addi	s2,s2,602 # ffffffffc02155c8 <nr_process>
ffffffffc0204376:	00092703          	lw	a4,0(s2)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc020437a:	f406                	sd	ra,40(sp)
ffffffffc020437c:	f022                	sd	s0,32(sp)
ffffffffc020437e:	ec26                	sd	s1,24(sp)
ffffffffc0204380:	e44e                	sd	s3,8(sp)
ffffffffc0204382:	e052                	sd	s4,0(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204384:	6785                	lui	a5,0x1
ffffffffc0204386:	1cf75563          	bge	a4,a5,ffffffffc0204550 <do_fork+0x1e6>
ffffffffc020438a:	84ae                	mv	s1,a1
ffffffffc020438c:	8a32                	mv	s4,a2
    if((proc = alloc_proc())==NULL)
ffffffffc020438e:	e8dff0ef          	jal	ra,ffffffffc020421a <alloc_proc>
ffffffffc0204392:	842a                	mv	s0,a0
ffffffffc0204394:	20050863          	beqz	a0,ffffffffc02045a4 <do_fork+0x23a>
    proc->parent=current;
ffffffffc0204398:	00011997          	auipc	s3,0x11
ffffffffc020439c:	21898993          	addi	s3,s3,536 # ffffffffc02155b0 <current>
ffffffffc02043a0:	0009b783          	ld	a5,0(s3)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043a4:	4509                	li	a0,2
    proc->parent=current;
ffffffffc02043a6:	f01c                	sd	a5,32(s0)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043a8:	e84fd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc02043ac:	1a050463          	beqz	a0,ffffffffc0204554 <do_fork+0x1ea>
    assert(current->mm == NULL);
ffffffffc02043b0:	0009b783          	ld	a5,0(s3)
        proc->kstack =page;
ffffffffc02043b4:	e808                	sd	a0,16(s0)
    assert(current->mm == NULL);
ffffffffc02043b6:	779c                	ld	a5,40(a5)
ffffffffc02043b8:	1e079863          	bnez	a5,ffffffffc02045a8 <do_fork+0x23e>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02043bc:	6789                	lui	a5,0x2
ffffffffc02043be:	ee078793          	addi	a5,a5,-288 # 1ee0 <kern_entry-0xffffffffc01fe120>
ffffffffc02043c2:	953e                	add	a0,a0,a5
    *(proc->tf) = *tf;
ffffffffc02043c4:	8652                	mv	a2,s4
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02043c6:	f048                	sd	a0,160(s0)
    *(proc->tf) = *tf;
ffffffffc02043c8:	87aa                	mv	a5,a0
ffffffffc02043ca:	120a0593          	addi	a1,s4,288
ffffffffc02043ce:	00063883          	ld	a7,0(a2)
ffffffffc02043d2:	00863803          	ld	a6,8(a2)
ffffffffc02043d6:	6a14                	ld	a3,16(a2)
ffffffffc02043d8:	6e18                	ld	a4,24(a2)
ffffffffc02043da:	0117b023          	sd	a7,0(a5)
ffffffffc02043de:	0107b423          	sd	a6,8(a5)
ffffffffc02043e2:	eb94                	sd	a3,16(a5)
ffffffffc02043e4:	ef98                	sd	a4,24(a5)
ffffffffc02043e6:	02060613          	addi	a2,a2,32
ffffffffc02043ea:	02078793          	addi	a5,a5,32
ffffffffc02043ee:	feb610e3          	bne	a2,a1,ffffffffc02043ce <do_fork+0x64>
    proc->tf->gpr.a0 = 0;
ffffffffc02043f2:	04053823          	sd	zero,80(a0)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc02043f6:	10048e63          	beqz	s1,ffffffffc0204512 <do_fork+0x1a8>
ffffffffc02043fa:	e904                	sd	s1,16(a0)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc02043fc:	00000797          	auipc	a5,0x0
ffffffffc0204400:	e8078793          	addi	a5,a5,-384 # ffffffffc020427c <forkret>
ffffffffc0204404:	f81c                	sd	a5,48(s0)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204406:	fc08                	sd	a0,56(s0)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204408:	100027f3          	csrr	a5,sstatus
ffffffffc020440c:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020440e:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204410:	10079f63          	bnez	a5,ffffffffc020452e <do_fork+0x1c4>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204414:	00006817          	auipc	a6,0x6
ffffffffc0204418:	c4480813          	addi	a6,a6,-956 # ffffffffc020a058 <last_pid.1>
ffffffffc020441c:	00082783          	lw	a5,0(a6)
ffffffffc0204420:	6709                	lui	a4,0x2
ffffffffc0204422:	0017851b          	addiw	a0,a5,1
ffffffffc0204426:	00a82023          	sw	a0,0(a6)
ffffffffc020442a:	06e55d63          	bge	a0,a4,ffffffffc02044a4 <do_fork+0x13a>
    if (last_pid >= next_safe) {
ffffffffc020442e:	00006317          	auipc	t1,0x6
ffffffffc0204432:	c2e30313          	addi	t1,t1,-978 # ffffffffc020a05c <next_safe.0>
ffffffffc0204436:	00032783          	lw	a5,0(t1)
ffffffffc020443a:	00011497          	auipc	s1,0x11
ffffffffc020443e:	0ee48493          	addi	s1,s1,238 # ffffffffc0215528 <proc_list>
ffffffffc0204442:	06f55963          	bge	a0,a5,ffffffffc02044b4 <do_fork+0x14a>
        proc->pid=get_pid();
ffffffffc0204446:	c048                	sw	a0,4(s0)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0204448:	45a9                	li	a1,10
ffffffffc020444a:	2501                	sext.w	a0,a0
ffffffffc020444c:	5b2000ef          	jal	ra,ffffffffc02049fe <hash32>
ffffffffc0204450:	02051793          	slli	a5,a0,0x20
ffffffffc0204454:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0204458:	0000d797          	auipc	a5,0xd
ffffffffc020445c:	0c078793          	addi	a5,a5,192 # ffffffffc0211518 <hash_list>
ffffffffc0204460:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0204462:	6510                	ld	a2,8(a0)
ffffffffc0204464:	0d840793          	addi	a5,s0,216
ffffffffc0204468:	6494                	ld	a3,8(s1)
        nr_process++;
ffffffffc020446a:	00092703          	lw	a4,0(s2)
    prev->next = next->prev = elm;
ffffffffc020446e:	e21c                	sd	a5,0(a2)
ffffffffc0204470:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc0204472:	f070                	sd	a2,224(s0)
        list_add(&proc_list,&(proc->list_link));
ffffffffc0204474:	0c840793          	addi	a5,s0,200
    elm->prev = prev;
ffffffffc0204478:	ec68                	sd	a0,216(s0)
    prev->next = next->prev = elm;
ffffffffc020447a:	e29c                	sd	a5,0(a3)
        nr_process++;
ffffffffc020447c:	2705                	addiw	a4,a4,1
ffffffffc020447e:	e49c                	sd	a5,8(s1)
    elm->next = next;
ffffffffc0204480:	e874                	sd	a3,208(s0)
    elm->prev = prev;
ffffffffc0204482:	e464                	sd	s1,200(s0)
ffffffffc0204484:	00e92023          	sw	a4,0(s2)
    if (flag) {
ffffffffc0204488:	0a099763          	bnez	s3,ffffffffc0204536 <do_fork+0x1cc>
    wakeup_proc(proc);
ffffffffc020448c:	8522                	mv	a0,s0
ffffffffc020448e:	4aa000ef          	jal	ra,ffffffffc0204938 <wakeup_proc>
    ret = proc->pid;
ffffffffc0204492:	4048                	lw	a0,4(s0)
}  
ffffffffc0204494:	70a2                	ld	ra,40(sp)
ffffffffc0204496:	7402                	ld	s0,32(sp)
ffffffffc0204498:	64e2                	ld	s1,24(sp)
ffffffffc020449a:	6942                	ld	s2,16(sp)
ffffffffc020449c:	69a2                	ld	s3,8(sp)
ffffffffc020449e:	6a02                	ld	s4,0(sp)
ffffffffc02044a0:	6145                	addi	sp,sp,48
ffffffffc02044a2:	8082                	ret
        last_pid = 1;
ffffffffc02044a4:	4785                	li	a5,1
ffffffffc02044a6:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02044aa:	4505                	li	a0,1
ffffffffc02044ac:	00006317          	auipc	t1,0x6
ffffffffc02044b0:	bb030313          	addi	t1,t1,-1104 # ffffffffc020a05c <next_safe.0>
    return listelm->next;
ffffffffc02044b4:	00011497          	auipc	s1,0x11
ffffffffc02044b8:	07448493          	addi	s1,s1,116 # ffffffffc0215528 <proc_list>
ffffffffc02044bc:	0084be03          	ld	t3,8(s1)
        next_safe = MAX_PID;
ffffffffc02044c0:	6789                	lui	a5,0x2
ffffffffc02044c2:	00f32023          	sw	a5,0(t1)
ffffffffc02044c6:	86aa                	mv	a3,a0
ffffffffc02044c8:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc02044ca:	6e89                	lui	t4,0x2
ffffffffc02044cc:	069e0d63          	beq	t3,s1,ffffffffc0204546 <do_fork+0x1dc>
ffffffffc02044d0:	88ae                	mv	a7,a1
ffffffffc02044d2:	87f2                	mv	a5,t3
ffffffffc02044d4:	6609                	lui	a2,0x2
ffffffffc02044d6:	a811                	j	ffffffffc02044ea <do_fork+0x180>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc02044d8:	00e6d663          	bge	a3,a4,ffffffffc02044e4 <do_fork+0x17a>
ffffffffc02044dc:	00c75463          	bge	a4,a2,ffffffffc02044e4 <do_fork+0x17a>
ffffffffc02044e0:	863a                	mv	a2,a4
ffffffffc02044e2:	4885                	li	a7,1
ffffffffc02044e4:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02044e6:	00978d63          	beq	a5,s1,ffffffffc0204500 <do_fork+0x196>
            if (proc->pid == last_pid) {
ffffffffc02044ea:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc02044ee:	fee695e3          	bne	a3,a4,ffffffffc02044d8 <do_fork+0x16e>
                if (++ last_pid >= next_safe) {
ffffffffc02044f2:	2685                	addiw	a3,a3,1
ffffffffc02044f4:	04c6d463          	bge	a3,a2,ffffffffc020453c <do_fork+0x1d2>
ffffffffc02044f8:	679c                	ld	a5,8(a5)
ffffffffc02044fa:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc02044fc:	fe9797e3          	bne	a5,s1,ffffffffc02044ea <do_fork+0x180>
ffffffffc0204500:	c581                	beqz	a1,ffffffffc0204508 <do_fork+0x19e>
ffffffffc0204502:	00d82023          	sw	a3,0(a6)
ffffffffc0204506:	8536                	mv	a0,a3
ffffffffc0204508:	f2088fe3          	beqz	a7,ffffffffc0204446 <do_fork+0xdc>
ffffffffc020450c:	00c32023          	sw	a2,0(t1)
ffffffffc0204510:	bf1d                	j	ffffffffc0204446 <do_fork+0xdc>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204512:	84aa                	mv	s1,a0
ffffffffc0204514:	e904                	sd	s1,16(a0)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204516:	00000797          	auipc	a5,0x0
ffffffffc020451a:	d6678793          	addi	a5,a5,-666 # ffffffffc020427c <forkret>
ffffffffc020451e:	f81c                	sd	a5,48(s0)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204520:	fc08                	sd	a0,56(s0)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204522:	100027f3          	csrr	a5,sstatus
ffffffffc0204526:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204528:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020452a:	ee0785e3          	beqz	a5,ffffffffc0204414 <do_fork+0xaa>
        intr_disable();
ffffffffc020452e:	894fc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204532:	4985                	li	s3,1
ffffffffc0204534:	b5c5                	j	ffffffffc0204414 <do_fork+0xaa>
        intr_enable();
ffffffffc0204536:	886fc0ef          	jal	ra,ffffffffc02005bc <intr_enable>
ffffffffc020453a:	bf89                	j	ffffffffc020448c <do_fork+0x122>
                    if (last_pid >= MAX_PID) {
...
ffffffffc0204544:	b761                	j	ffffffffc02044cc <do_fork+0x162>
ffffffffc0204546:	cda1                	beqz	a1,ffffffffc020459e <do_fork+0x234>
ffffffffc0204548:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc020454c:	8536                	mv	a0,a3
ffffffffc020454e:	bde5                	j	ffffffffc0204446 <do_fork+0xdc>
    int ret = -E_NO_FREE_PROC;
ffffffffc0204550:	556d                	li	a0,-5
ffffffffc0204552:	b789                	j	ffffffffc0204494 <do_fork+0x12a>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc0204554:	6814                	ld	a3,16(s0)
    return pa2page(PADDR(kva));
ffffffffc0204556:	c02007b7          	lui	a5,0xc0200
ffffffffc020455a:	08f6e363          	bltu	a3,a5,ffffffffc02045e0 <do_fork+0x276>
ffffffffc020455e:	00011797          	auipc	a5,0x11
ffffffffc0204562:	0227b783          	ld	a5,34(a5) # ffffffffc0215580 <va_pa_offset>
ffffffffc0204566:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc020456a:	83b1                	srli	a5,a5,0xc
ffffffffc020456c:	00011717          	auipc	a4,0x11
ffffffffc0204570:	ffc73703          	ld	a4,-4(a4) # ffffffffc0215568 <npage>
ffffffffc0204574:	04e7fa63          	bgeu	a5,a4,ffffffffc02045c8 <do_fork+0x25e>
    return &pages[PPN(pa) - nbase];
ffffffffc0204578:	00003717          	auipc	a4,0x3
ffffffffc020457c:	a3873703          	ld	a4,-1480(a4) # ffffffffc0206fb0 <nbase>
ffffffffc0204580:	8f99                	sub	a5,a5,a4
ffffffffc0204582:	079a                	slli	a5,a5,0x6
ffffffffc0204584:	00011517          	auipc	a0,0x11
ffffffffc0204588:	fec53503          	ld	a0,-20(a0) # ffffffffc0215570 <pages>
ffffffffc020458c:	953e                	add	a0,a0,a5
ffffffffc020458e:	4589                	li	a1,2
ffffffffc0204590:	d2efd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    kfree(proc);
ffffffffc0204594:	8522                	mv	a0,s0
ffffffffc0204596:	b68fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc020459a:	5571                	li	a0,-4
    goto fork_out;
ffffffffc020459c:	bde5                	j	ffffffffc0204494 <do_fork+0x12a>
    return last_pid;
ffffffffc020459e:	00082503          	lw	a0,0(a6)
ffffffffc02045a2:	b555                	j	ffffffffc0204446 <do_fork+0xdc>
    ret = -E_NO_MEM;
ffffffffc02045a4:	5571                	li	a0,-4
    return ret;
ffffffffc02045a6:	b5fd                	j	ffffffffc0204494 <do_fork+0x12a>
    assert(current->mm == NULL);
ffffffffc02045a8:	00002697          	auipc	a3,0x2
ffffffffc02045ac:	66868693          	addi	a3,a3,1640 # ffffffffc0206c10 <default_pmm_manager+0xff0>
ffffffffc02045b0:	00001617          	auipc	a2,0x1
ffffffffc02045b4:	2c060613          	addi	a2,a2,704 # ffffffffc0205870 <commands+0x738>
ffffffffc02045b8:	10800593          	li	a1,264
ffffffffc02045bc:	00002517          	auipc	a0,0x2
ffffffffc02045c0:	66c50513          	addi	a0,a0,1644 # ffffffffc0206c28 <default_pmm_manager+0x1008>
ffffffffc02045c4:	e83fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02045c8:	00001617          	auipc	a2,0x1
ffffffffc02045cc:	76060613          	addi	a2,a2,1888 # ffffffffc0205d28 <default_pmm_manager+0x108>
ffffffffc02045d0:	06200593          	li	a1,98
ffffffffc02045d4:	00001517          	auipc	a0,0x1
ffffffffc02045d8:	6ac50513          	addi	a0,a0,1708 # ffffffffc0205c80 <default_pmm_manager+0x60>
ffffffffc02045dc:	e6bfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return pa2page(PADDR(kva));
ffffffffc02045e0:	00001617          	auipc	a2,0x1
ffffffffc02045e4:	72060613          	addi	a2,a2,1824 # ffffffffc0205d00 <default_pmm_manager+0xe0>
ffffffffc02045e8:	06e00593          	li	a1,110
ffffffffc02045ec:	00001517          	auipc	a0,0x1
ffffffffc02045f0:	69450513          	addi	a0,a0,1684 # ffffffffc0205c80 <default_pmm_manager+0x60>
ffffffffc02045f4:	e53fb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc020460e:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204610:	06f000ef          	jal	ra,ffffffffc0204e7e <memset>
...
ffffffffc0204630:	be678793          	addi	a5,a5,-1050 # ffffffffc0204212 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204634:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0204636:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204638:	d33ff0ef          	jal	ra,ffffffffc020436a <do_fork>
}
...
ffffffffc020464e:	5f660613          	addi	a2,a2,1526 # ffffffffc0206c40 <default_pmm_manager+0x1020>
ffffffffc0204652:	16d00593          	li	a1,365
ffffffffc0204656:	00002517          	auipc	a0,0x2
ffffffffc020465a:	5d250513          	addi	a0,a0,1490 # ffffffffc0206c28 <default_pmm_manager+0x1008>
do_exit(int error_code) {
ffffffffc020465e:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc0204660:	de7fb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc0204698:	b83ff0ef          	jal	ra,ffffffffc020421a <alloc_proc>
...
ffffffffc02046b0:	99efd0ef          	jal	ra,ffffffffc020184e <kmalloc>
...
ffffffffc02046ba:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046bc:	7c2000ef          	jal	ra,ffffffffc0204e7e <memset>
...
ffffffffc02046ce:	7da000ef          	jal	ra,ffffffffc0204ea8 <memcmp>
ffffffffc02046d2:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc02046d4:	453d                	li	a0,15
ffffffffc02046d6:	978fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
...
ffffffffc02046de:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02046e0:	79e000ef          	jal	ra,ffffffffc0204e7e <memset>
...
ffffffffc02046f0:	7b8000ef          	jal	ra,ffffffffc0204ea8 <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc02046f4:	00093783          	ld	a5,0(s2)
ffffffffc02046f8:	00011717          	auipc	a4,0x11
ffffffffc02046fc:	e6073703          	ld	a4,-416(a4) # ffffffffc0215558 <boot_cr3>
...
ffffffffc0204722:	75c000ef          	jal	ra,ffffffffc0204e7e <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204726:	463d                	li	a2,15
ffffffffc0204728:	00002597          	auipc	a1,0x2
ffffffffc020472c:	56058593          	addi	a1,a1,1376 # ffffffffc0206c88 <default_pmm_manager+0x1068>
ffffffffc0204730:	8522                	mv	a0,s0
ffffffffc0204732:	75e000ef          	jal	ra,ffffffffc0204e90 <memcpy>
...
ffffffffc020474c:	54858593          	addi	a1,a1,1352 # ffffffffc0206c90 <default_pmm_manager+0x1070>
ffffffffc0204750:	00000517          	auipc	a0,0x0
ffffffffc0204754:	b3a50513          	addi	a0,a0,-1222 # ffffffffc020428a <init_main>
    nr_process ++;
...
ffffffffc020477c:	282000ef          	jal	ra,ffffffffc02049fe <hash32>
...
ffffffffc02047b0:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047b2:	6cc000ef          	jal	ra,ffffffffc0204e7e <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02047b6:	463d                	li	a2,15
ffffffffc02047b8:	00002597          	auipc	a1,0x2
ffffffffc02047bc:	50858593          	addi	a1,a1,1288 # ffffffffc0206cc0 <default_pmm_manager+0x10a0>
ffffffffc02047c0:	8526                	mv	a0,s1
ffffffffc02047c2:	6ce000ef          	jal	ra,ffffffffc0204e90 <memcpy>
...
ffffffffc020482e:	44650513          	addi	a0,a0,1094 # ffffffffc0206c70 <default_pmm_manager+0x1050>
...
ffffffffc0204846:	41660613          	addi	a2,a2,1046 # ffffffffc0206c58 <default_pmm_manager+0x1038>
ffffffffc020484a:	18500593          	li	a1,389
ffffffffc020484e:	00002517          	auipc	a0,0x2
ffffffffc0204852:	3da50513          	addi	a0,a0,986 # ffffffffc0206c28 <default_pmm_manager+0x1008>
ffffffffc0204856:	bf1fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc020485a:	00002617          	auipc	a2,0x2
ffffffffc020485e:	44660613          	addi	a2,a2,1094 # ffffffffc0206ca0 <default_pmm_manager+0x1080>
ffffffffc0204862:	1a500593          	li	a1,421
ffffffffc0204866:	00002517          	auipc	a0,0x2
ffffffffc020486a:	3c250513          	addi	a0,a0,962 # ffffffffc0206c28 <default_pmm_manager+0x1008>
ffffffffc020486e:	bd9fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204872:	00002697          	auipc	a3,0x2
ffffffffc0204876:	47e68693          	addi	a3,a3,1150 # ffffffffc0206cf0 <default_pmm_manager+0x10d0>
ffffffffc020487a:	00001617          	auipc	a2,0x1
ffffffffc020487e:	ff660613          	addi	a2,a2,-10 # ffffffffc0205870 <commands+0x738>
ffffffffc0204882:	1ac00593          	li	a1,428
ffffffffc0204886:	00002517          	auipc	a0,0x2
ffffffffc020488a:	3a250513          	addi	a0,a0,930 # ffffffffc0206c28 <default_pmm_manager+0x1008>
ffffffffc020488e:	bb9fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204892:	00002697          	auipc	a3,0x2
ffffffffc0204896:	43668693          	addi	a3,a3,1078 # ffffffffc0206cc8 <default_pmm_manager+0x10a8>
ffffffffc020489a:	00001617          	auipc	a2,0x1
ffffffffc020489e:	fd660613          	addi	a2,a2,-42 # ffffffffc0205870 <commands+0x738>
ffffffffc02048a2:	1ab00593          	li	a1,427
ffffffffc02048a6:	00002517          	auipc	a0,0x2
ffffffffc02048aa:	38250513          	addi	a0,a0,898 # ffffffffc0206c28 <default_pmm_manager+0x1008>
ffffffffc02048ae:	b99fb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc02048c6:	dff5                	beqz	a5,ffffffffc02048c2 <cpu_idle+0x10>
            schedule();
ffffffffc02048c8:	0a2000ef          	jal	ra,ffffffffc020496a <schedule>
ffffffffc02048cc:	bfd5                	j	ffffffffc02048c0 <cpu_idle+0xe>

ffffffffc02048ce <switch_to>:
.text
...
ffffffffc02048ce:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc02048d2:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc02048d6:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc02048d8:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc02048da:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc02048de:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc02048e2:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc02048e6:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc02048ea:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc02048ee:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc02048f2:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc02048f6:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc02048fa:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc02048fe:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0204902:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0204906:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc020490a:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc020490c:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc020490e:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0204912:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0204916:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc020491a:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc020491e:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0204922:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0204926:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc020492a:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc020492e:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0204932:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc0204936:	8082                	ret

ffffffffc0204938 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc0204938:	411c                	lw	a5,0(a0)
ffffffffc020493a:	4705                	li	a4,1
ffffffffc020493c:	37f9                	addiw	a5,a5,-2
ffffffffc020493e:	00f77563          	bgeu	a4,a5,ffffffffc0204948 <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc0204942:	4789                	li	a5,2
ffffffffc0204944:	c11c                	sw	a5,0(a0)
ffffffffc0204946:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc0204948:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc020494a:	00002697          	auipc	a3,0x2
ffffffffc020494e:	3ce68693          	addi	a3,a3,974 # ffffffffc0206d18 <default_pmm_manager+0x10f8>
ffffffffc0204952:	00001617          	auipc	a2,0x1
ffffffffc0204956:	f1e60613          	addi	a2,a2,-226 # ffffffffc0205870 <commands+0x738>
ffffffffc020495a:	45a5                	li	a1,9
ffffffffc020495c:	00002517          	auipc	a0,0x2
ffffffffc0204960:	3fc50513          	addi	a0,a0,1020 # ffffffffc0206d58 <default_pmm_manager+0x1138>
wakeup_proc(struct proc_struct *proc) {
ffffffffc0204964:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc0204966:	ae1fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020496a <schedule>:
}
...
ffffffffc020496e:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204970:	100027f3          	csrr	a5,sstatus
ffffffffc0204974:	8b89                	andi	a5,a5,2
ffffffffc0204976:	4401                	li	s0,0
ffffffffc0204978:	efbd                	bnez	a5,ffffffffc02049f6 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc020497a:	00011897          	auipc	a7,0x11
ffffffffc020497e:	c368b883          	ld	a7,-970(a7) # ffffffffc02155b0 <current>
ffffffffc0204982:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204986:	00011517          	auipc	a0,0x11
ffffffffc020498a:	c3253503          	ld	a0,-974(a0) # ffffffffc02155b8 <idleproc>
ffffffffc020498e:	04a88e63          	beq	a7,a0,ffffffffc02049ea <schedule+0x80>
ffffffffc0204992:	0c888693          	addi	a3,a7,200
ffffffffc0204996:	00011617          	auipc	a2,0x11
ffffffffc020499a:	b9260613          	addi	a2,a2,-1134 # ffffffffc0215528 <proc_list>
        le = last;
ffffffffc020499e:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc02049a2:	4809                	li	a6,2
ffffffffc02049a4:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc02049a6:	00c78863          	beq	a5,a2,ffffffffc02049b6 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049aa:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc02049ae:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049b2:	03070163          	beq	a4,a6,ffffffffc02049d4 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc02049b6:	fef697e3          	bne	a3,a5,ffffffffc02049a4 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02049ba:	ed89                	bnez	a1,ffffffffc02049d4 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc02049bc:	451c                	lw	a5,8(a0)
ffffffffc02049be:	2785                	addiw	a5,a5,1
ffffffffc02049c0:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc02049c2:	00a88463          	beq	a7,a0,ffffffffc02049ca <schedule+0x60>
            proc_run(next);
ffffffffc02049c6:	937ff0ef          	jal	ra,ffffffffc02042fc <proc_run>
    if (flag) {
ffffffffc02049ca:	e819                	bnez	s0,ffffffffc02049e0 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc02049d8:	fef712e3          	bne	a4,a5,ffffffffc02049bc <schedule+0x52>
ffffffffc02049dc:	852e                	mv	a0,a1
ffffffffc02049de:	bff9                	j	ffffffffc02049bc <schedule+0x52>
}
ffffffffc02049e0:	6402                	ld	s0,0(sp)
ffffffffc02049e2:	60a2                	ld	ra,8(sp)
ffffffffc02049e4:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc02049e6:	bd7fb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049ea:	00011617          	auipc	a2,0x11
ffffffffc02049ee:	b3e60613          	addi	a2,a2,-1218 # ffffffffc0215528 <proc_list>
ffffffffc02049f2:	86b2                	mv	a3,a2
ffffffffc02049f4:	b76d                	j	ffffffffc020499e <schedule+0x34>
        intr_disable();
ffffffffc02049f6:	bcdfb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc02049fa:	4405                	li	s0,1
ffffffffc02049fc:	bfbd                	j	ffffffffc020497a <schedule+0x10>
...
ffffffffc0204a04:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0204a08:	02000793          	li	a5,32
ffffffffc0204a0c:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a0e:	00f5553b          	srlw	a0,a0,a5
ffffffffc0204a12:	8082                	ret

ffffffffc0204a14 <printnum>:
 * */
static void
...
ffffffffc0204a14:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a18:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204a1a:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a1e:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0204a20:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a24:	f022                	sd	s0,32(sp)
ffffffffc0204a26:	ec26                	sd	s1,24(sp)
ffffffffc0204a28:	e84a                	sd	s2,16(sp)
ffffffffc0204a2a:	f406                	sd	ra,40(sp)
ffffffffc0204a2c:	e44e                	sd	s3,8(sp)
ffffffffc0204a2e:	84aa                	mv	s1,a0
ffffffffc0204a30:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0204a32:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204a36:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204a38:	03067e63          	bgeu	a2,a6,ffffffffc0204a74 <printnum+0x60>
ffffffffc0204a3c:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0204a3e:	00805763          	blez	s0,ffffffffc0204a4c <printnum+0x38>
ffffffffc0204a42:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204a44:	85ca                	mv	a1,s2
ffffffffc0204a46:	854e                	mv	a0,s3
ffffffffc0204a48:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204a4a:	fc65                	bnez	s0,ffffffffc0204a42 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a4c:	1a02                	slli	s4,s4,0x20
ffffffffc0204a4e:	00002797          	auipc	a5,0x2
ffffffffc0204a52:	32278793          	addi	a5,a5,802 # ffffffffc0206d70 <default_pmm_manager+0x1150>
ffffffffc0204a56:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204a5a:	9a3e                	add	s4,s4,a5
}
ffffffffc0204a5c:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a5e:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204a62:	70a2                	ld	ra,40(sp)
ffffffffc0204a64:	69a2                	ld	s3,8(sp)
ffffffffc0204a66:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a68:	85ca                	mv	a1,s2
ffffffffc0204a6a:	87a6                	mv	a5,s1
}
ffffffffc0204a6c:	6942                	ld	s2,16(sp)
ffffffffc0204a6e:	64e2                	ld	s1,24(sp)
ffffffffc0204a70:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a72:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204a74:	03065633          	divu	a2,a2,a6
ffffffffc0204a78:	8722                	mv	a4,s0
ffffffffc0204a7a:	f9bff0ef          	jal	ra,ffffffffc0204a14 <printnum>
ffffffffc0204a7e:	b7f9                	j	ffffffffc0204a4c <printnum+0x38>

ffffffffc0204a80 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204a80:	7119                	addi	sp,sp,-128
ffffffffc0204a82:	f4a6                	sd	s1,104(sp)
ffffffffc0204a84:	f0ca                	sd	s2,96(sp)
ffffffffc0204a86:	ecce                	sd	s3,88(sp)
ffffffffc0204a88:	e8d2                	sd	s4,80(sp)
ffffffffc0204a8a:	e4d6                	sd	s5,72(sp)
ffffffffc0204a8c:	e0da                	sd	s6,64(sp)
ffffffffc0204a8e:	fc5e                	sd	s7,56(sp)
ffffffffc0204a90:	f06a                	sd	s10,32(sp)
ffffffffc0204a92:	fc86                	sd	ra,120(sp)
ffffffffc0204a94:	f8a2                	sd	s0,112(sp)
ffffffffc0204a96:	f862                	sd	s8,48(sp)
ffffffffc0204a98:	f466                	sd	s9,40(sp)
ffffffffc0204a9a:	ec6e                	sd	s11,24(sp)
ffffffffc0204a9c:	892a                	mv	s2,a0
ffffffffc0204a9e:	84ae                	mv	s1,a1
ffffffffc0204aa0:	8d32                	mv	s10,a2
ffffffffc0204aa2:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204aa4:	02500993          	li	s3,37
            putch(ch, putdat);
        }
...
ffffffffc0204aaa:	00002a97          	auipc	s5,0x2
ffffffffc0204aae:	2f2a8a93          	addi	s5,s5,754 # ffffffffc0206d9c <default_pmm_manager+0x117c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204ab2:	00002b97          	auipc	s7,0x2
ffffffffc0204ab6:	4c6b8b93          	addi	s7,s7,1222 # ffffffffc0206f78 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204aba:	000d4503          	lbu	a0,0(s10)
ffffffffc0204abe:	001d0413          	addi	s0,s10,1
ffffffffc0204ac2:	01350a63          	beq	a0,s3,ffffffffc0204ad6 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204ac6:	c121                	beqz	a0,ffffffffc0204b06 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0204ac8:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204aca:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0204acc:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204ace:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204ad2:	ff351ae3          	bne	a0,s3,ffffffffc0204ac6 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ad6:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204ada:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204ade:	4c81                	li	s9,0
ffffffffc0204ae0:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204ae2:	5c7d                	li	s8,-1
ffffffffc0204ae4:	5dfd                	li	s11,-1
ffffffffc0204ae6:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204aea:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204aec:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204af0:	0ff5f593          	zext.b	a1,a1
ffffffffc0204af4:	00140d13          	addi	s10,s0,1
ffffffffc0204af8:	04b56263          	bltu	a0,a1,ffffffffc0204b3c <vprintfmt+0xbc>
ffffffffc0204afc:	058a                	slli	a1,a1,0x2
ffffffffc0204afe:	95d6                	add	a1,a1,s5
ffffffffc0204b00:	4194                	lw	a3,0(a1)
ffffffffc0204b02:	96d6                	add	a3,a3,s5
ffffffffc0204b04:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204b06:	70e6                	ld	ra,120(sp)
ffffffffc0204b08:	7446                	ld	s0,112(sp)
ffffffffc0204b0a:	74a6                	ld	s1,104(sp)
ffffffffc0204b0c:	7906                	ld	s2,96(sp)
ffffffffc0204b0e:	69e6                	ld	s3,88(sp)
ffffffffc0204b10:	6a46                	ld	s4,80(sp)
ffffffffc0204b12:	6aa6                	ld	s5,72(sp)
ffffffffc0204b14:	6b06                	ld	s6,64(sp)
ffffffffc0204b16:	7be2                	ld	s7,56(sp)
ffffffffc0204b18:	7c42                	ld	s8,48(sp)
ffffffffc0204b1a:	7ca2                	ld	s9,40(sp)
ffffffffc0204b1c:	7d02                	ld	s10,32(sp)
ffffffffc0204b1e:	6de2                	ld	s11,24(sp)
ffffffffc0204b20:	6109                	addi	sp,sp,128
ffffffffc0204b22:	8082                	ret
            padc = '0';
ffffffffc0204b24:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204b26:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b2a:	846a                	mv	s0,s10
ffffffffc0204b2c:	00140d13          	addi	s10,s0,1
ffffffffc0204b30:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b34:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b38:	fcb572e3          	bgeu	a0,a1,ffffffffc0204afc <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204b3c:	85a6                	mv	a1,s1
ffffffffc0204b3e:	02500513          	li	a0,37
ffffffffc0204b42:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204b44:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204b48:	8d22                	mv	s10,s0
ffffffffc0204b4a:	f73788e3          	beq	a5,s3,ffffffffc0204aba <vprintfmt+0x3a>
ffffffffc0204b4e:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204b52:	1d7d                	addi	s10,s10,-1
ffffffffc0204b54:	ff379de3          	bne	a5,s3,ffffffffc0204b4e <vprintfmt+0xce>
ffffffffc0204b58:	b78d                	j	ffffffffc0204aba <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204b5a:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204b5e:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b62:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204b64:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204b68:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b6c:	02d86463          	bltu	a6,a3,ffffffffc0204b94 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204b70:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204b74:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204b78:	0186873b          	addw	a4,a3,s8
ffffffffc0204b7c:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204b80:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204b82:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204b86:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204b88:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204b8c:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b90:	fed870e3          	bgeu	a6,a3,ffffffffc0204b70 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204b94:	f40ddce3          	bgez	s11,ffffffffc0204aec <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204b98:	8de2                	mv	s11,s8
ffffffffc0204b9a:	5c7d                	li	s8,-1
ffffffffc0204b9c:	bf81                	j	ffffffffc0204aec <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204b9e:	fffdc693          	not	a3,s11
ffffffffc0204ba2:	96fd                	srai	a3,a3,0x3f
ffffffffc0204ba4:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ba8:	00144603          	lbu	a2,1(s0)
ffffffffc0204bac:	2d81                	sext.w	s11,s11
ffffffffc0204bae:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204bb0:	bf35                	j	ffffffffc0204aec <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204bb2:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc0204bbe:	bfd9                	j	ffffffffc0204b94 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204bc0:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204bc2:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204bc6:	01174463          	blt	a4,a7,ffffffffc0204bce <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204bca:	1a088e63          	beqz	a7,ffffffffc0204d86 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204bce:	000a3603          	ld	a2,0(s4)
ffffffffc0204bd2:	46c1                	li	a3,16
ffffffffc0204bd4:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204bd6:	2781                	sext.w	a5,a5
ffffffffc0204bd8:	876e                	mv	a4,s11
ffffffffc0204bda:	85a6                	mv	a1,s1
ffffffffc0204bdc:	854a                	mv	a0,s2
ffffffffc0204bde:	e37ff0ef          	jal	ra,ffffffffc0204a14 <printnum>
            break;
ffffffffc0204be2:	bde1                	j	ffffffffc0204aba <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204be4:	000a2503          	lw	a0,0(s4)
ffffffffc0204be8:	85a6                	mv	a1,s1
ffffffffc0204bea:	0a21                	addi	s4,s4,8
ffffffffc0204bec:	9902                	jalr	s2
            break;
ffffffffc0204bee:	b5f1                	j	ffffffffc0204aba <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204bf0:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204bf2:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204bf6:	01174463          	blt	a4,a7,ffffffffc0204bfe <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204bfa:	18088163          	beqz	a7,ffffffffc0204d7c <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204bfe:	000a3603          	ld	a2,0(s4)
ffffffffc0204c02:	46a9                	li	a3,10
ffffffffc0204c04:	8a2e                	mv	s4,a1
ffffffffc0204c06:	bfc1                	j	ffffffffc0204bd6 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c08:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c0c:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c0e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c10:	bdf1                	j	ffffffffc0204aec <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c12:	85a6                	mv	a1,s1
ffffffffc0204c14:	02500513          	li	a0,37
ffffffffc0204c18:	9902                	jalr	s2
            break;
ffffffffc0204c1a:	b545                	j	ffffffffc0204aba <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c1c:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204c20:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c22:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c24:	b5e1                	j	ffffffffc0204aec <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204c26:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c28:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c2c:	01174463          	blt	a4,a7,ffffffffc0204c34 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204c30:	14088163          	beqz	a7,ffffffffc0204d72 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204c34:	000a3603          	ld	a2,0(s4)
ffffffffc0204c38:	46a1                	li	a3,8
ffffffffc0204c3a:	8a2e                	mv	s4,a1
ffffffffc0204c3c:	bf69                	j	ffffffffc0204bd6 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204c3e:	03000513          	li	a0,48
ffffffffc0204c42:	85a6                	mv	a1,s1
ffffffffc0204c44:	e03e                	sd	a5,0(sp)
ffffffffc0204c46:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204c48:	85a6                	mv	a1,s1
ffffffffc0204c4a:	07800513          	li	a0,120
ffffffffc0204c4e:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c50:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204c52:	6782                	ld	a5,0(sp)
ffffffffc0204c54:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c56:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204c5a:	bfb5                	j	ffffffffc0204bd6 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c5c:	000a3403          	ld	s0,0(s4)
ffffffffc0204c60:	008a0713          	addi	a4,s4,8
ffffffffc0204c64:	e03a                	sd	a4,0(sp)
ffffffffc0204c66:	14040263          	beqz	s0,ffffffffc0204daa <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204c6a:	0fb05763          	blez	s11,ffffffffc0204d58 <vprintfmt+0x2d8>
ffffffffc0204c6e:	02d00693          	li	a3,45
ffffffffc0204c72:	0cd79163          	bne	a5,a3,ffffffffc0204d34 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c76:	00044783          	lbu	a5,0(s0)
ffffffffc0204c7a:	0007851b          	sext.w	a0,a5
ffffffffc0204c7e:	cf85                	beqz	a5,ffffffffc0204cb6 <vprintfmt+0x236>
ffffffffc0204c80:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c84:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c88:	000c4563          	bltz	s8,ffffffffc0204c92 <vprintfmt+0x212>
ffffffffc0204c8c:	3c7d                	addiw	s8,s8,-1
ffffffffc0204c8e:	036c0263          	beq	s8,s6,ffffffffc0204cb2 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204c92:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c94:	0e0c8e63          	beqz	s9,ffffffffc0204d90 <vprintfmt+0x310>
ffffffffc0204c98:	3781                	addiw	a5,a5,-32
ffffffffc0204c9a:	0ef47b63          	bgeu	s0,a5,ffffffffc0204d90 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204c9e:	03f00513          	li	a0,63
ffffffffc0204ca2:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204ca4:	000a4783          	lbu	a5,0(s4)
ffffffffc0204ca8:	3dfd                	addiw	s11,s11,-1
ffffffffc0204caa:	0a05                	addi	s4,s4,1
ffffffffc0204cac:	0007851b          	sext.w	a0,a5
ffffffffc0204cb0:	ffe1                	bnez	a5,ffffffffc0204c88 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204cb2:	01b05963          	blez	s11,ffffffffc0204cc4 <vprintfmt+0x244>
...
ffffffffc0204cbe:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204cc0:	fe0d9be3          	bnez	s11,ffffffffc0204cb6 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204cc4:	6a02                	ld	s4,0(sp)
ffffffffc0204cc6:	bbd5                	j	ffffffffc0204aba <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204cc8:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204cca:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204cce:	01174463          	blt	a4,a7,ffffffffc0204cd6 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204cd2:	08088d63          	beqz	a7,ffffffffc0204d6c <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204cd6:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204cda:	0a044d63          	bltz	s0,ffffffffc0204d94 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204cde:	8622                	mv	a2,s0
ffffffffc0204ce0:	8a66                	mv	s4,s9
ffffffffc0204ce2:	46a9                	li	a3,10
ffffffffc0204ce4:	bdcd                	j	ffffffffc0204bd6 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204ce6:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204cea:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204cec:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204cee:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204cf2:	8fb5                	xor	a5,a5,a3
ffffffffc0204cf4:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204cf8:	02d74163          	blt	a4,a3,ffffffffc0204d1a <vprintfmt+0x29a>
ffffffffc0204cfc:	00369793          	slli	a5,a3,0x3
ffffffffc0204d00:	97de                	add	a5,a5,s7
ffffffffc0204d02:	639c                	ld	a5,0(a5)
ffffffffc0204d04:	cb99                	beqz	a5,ffffffffc0204d1a <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204d06:	86be                	mv	a3,a5
ffffffffc0204d08:	00000617          	auipc	a2,0x0
ffffffffc0204d0c:	1f060613          	addi	a2,a2,496 # ffffffffc0204ef8 <etext+0x2c>
ffffffffc0204d10:	85a6                	mv	a1,s1
ffffffffc0204d12:	854a                	mv	a0,s2
ffffffffc0204d14:	0ce000ef          	jal	ra,ffffffffc0204de2 <printfmt>
ffffffffc0204d18:	b34d                	j	ffffffffc0204aba <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d1a:	00002617          	auipc	a2,0x2
ffffffffc0204d1e:	07660613          	addi	a2,a2,118 # ffffffffc0206d90 <default_pmm_manager+0x1170>
ffffffffc0204d22:	85a6                	mv	a1,s1
ffffffffc0204d24:	854a                	mv	a0,s2
ffffffffc0204d26:	0bc000ef          	jal	ra,ffffffffc0204de2 <printfmt>
ffffffffc0204d2a:	bb41                	j	ffffffffc0204aba <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d2c:	00002417          	auipc	s0,0x2
ffffffffc0204d30:	05c40413          	addi	s0,s0,92 # ffffffffc0206d88 <default_pmm_manager+0x1168>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d34:	85e2                	mv	a1,s8
ffffffffc0204d36:	8522                	mv	a0,s0
ffffffffc0204d38:	e43e                	sd	a5,8(sp)
ffffffffc0204d3a:	0e2000ef          	jal	ra,ffffffffc0204e1c <strnlen>
ffffffffc0204d3e:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204d42:	01b05b63          	blez	s11,ffffffffc0204d58 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204d46:	67a2                	ld	a5,8(sp)
ffffffffc0204d48:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d4c:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204d4e:	85a6                	mv	a1,s1
ffffffffc0204d50:	8552                	mv	a0,s4
ffffffffc0204d52:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d54:	fe0d9ce3          	bnez	s11,ffffffffc0204d4c <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d58:	00044783          	lbu	a5,0(s0)
ffffffffc0204d5c:	00140a13          	addi	s4,s0,1
ffffffffc0204d60:	0007851b          	sext.w	a0,a5
ffffffffc0204d64:	d3a5                	beqz	a5,ffffffffc0204cc4 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d66:	05e00413          	li	s0,94
ffffffffc0204d6a:	bf39                	j	ffffffffc0204c88 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204d6c:	000a2403          	lw	s0,0(s4)
ffffffffc0204d70:	b7ad                	j	ffffffffc0204cda <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204d72:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d76:	46a1                	li	a3,8
ffffffffc0204d78:	8a2e                	mv	s4,a1
ffffffffc0204d7a:	bdb1                	j	ffffffffc0204bd6 <vprintfmt+0x156>
ffffffffc0204d7c:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d80:	46a9                	li	a3,10
ffffffffc0204d82:	8a2e                	mv	s4,a1
ffffffffc0204d84:	bd89                	j	ffffffffc0204bd6 <vprintfmt+0x156>
ffffffffc0204d86:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d8a:	46c1                	li	a3,16
ffffffffc0204d8c:	8a2e                	mv	s4,a1
ffffffffc0204d8e:	b5a1                	j	ffffffffc0204bd6 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204d90:	9902                	jalr	s2
ffffffffc0204d92:	bf09                	j	ffffffffc0204ca4 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204d94:	85a6                	mv	a1,s1
ffffffffc0204d96:	02d00513          	li	a0,45
ffffffffc0204d9a:	e03e                	sd	a5,0(sp)
ffffffffc0204d9c:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204d9e:	6782                	ld	a5,0(sp)
ffffffffc0204da0:	8a66                	mv	s4,s9
ffffffffc0204da2:	40800633          	neg	a2,s0
ffffffffc0204da6:	46a9                	li	a3,10
ffffffffc0204da8:	b53d                	j	ffffffffc0204bd6 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204daa:	03b05163          	blez	s11,ffffffffc0204dcc <vprintfmt+0x34c>
ffffffffc0204dae:	02d00693          	li	a3,45
ffffffffc0204db2:	f6d79de3          	bne	a5,a3,ffffffffc0204d2c <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204db6:	00002417          	auipc	s0,0x2
ffffffffc0204dba:	fd240413          	addi	s0,s0,-46 # ffffffffc0206d88 <default_pmm_manager+0x1168>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204dbe:	02800793          	li	a5,40
ffffffffc0204dc2:	02800513          	li	a0,40
ffffffffc0204dc6:	00140a13          	addi	s4,s0,1
ffffffffc0204dca:	bd6d                	j	ffffffffc0204c84 <vprintfmt+0x204>
ffffffffc0204dcc:	00002a17          	auipc	s4,0x2
ffffffffc0204dd0:	fbda0a13          	addi	s4,s4,-67 # ffffffffc0206d89 <default_pmm_manager+0x1169>
ffffffffc0204dd4:	02800513          	li	a0,40
ffffffffc0204dd8:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204ddc:	05e00413          	li	s0,94
ffffffffc0204de0:	b565                	j	ffffffffc0204c88 <vprintfmt+0x208>
...
ffffffffc0204df6:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204df8:	c89ff0ef          	jal	ra,ffffffffc0204a80 <vprintfmt>
}
...
strlen(const char *s) {
ffffffffc0204e06:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204e08:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204e0a:	cb81                	beqz	a5,ffffffffc0204e1a <strlen+0x18>
        cnt ++;
ffffffffc0204e0c:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e0e:	00a707b3          	add	a5,a4,a0
ffffffffc0204e12:	0007c783          	lbu	a5,0(a5)
ffffffffc0204e16:	fbfd                	bnez	a5,ffffffffc0204e0c <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204e1c:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e1e:	e589                	bnez	a1,ffffffffc0204e28 <strnlen+0xc>
ffffffffc0204e20:	a811                	j	ffffffffc0204e34 <strnlen+0x18>
        cnt ++;
ffffffffc0204e22:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e24:	00f58863          	beq	a1,a5,ffffffffc0204e34 <strnlen+0x18>
ffffffffc0204e28:	00f50733          	add	a4,a0,a5
ffffffffc0204e2c:	00074703          	lbu	a4,0(a4)
ffffffffc0204e30:	fb6d                	bnez	a4,ffffffffc0204e22 <strnlen+0x6>
ffffffffc0204e32:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204e34:	852e                	mv	a0,a1
ffffffffc0204e36:	8082                	ret

ffffffffc0204e38 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0204e38:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204e3a:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e3e:	0785                	addi	a5,a5,1
ffffffffc0204e40:	0585                	addi	a1,a1,1
ffffffffc0204e42:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204e46:	fb75                	bnez	a4,ffffffffc0204e3a <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204e4e:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e52:	cb89                	beqz	a5,ffffffffc0204e64 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204e54:	0505                	addi	a0,a0,1
ffffffffc0204e56:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e58:	fee789e3          	beq	a5,a4,ffffffffc0204e4a <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e5c:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204e60:	9d19                	subw	a0,a0,a4
ffffffffc0204e62:	8082                	ret
ffffffffc0204e64:	4501                	li	a0,0
ffffffffc0204e66:	bfed                	j	ffffffffc0204e60 <strcmp+0x16>

ffffffffc0204e68 <strchr>:
...
ffffffffc0204e6c:	c799                	beqz	a5,ffffffffc0204e7a <strchr+0x12>
        if (*s == c) {
ffffffffc0204e6e:	00f58763          	beq	a1,a5,ffffffffc0204e7c <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204e72:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204e76:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204e78:	fbfd                	bnez	a5,ffffffffc0204e6e <strchr+0x6>
    }
    return NULL;
...
ffffffffc0204e94:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204e96:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e9a:	0585                	addi	a1,a1,1
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204ea8:	c205                	beqz	a2,ffffffffc0204ec8 <memcmp+0x20>
ffffffffc0204eaa:	962e                	add	a2,a2,a1
ffffffffc0204eac:	a019                	j	ffffffffc0204eb2 <memcmp+0xa>
ffffffffc0204eae:	00c58d63          	beq	a1,a2,ffffffffc0204ec8 <memcmp+0x20>
        if (*s1 != *s2) {
ffffffffc0204eb2:	00054783          	lbu	a5,0(a0)
ffffffffc0204eb6:	0005c703          	lbu	a4,0(a1)
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
ffffffffc0204eba:	0505                	addi	a0,a0,1
ffffffffc0204ebc:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204ebe:	fee788e3          	beq	a5,a4,ffffffffc0204eae <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204ec2:	40e7853b          	subw	a0,a5,a4
