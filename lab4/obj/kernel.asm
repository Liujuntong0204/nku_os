...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	6a9040ef          	jal	ra,ffffffffc0204ef2 <memset>
...
ffffffffc0200056:	eee58593          	addi	a1,a1,-274 # ffffffffc0204f40 <etext>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	f0650513          	addi	a0,a0,-250 # ffffffffc0204f60 <etext+0x20>
...
ffffffffc020007a:	65e040ef          	jal	ra,ffffffffc02046d8 <proc_init>
...
ffffffffc020008e:	099040ef          	jal	ra,ffffffffc0204926 <cpu_idle>
...
ffffffffc02000ac:	ec050513          	addi	a0,a0,-320 # ffffffffc0204f68 <etext+0x28>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	181040ef          	jal	ra,ffffffffc0204af4 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	14b040ef          	jal	ra,ffffffffc0204af4 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	da650513          	addi	a0,a0,-602 # ffffffffc0204f70 <etext+0x30>
void print_kerninfo(void) {
...
ffffffffc02001e4:	db050513          	addi	a0,a0,-592 # ffffffffc0204f90 <etext+0x50>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	d5458593          	addi	a1,a1,-684 # ffffffffc0204f40 <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	dbc50513          	addi	a0,a0,-580 # ffffffffc0204fb0 <etext+0x70>
...
ffffffffc020020c:	dc850513          	addi	a0,a0,-568 # ffffffffc0204fd0 <etext+0x90>
...
ffffffffc0200220:	dd450513          	addi	a0,a0,-556 # ffffffffc0204ff0 <etext+0xb0>
...
ffffffffc020024e:	dc650513          	addi	a0,a0,-570 # ffffffffc0205010 <etext+0xd0>
}
...
ffffffffc020025c:	de860613          	addi	a2,a2,-536 # ffffffffc0205040 <etext+0x100>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	df450513          	addi	a0,a0,-524 # ffffffffc0205058 <etext+0x118>
void print_stackframe(void) {
...
ffffffffc0200278:	dfc60613          	addi	a2,a2,-516 # ffffffffc0205070 <etext+0x130>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	e1458593          	addi	a1,a1,-492 # ffffffffc0205090 <etext+0x150>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	e1450513          	addi	a0,a0,-492 # ffffffffc0205098 <etext+0x158>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	e1660613          	addi	a2,a2,-490 # ffffffffc02050a8 <etext+0x168>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	e3658593          	addi	a1,a1,-458 # ffffffffc02050d0 <etext+0x190>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	df650513          	addi	a0,a0,-522 # ffffffffc0205098 <etext+0x158>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	e3260613          	addi	a2,a2,-462 # ffffffffc02050e0 <etext+0x1a0>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	e4a58593          	addi	a1,a1,-438 # ffffffffc0205100 <etext+0x1c0>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	dda50513          	addi	a0,a0,-550 # ffffffffc0205098 <etext+0x158>
...
ffffffffc02002fc:	e1850513          	addi	a0,a0,-488 # ffffffffc0205110 <etext+0x1d0>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	e1e50513          	addi	a0,a0,-482 # ffffffffc0205138 <etext+0x1f8>
...
ffffffffc0200348:	e1c90913          	addi	s2,s2,-484 # ffffffffc0205160 <etext+0x220>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	e1c48493          	addi	s1,s1,-484 # ffffffffc0205168 <etext+0x228>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	e1ab0b13          	addi	s6,s6,-486 # ffffffffc0205170 <etext+0x230>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	d32a0a13          	addi	s4,s4,-718 # ffffffffc0205090 <etext+0x150>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	331040ef          	jal	ra,ffffffffc0204ebe <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	31d040ef          	jal	ra,ffffffffc0204ebe <strcmp>
...
ffffffffc02003e0:	2fd040ef          	jal	ra,ffffffffc0204edc <strchr>
...
ffffffffc020041e:	2bf040ef          	jal	ra,ffffffffc0204edc <strchr>
...
ffffffffc020043c:	d5850513          	addi	a0,a0,-680 # ffffffffc0205190 <etext+0x250>
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	179040ef          	jal	ra,ffffffffc0204f04 <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	155040ef          	jal	ra,ffffffffc0204f04 <memcpy>
    return 0;
}
...
ffffffffc0201bbe:	334030ef          	jal	ra,ffffffffc0204ef2 <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	2a2030ef          	jal	ra,ffffffffc0204ef2 <memset>
    return page - pages + nbase;
...
ffffffffc0202352:	35b020ef          	jal	ra,ffffffffc0204eac <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	361020ef          	jal	ra,ffffffffc0204ebe <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	2e3020ef          	jal	ra,ffffffffc0204e76 <strlen>
...
ffffffffc0203606:	05500593          	li	a1,85
...
ffffffffc0203626:	07700593          	li	a1,119
...
ffffffffc0203646:	07500593          	li	a1,117
...
ffffffffc0203666:	07300593          	li	a1,115
...
ffffffffc0203686:	07000593          	li	a1,112
...
ffffffffc02036a6:	06d00593          	li	a1,109
...
ffffffffc02036c6:	06a00593          	li	a1,106
...
ffffffffc02036e6:	06700593          	li	a1,103
...
ffffffffc0203706:	06400593          	li	a1,100
...
ffffffffc0203726:	06100593          	li	a1,97
...
ffffffffc0203746:	05e00593          	li	a1,94
...
ffffffffc0203766:	05b00593          	li	a1,91
...
ffffffffc0203786:	05800593          	li	a1,88
...
ffffffffc02037cc:	08868693          	addi	a3,a3,136 # ffffffffc0206850 <default_pmm_manager+0xbc0>
ffffffffc02037d0:	00002617          	auipc	a2,0x2
ffffffffc02037d4:	11060613          	addi	a2,a2,272 # ffffffffc02058e0 <commands+0x738>
ffffffffc02037d8:	04200593          	li	a1,66
ffffffffc02037dc:	00003517          	auipc	a0,0x3
ffffffffc02037e0:	f1450513          	addi	a0,a0,-236 # ffffffffc02066f0 <default_pmm_manager+0xa60>
ffffffffc02037e4:	c63fc0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(head != NULL);
ffffffffc02037e8:	00003697          	auipc	a3,0x3
ffffffffc02037ec:	05868693          	addi	a3,a3,88 # ffffffffc0206840 <default_pmm_manager+0xbb0>
ffffffffc02037f0:	00002617          	auipc	a2,0x2
ffffffffc02037f4:	0f060613          	addi	a2,a2,240 # ffffffffc02058e0 <commands+0x738>
ffffffffc02037f8:	04100593          	li	a1,65
ffffffffc02037fc:	00003517          	auipc	a0,0x3
ffffffffc0203800:	ef450513          	addi	a0,a0,-268 # ffffffffc02066f0 <default_pmm_manager+0xa60>
...
ffffffffc0203824:	04068693          	addi	a3,a3,64 # ffffffffc0206860 <default_pmm_manager+0xbd0>
ffffffffc0203828:	00002617          	auipc	a2,0x2
ffffffffc020382c:	0b860613          	addi	a2,a2,184 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203830:	03200593          	li	a1,50
ffffffffc0203834:	00003517          	auipc	a0,0x3
ffffffffc0203838:	ebc50513          	addi	a0,a0,-324 # ffffffffc02066f0 <default_pmm_manager+0xa60>
{
...
ffffffffc0203848:	05468693          	addi	a3,a3,84 # ffffffffc0206898 <default_pmm_manager+0xc08>
ffffffffc020384c:	00002617          	auipc	a2,0x2
ffffffffc0203850:	09460613          	addi	a2,a2,148 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203854:	07e00593          	li	a1,126
ffffffffc0203858:	00003517          	auipc	a0,0x3
ffffffffc020385c:	06050513          	addi	a0,a0,96 # ffffffffc02068b8 <default_pmm_manager+0xc28>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0203888:	00013797          	auipc	a5,0x13
ffffffffc020388c:	d107a783          	lw	a5,-752(a5) # ffffffffc0216598 <swap_init_ok>
...
ffffffffc0203990:	f3c68693          	addi	a3,a3,-196 # ffffffffc02068c8 <default_pmm_manager+0xc38>
ffffffffc0203994:	00002617          	auipc	a2,0x2
ffffffffc0203998:	f4c60613          	addi	a2,a2,-180 # ffffffffc02058e0 <commands+0x738>
ffffffffc020399c:	08500593          	li	a1,133
ffffffffc02039a0:	00003517          	auipc	a0,0x3
ffffffffc02039a4:	f1850513          	addi	a0,a0,-232 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc02039a8:	a9ffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02039ac:	00003697          	auipc	a3,0x3
ffffffffc02039b0:	f5c68693          	addi	a3,a3,-164 # ffffffffc0206908 <default_pmm_manager+0xc78>
ffffffffc02039b4:	00002617          	auipc	a2,0x2
ffffffffc02039b8:	f2c60613          	addi	a2,a2,-212 # ffffffffc02058e0 <commands+0x738>
ffffffffc02039bc:	07d00593          	li	a1,125
ffffffffc02039c0:	00003517          	auipc	a0,0x3
ffffffffc02039c4:	ef850513          	addi	a0,a0,-264 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc02039c8:	a7ffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02039cc:	00003697          	auipc	a3,0x3
ffffffffc02039d0:	f1c68693          	addi	a3,a3,-228 # ffffffffc02068e8 <default_pmm_manager+0xc58>
ffffffffc02039d4:	00002617          	auipc	a2,0x2
ffffffffc02039d8:	f0c60613          	addi	a2,a2,-244 # ffffffffc02058e0 <commands+0x738>
ffffffffc02039dc:	07c00593          	li	a1,124
ffffffffc02039e0:	00003517          	auipc	a0,0x3
ffffffffc02039e4:	ed850513          	addi	a0,a0,-296 # ffffffffc02068b8 <default_pmm_manager+0xc28>
...
ffffffffc0203a42:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203a46:	00013797          	auipc	a5,0x13
ffffffffc0203a4a:	b527a783          	lw	a5,-1198(a5) # ffffffffc0216598 <swap_init_ok>
...
ffffffffc0203a82:	95a68693          	addi	a3,a3,-1702 # ffffffffc02063d8 <default_pmm_manager+0x748>
ffffffffc0203a86:	00002617          	auipc	a2,0x2
ffffffffc0203a8a:	e5a60613          	addi	a2,a2,-422 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203a8e:	0c900593          	li	a1,201
ffffffffc0203a92:	00003517          	auipc	a0,0x3
ffffffffc0203a96:	e2650513          	addi	a0,a0,-474 # ffffffffc02068b8 <default_pmm_manager+0xc28>
...
ffffffffc0203ad6:	90668693          	addi	a3,a3,-1786 # ffffffffc02063d8 <default_pmm_manager+0x748>
ffffffffc0203ada:	00002617          	auipc	a2,0x2
ffffffffc0203ade:	e0660613          	addi	a2,a2,-506 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203ae2:	0cf00593          	li	a1,207
ffffffffc0203ae6:	00003517          	auipc	a0,0x3
ffffffffc0203aea:	dd250513          	addi	a0,a0,-558 # ffffffffc02068b8 <default_pmm_manager+0xc28>
...
ffffffffc0203baa:	e8250513          	addi	a0,a0,-382 # ffffffffc0206a28 <default_pmm_manager+0xd98>
ffffffffc0203bae:	dd2fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203bb2:	00003697          	auipc	a3,0x3
ffffffffc0203bb6:	e9e68693          	addi	a3,a3,-354 # ffffffffc0206a50 <default_pmm_manager+0xdc0>
ffffffffc0203bba:	00002617          	auipc	a2,0x2
ffffffffc0203bbe:	d2660613          	addi	a2,a2,-730 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203bc2:	0f100593          	li	a1,241
ffffffffc0203bc6:	00003517          	auipc	a0,0x3
ffffffffc0203bca:	cf250513          	addi	a0,a0,-782 # ffffffffc02068b8 <default_pmm_manager+0xc28>
...
ffffffffc0203bf8:	e7450513          	addi	a0,a0,-396 # ffffffffc0206a68 <default_pmm_manager+0xdd8>
...
ffffffffc0203c10:	2c050363          	beqz	a0,ffffffffc0203ed6 <vmm_init+0x4bc>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203c14:	00013797          	auipc	a5,0x13
ffffffffc0203c18:	9847a783          	lw	a5,-1660(a5) # ffffffffc0216598 <swap_init_ok>
    elm->prev = elm->next = elm;
...
ffffffffc0203c30:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203c34:	00013917          	auipc	s2,0x13
ffffffffc0203c38:	92c93903          	ld	s2,-1748(s2) # ffffffffc0216560 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc0203c3c:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc0203c40:	00013717          	auipc	a4,0x13
ffffffffc0203c44:	96873023          	sd	s0,-1696(a4) # ffffffffc02165a0 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
...
ffffffffc0203cb6:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc0203cba:	00013a97          	auipc	s5,0x13
ffffffffc0203cbe:	8aea8a93          	addi	s5,s5,-1874 # ffffffffc0216568 <npage>
...
ffffffffc0203cd2:	352a3a03          	ld	s4,850(s4) # ffffffffc0207020 <nbase>
...
ffffffffc0203cee:	00013997          	auipc	s3,0x13
ffffffffc0203cf2:	8929b983          	ld	s3,-1902(s3) # ffffffffc0216580 <va_pa_offset>
...
ffffffffc0203d0c:	24e7f963          	bgeu	a5,a4,ffffffffc0203f5e <vmm_init+0x544>
    return &pages[PPN(pa) - nbase];
ffffffffc0203d10:	00013997          	auipc	s3,0x13
ffffffffc0203d14:	86098993          	addi	s3,s3,-1952 # ffffffffc0216570 <pages>
...
ffffffffc0203d78:	00013797          	auipc	a5,0x13
ffffffffc0203d7c:	8207b423          	sd	zero,-2008(a5) # ffffffffc02165a0 <check_mm_struct>
...
ffffffffc0203d8c:	d5850513          	addi	a0,a0,-680 # ffffffffc0206ae0 <default_pmm_manager+0xe50>
...
ffffffffc0203da6:	d5e50513          	addi	a0,a0,-674 # ffffffffc0206b00 <default_pmm_manager+0xe70>
}
...
ffffffffc0203dba:	b8a68693          	addi	a3,a3,-1142 # ffffffffc0206940 <default_pmm_manager+0xcb0>
ffffffffc0203dbe:	00002617          	auipc	a2,0x2
ffffffffc0203dc2:	b2260613          	addi	a2,a2,-1246 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203dc6:	0d800593          	li	a1,216
ffffffffc0203dca:	00003517          	auipc	a0,0x3
ffffffffc0203dce:	aee50513          	addi	a0,a0,-1298 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203dd2:	e74fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203dd6:	00003697          	auipc	a3,0x3
ffffffffc0203dda:	bf268693          	addi	a3,a3,-1038 # ffffffffc02069c8 <default_pmm_manager+0xd38>
ffffffffc0203dde:	00002617          	auipc	a2,0x2
ffffffffc0203de2:	b0260613          	addi	a2,a2,-1278 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203de6:	0e800593          	li	a1,232
ffffffffc0203dea:	00003517          	auipc	a0,0x3
ffffffffc0203dee:	ace50513          	addi	a0,a0,-1330 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203df2:	e54fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203df6:	00003697          	auipc	a3,0x3
ffffffffc0203dfa:	c0268693          	addi	a3,a3,-1022 # ffffffffc02069f8 <default_pmm_manager+0xd68>
ffffffffc0203dfe:	00002617          	auipc	a2,0x2
ffffffffc0203e02:	ae260613          	addi	a2,a2,-1310 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203e06:	0e900593          	li	a1,233
ffffffffc0203e0a:	00003517          	auipc	a0,0x3
ffffffffc0203e0e:	aae50513          	addi	a0,a0,-1362 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203e12:	e34fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203e16:	00003697          	auipc	a3,0x3
ffffffffc0203e1a:	b1268693          	addi	a3,a3,-1262 # ffffffffc0206928 <default_pmm_manager+0xc98>
ffffffffc0203e1e:	00002617          	auipc	a2,0x2
ffffffffc0203e22:	ac260613          	addi	a2,a2,-1342 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203e26:	0d600593          	li	a1,214
ffffffffc0203e2a:	00003517          	auipc	a0,0x3
ffffffffc0203e2e:	a8e50513          	addi	a0,a0,-1394 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203e32:	e14fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma4 == NULL);
ffffffffc0203e36:	00003697          	auipc	a3,0x3
ffffffffc0203e3a:	b7268693          	addi	a3,a3,-1166 # ffffffffc02069a8 <default_pmm_manager+0xd18>
ffffffffc0203e3e:	00002617          	auipc	a2,0x2
ffffffffc0203e42:	aa260613          	addi	a2,a2,-1374 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203e46:	0e400593          	li	a1,228
ffffffffc0203e4a:	00003517          	auipc	a0,0x3
ffffffffc0203e4e:	a6e50513          	addi	a0,a0,-1426 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203e52:	df4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma5 == NULL);
ffffffffc0203e56:	00003697          	auipc	a3,0x3
ffffffffc0203e5a:	b6268693          	addi	a3,a3,-1182 # ffffffffc02069b8 <default_pmm_manager+0xd28>
ffffffffc0203e5e:	00002617          	auipc	a2,0x2
ffffffffc0203e62:	a8260613          	addi	a2,a2,-1406 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203e66:	0e600593          	li	a1,230
ffffffffc0203e6a:	00003517          	auipc	a0,0x3
ffffffffc0203e6e:	a4e50513          	addi	a0,a0,-1458 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203e72:	dd4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1 != NULL);
ffffffffc0203e76:	00003697          	auipc	a3,0x3
ffffffffc0203e7a:	b0268693          	addi	a3,a3,-1278 # ffffffffc0206978 <default_pmm_manager+0xce8>
ffffffffc0203e7e:	00002617          	auipc	a2,0x2
ffffffffc0203e82:	a6260613          	addi	a2,a2,-1438 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203e86:	0de00593          	li	a1,222
ffffffffc0203e8a:	00003517          	auipc	a0,0x3
ffffffffc0203e8e:	a2e50513          	addi	a0,a0,-1490 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203e92:	db4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2 != NULL);
ffffffffc0203e96:	00003697          	auipc	a3,0x3
ffffffffc0203e9a:	af268693          	addi	a3,a3,-1294 # ffffffffc0206988 <default_pmm_manager+0xcf8>
ffffffffc0203e9e:	00002617          	auipc	a2,0x2
ffffffffc0203ea2:	a4260613          	addi	a2,a2,-1470 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203ea6:	0e000593          	li	a1,224
ffffffffc0203eaa:	00003517          	auipc	a0,0x3
ffffffffc0203eae:	a0e50513          	addi	a0,a0,-1522 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203eb2:	d94fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma3 == NULL);
ffffffffc0203eb6:	00003697          	auipc	a3,0x3
ffffffffc0203eba:	ae268693          	addi	a3,a3,-1310 # ffffffffc0206998 <default_pmm_manager+0xd08>
ffffffffc0203ebe:	00002617          	auipc	a2,0x2
ffffffffc0203ec2:	a2260613          	addi	a2,a2,-1502 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203ec6:	0e200593          	li	a1,226
ffffffffc0203eca:	00003517          	auipc	a0,0x3
ffffffffc0203ece:	9ee50513          	addi	a0,a0,-1554 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203ed2:	d74fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203ed6:	00003697          	auipc	a3,0x3
ffffffffc0203eda:	c4268693          	addi	a3,a3,-958 # ffffffffc0206b18 <default_pmm_manager+0xe88>
ffffffffc0203ede:	00002617          	auipc	a2,0x2
ffffffffc0203ee2:	a0260613          	addi	a2,a2,-1534 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203ee6:	10100593          	li	a1,257
ffffffffc0203eea:	00003517          	auipc	a0,0x3
ffffffffc0203eee:	9ce50513          	addi	a0,a0,-1586 # ffffffffc02068b8 <default_pmm_manager+0xc28>
    check_mm_struct = mm_create();
ffffffffc0203ef2:	00012797          	auipc	a5,0x12
ffffffffc0203ef6:	6a07b723          	sd	zero,1710(a5) # ffffffffc02165a0 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203efa:	d4cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(vma != NULL);
ffffffffc0203efe:	00002697          	auipc	a3,0x2
ffffffffc0203f02:	4da68693          	addi	a3,a3,1242 # ffffffffc02063d8 <default_pmm_manager+0x748>
ffffffffc0203f06:	00002617          	auipc	a2,0x2
ffffffffc0203f0a:	9da60613          	addi	a2,a2,-1574 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203f0e:	10800593          	li	a1,264
ffffffffc0203f12:	00003517          	auipc	a0,0x3
ffffffffc0203f16:	9a650513          	addi	a0,a0,-1626 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203f1a:	d2cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203f1e:	00003697          	auipc	a3,0x3
ffffffffc0203f22:	b6a68693          	addi	a3,a3,-1174 # ffffffffc0206a88 <default_pmm_manager+0xdf8>
ffffffffc0203f26:	00002617          	auipc	a2,0x2
ffffffffc0203f2a:	9ba60613          	addi	a2,a2,-1606 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203f2e:	10d00593          	li	a1,269
ffffffffc0203f32:	00003517          	auipc	a0,0x3
ffffffffc0203f36:	98650513          	addi	a0,a0,-1658 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203f3a:	d0cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(sum == 0);
ffffffffc0203f3e:	00003697          	auipc	a3,0x3
ffffffffc0203f42:	b6a68693          	addi	a3,a3,-1174 # ffffffffc0206aa8 <default_pmm_manager+0xe18>
ffffffffc0203f46:	00002617          	auipc	a2,0x2
ffffffffc0203f4a:	99a60613          	addi	a2,a2,-1638 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203f4e:	11700593          	li	a1,279
ffffffffc0203f52:	00003517          	auipc	a0,0x3
ffffffffc0203f56:	96650513          	addi	a0,a0,-1690 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203f5a:	cecfc0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203f5e:	00002617          	auipc	a2,0x2
ffffffffc0203f62:	e3a60613          	addi	a2,a2,-454 # ffffffffc0205d98 <default_pmm_manager+0x108>
ffffffffc0203f66:	06200593          	li	a1,98
ffffffffc0203f6a:	00002517          	auipc	a0,0x2
ffffffffc0203f6e:	d8650513          	addi	a0,a0,-634 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc0203f72:	cd4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203f76:	00002617          	auipc	a2,0x2
ffffffffc0203f7a:	d5260613          	addi	a2,a2,-686 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc0203f7e:	06900593          	li	a1,105
ffffffffc0203f82:	00002517          	auipc	a0,0x2
ffffffffc0203f86:	d6e50513          	addi	a0,a0,-658 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc0203f8a:	cbcfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203f8e:	00003697          	auipc	a3,0x3
ffffffffc0203f92:	b2a68693          	addi	a3,a3,-1238 # ffffffffc0206ab8 <default_pmm_manager+0xe28>
ffffffffc0203f96:	00002617          	auipc	a2,0x2
ffffffffc0203f9a:	94a60613          	addi	a2,a2,-1718 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203f9e:	12400593          	li	a1,292
ffffffffc0203fa2:	00003517          	auipc	a0,0x3
ffffffffc0203fa6:	91650513          	addi	a0,a0,-1770 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203faa:	c9cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203fae:	00002697          	auipc	a3,0x2
ffffffffc0203fb2:	41a68693          	addi	a3,a3,1050 # ffffffffc02063c8 <default_pmm_manager+0x738>
ffffffffc0203fb6:	00002617          	auipc	a2,0x2
ffffffffc0203fba:	92a60613          	addi	a2,a2,-1750 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203fbe:	10500593          	li	a1,261
ffffffffc0203fc2:	00003517          	auipc	a0,0x3
ffffffffc0203fc6:	8f650513          	addi	a0,a0,-1802 # ffffffffc02068b8 <default_pmm_manager+0xc28>
ffffffffc0203fca:	c7cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(mm != NULL);
ffffffffc0203fce:	00002697          	auipc	a3,0x2
ffffffffc0203fd2:	3d268693          	addi	a3,a3,978 # ffffffffc02063a0 <default_pmm_manager+0x710>
ffffffffc0203fd6:	00002617          	auipc	a2,0x2
ffffffffc0203fda:	90a60613          	addi	a2,a2,-1782 # ffffffffc02058e0 <commands+0x738>
ffffffffc0203fde:	0c200593          	li	a1,194
ffffffffc0203fe2:	00003517          	auipc	a0,0x3
ffffffffc0203fe6:	8d650513          	addi	a0,a0,-1834 # ffffffffc02068b8 <default_pmm_manager+0xc28>
...
ffffffffc0204006:	5a67a783          	lw	a5,1446(a5) # ffffffffc02165a8 <pgfault_num>
ffffffffc020400a:	2785                	addiw	a5,a5,1
ffffffffc020400c:	00012717          	auipc	a4,0x12
ffffffffc0204010:	58f72e23          	sw	a5,1436(a4) # ffffffffc02165a8 <pgfault_num>
...
ffffffffc0204036:	c1b9                	beqz	a1,ffffffffc020407c <do_pgfault+0x8e>
        ...
        */
        if (swap_init_ok) {
ffffffffc0204038:	00012797          	auipc	a5,0x12
ffffffffc020403c:	5607a783          	lw	a5,1376(a5) # ffffffffc0216598 <swap_init_ok>
...
ffffffffc0204090:	af450513          	addi	a0,a0,-1292 # ffffffffc0206b80 <default_pmm_manager+0xef0>
...
ffffffffc02040a2:	a9250513          	addi	a0,a0,-1390 # ffffffffc0206b30 <default_pmm_manager+0xea0>
...
ffffffffc02040b2:	afa50513          	addi	a0,a0,-1286 # ffffffffc0206ba8 <default_pmm_manager+0xf18>
...
ffffffffc02040c2:	aa250513          	addi	a0,a0,-1374 # ffffffffc0206b60 <default_pmm_manager+0xed0>
...
ffffffffc02040e8:	4aa7b223          	sd	a0,1188(a5) # ffffffffc0216588 <max_swap_offset>
}
ffffffffc02040ec:	0141                	addi	sp,sp,16
ffffffffc02040ee:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc02040f0:	00003617          	auipc	a2,0x3
ffffffffc02040f4:	ae060613          	addi	a2,a2,-1312 # ffffffffc0206bd0 <default_pmm_manager+0xf40>
ffffffffc02040f8:	45b5                	li	a1,13
ffffffffc02040fa:	00003517          	auipc	a0,0x3
ffffffffc02040fe:	af650513          	addi	a0,a0,-1290 # ffffffffc0206bf0 <default_pmm_manager+0xf60>
...
ffffffffc0204110:	00012717          	auipc	a4,0x12
ffffffffc0204114:	47873703          	ld	a4,1144(a4) # ffffffffc0216588 <max_swap_offset>
ffffffffc0204118:	04e7f563          	bgeu	a5,a4,ffffffffc0204162 <swapfs_read+0x5c>
    return page - pages + nbase;
ffffffffc020411c:	00012617          	auipc	a2,0x12
ffffffffc0204120:	45463603          	ld	a2,1108(a2) # ffffffffc0216570 <pages>
ffffffffc0204124:	8d91                	sub	a1,a1,a2
ffffffffc0204126:	4065d613          	srai	a2,a1,0x6
ffffffffc020412a:	00003717          	auipc	a4,0x3
ffffffffc020412e:	ef673703          	ld	a4,-266(a4) # ffffffffc0207020 <nbase>
ffffffffc0204132:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc0204134:	00c61713          	slli	a4,a2,0xc
ffffffffc0204138:	8331                	srli	a4,a4,0xc
ffffffffc020413a:	00012697          	auipc	a3,0x12
ffffffffc020413e:	42e6b683          	ld	a3,1070(a3) # ffffffffc0216568 <npage>
...
ffffffffc020414c:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc020414e:	00012797          	auipc	a5,0x12
ffffffffc0204152:	4327b783          	ld	a5,1074(a5) # ffffffffc0216580 <va_pa_offset>
...
ffffffffc0204168:	aa460613          	addi	a2,a2,-1372 # ffffffffc0206c08 <default_pmm_manager+0xf78>
ffffffffc020416c:	45d1                	li	a1,20
ffffffffc020416e:	00003517          	auipc	a0,0x3
ffffffffc0204172:	a8250513          	addi	a0,a0,-1406 # ffffffffc0206bf0 <default_pmm_manager+0xf60>
...
ffffffffc0204184:	b4860613          	addi	a2,a2,-1208 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc0204188:	00002517          	auipc	a0,0x2
ffffffffc020418c:	b6850513          	addi	a0,a0,-1176 # ffffffffc0205cf0 <default_pmm_manager+0x60>
...
ffffffffc02041a2:	3ea73703          	ld	a4,1002(a4) # ffffffffc0216588 <max_swap_offset>
ffffffffc02041a6:	04e7f563          	bgeu	a5,a4,ffffffffc02041f0 <swapfs_write+0x5c>
    return page - pages + nbase;
ffffffffc02041aa:	00012617          	auipc	a2,0x12
ffffffffc02041ae:	3c663603          	ld	a2,966(a2) # ffffffffc0216570 <pages>
ffffffffc02041b2:	8d91                	sub	a1,a1,a2
ffffffffc02041b4:	4065d613          	srai	a2,a1,0x6
ffffffffc02041b8:	00003717          	auipc	a4,0x3
ffffffffc02041bc:	e6873703          	ld	a4,-408(a4) # ffffffffc0207020 <nbase>
ffffffffc02041c0:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc02041c2:	00c61713          	slli	a4,a2,0xc
ffffffffc02041c6:	8331                	srli	a4,a4,0xc
ffffffffc02041c8:	00012697          	auipc	a3,0x12
ffffffffc02041cc:	3a06b683          	ld	a3,928(a3) # ffffffffc0216568 <npage>
...
ffffffffc02041da:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02041dc:	00012797          	auipc	a5,0x12
ffffffffc02041e0:	3a47b783          	ld	a5,932(a5) # ffffffffc0216580 <va_pa_offset>
...
ffffffffc02041f6:	a1660613          	addi	a2,a2,-1514 # ffffffffc0206c08 <default_pmm_manager+0xf78>
ffffffffc02041fa:	45e5                	li	a1,25
ffffffffc02041fc:	00003517          	auipc	a0,0x3
ffffffffc0204200:	9f450513          	addi	a0,a0,-1548 # ffffffffc0206bf0 <default_pmm_manager+0xf60>
...
ffffffffc0204212:	aba60613          	addi	a2,a2,-1350 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc0204216:	00002517          	auipc	a0,0x2
ffffffffc020421a:	ada50513          	addi	a0,a0,-1318 # ffffffffc0205cf0 <default_pmm_manager+0x60>
...
ffffffffc020427e:	475000ef          	jal	ra,ffffffffc0204ef2 <memset>
...
forkret(void) {
    forkrets(current->tf);
ffffffffc020428c:	00012797          	auipc	a5,0x12
ffffffffc0204290:	3247b783          	ld	a5,804(a5) # ffffffffc02165b0 <current>
...
ffffffffc020429e:	00012497          	auipc	s1,0x12
ffffffffc02042a2:	27a48493          	addi	s1,s1,634 # ffffffffc0216518 <name.2>
init_main(void *arg) {
ffffffffc02042a6:	f022                	sd	s0,32(sp)
ffffffffc02042a8:	e84a                	sd	s2,16(sp)
ffffffffc02042aa:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042ac:	00012917          	auipc	s2,0x12
ffffffffc02042b0:	30493903          	ld	s2,772(s2) # ffffffffc02165b0 <current>
    memset(name, 0, sizeof(name));
...
ffffffffc02042e8:	96c50513          	addi	a0,a0,-1684 # ffffffffc0206c50 <default_pmm_manager+0xfc0>
ffffffffc02042ec:	e95fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02042f0:	00003517          	auipc	a0,0x3
ffffffffc02042f4:	97050513          	addi	a0,a0,-1680 # ffffffffc0206c60 <default_pmm_manager+0xfd0>
...
ffffffffc020430e:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc0204310:	00012917          	auipc	s2,0x12
ffffffffc0204314:	2a090913          	addi	s2,s2,672 # ffffffffc02165b0 <current>
proc_run(struct proc_struct *proc) {
ffffffffc0204318:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc020431a:	00093483          	ld	s1,0(s2)
proc_run(struct proc_struct *proc) {
ffffffffc020431e:	f406                	sd	ra,40(sp)
ffffffffc0204320:	e84e                	sd	s3,16(sp)
    if (proc != current) {
ffffffffc0204322:	02a48963          	beq	s1,a0,ffffffffc0204354 <proc_run+0x48>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204326:	100027f3          	csrr	a5,sstatus
ffffffffc020432a:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020432c:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020432e:	e3a1                	bnez	a5,ffffffffc020436e <proc_run+0x62>
            lcr3(next->cr3); // 更换页表
ffffffffc0204330:	755c                	ld	a5,168(a0)
...
ffffffffc0204332:	80000737          	lui	a4,0x80000
            current=proc; // 更新当前线程为proc
ffffffffc0204336:	00a93023          	sd	a0,0(s2)
ffffffffc020433a:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc020433e:	8fd9                	or	a5,a5,a4
ffffffffc0204340:	18079073          	csrw	satp,a5
            switch_to(&(prev->context),&(next->context)); // 上下文切换
ffffffffc0204344:	03050593          	addi	a1,a0,48
ffffffffc0204348:	03048513          	addi	a0,s1,48
ffffffffc020434c:	5f6000ef          	jal	ra,ffffffffc0204942 <switch_to>
    if (flag) {
ffffffffc0204350:	00099863          	bnez	s3,ffffffffc0204360 <proc_run+0x54>
}
ffffffffc0204354:	70a2                	ld	ra,40(sp)
ffffffffc0204356:	7482                	ld	s1,32(sp)
ffffffffc0204358:	6962                	ld	s2,24(sp)
ffffffffc020435a:	69c2                	ld	s3,16(sp)
...
ffffffffc0204366:	69c2                	ld	s3,16(sp)
ffffffffc0204368:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc020436a:	a52fc06f          	j	ffffffffc02005bc <intr_enable>
ffffffffc020436e:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0204370:	a52fc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204374:	6522                	ld	a0,8(sp)
ffffffffc0204376:	4985                	li	s3,1
ffffffffc0204378:	bf65                	j	ffffffffc0204330 <proc_run+0x24>
...
ffffffffc020437e:	00012497          	auipc	s1,0x12
ffffffffc0204382:	24a48493          	addi	s1,s1,586 # ffffffffc02165c8 <nr_process>
ffffffffc0204386:	4098                	lw	a4,0(s1)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204388:	f406                	sd	ra,40(sp)
ffffffffc020438a:	f022                	sd	s0,32(sp)
ffffffffc020438c:	e84a                	sd	s2,16(sp)
...
ffffffffc02043b8:	e74fd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc02043bc:	1e050763          	beqz	a0,ffffffffc02045aa <do_fork+0x230>
    return page - pages + nbase;
ffffffffc02043c0:	00012697          	auipc	a3,0x12
ffffffffc02043c4:	1b06b683          	ld	a3,432(a3) # ffffffffc0216570 <pages>
ffffffffc02043c8:	40d506b3          	sub	a3,a0,a3
ffffffffc02043cc:	8699                	srai	a3,a3,0x6
ffffffffc02043ce:	00003517          	auipc	a0,0x3
ffffffffc02043d2:	c5253503          	ld	a0,-942(a0) # ffffffffc0207020 <nbase>
ffffffffc02043d6:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc02043d8:	00c69793          	slli	a5,a3,0xc
ffffffffc02043dc:	83b1                	srli	a5,a5,0xc
ffffffffc02043de:	00012717          	auipc	a4,0x12
ffffffffc02043e2:	18a73703          	ld	a4,394(a4) # ffffffffc0216568 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc02043e6:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043e8:	22e7fe63          	bgeu	a5,a4,ffffffffc0204624 <do_fork+0x2aa>
    assert(current->mm == NULL);
ffffffffc02043ec:	000a3783          	ld	a5,0(s4)
ffffffffc02043f0:	00012717          	auipc	a4,0x12
ffffffffc02043f4:	19073703          	ld	a4,400(a4) # ffffffffc0216580 <va_pa_offset>
ffffffffc02043f8:	96ba                	add	a3,a3,a4
ffffffffc02043fa:	779c                	ld	a5,40(a5)
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02043fc:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc0204400:	20079263          	bnez	a5,ffffffffc0204604 <do_fork+0x28a>
...
ffffffffc020441c:	6608                	ld	a0,8(a2)
ffffffffc020441e:	6a0c                	ld	a1,16(a2)
ffffffffc0204420:	6e18                	ld	a4,24(a2)
ffffffffc0204422:	0107b023          	sd	a6,0(a5)
ffffffffc0204426:	e788                	sd	a0,8(a5)
ffffffffc0204428:	eb8c                	sd	a1,16(a5)
ffffffffc020442a:	ef98                	sd	a4,24(a5)
ffffffffc020442c:	02060613          	addi	a2,a2,32
ffffffffc0204430:	02078793          	addi	a5,a5,32
...
ffffffffc020445a:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020445c:	12079663          	bnez	a5,ffffffffc0204588 <do_fork+0x20e>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204460:	00007817          	auipc	a6,0x7
ffffffffc0204464:	bf880813          	addi	a6,a6,-1032 # ffffffffc020b058 <last_pid.1>
ffffffffc0204468:	00082783          	lw	a5,0(a6)
ffffffffc020446c:	6709                	lui	a4,0x2
ffffffffc020446e:	0017851b          	addiw	a0,a5,1
ffffffffc0204472:	00a82023          	sw	a0,0(a6)
ffffffffc0204476:	08e55163          	bge	a0,a4,ffffffffc02044f8 <do_fork+0x17e>
    if (last_pid >= next_safe) {
ffffffffc020447a:	00007317          	auipc	t1,0x7
ffffffffc020447e:	be230313          	addi	t1,t1,-1054 # ffffffffc020b05c <next_safe.0>
ffffffffc0204482:	00032783          	lw	a5,0(t1)
...
ffffffffc0204498:	2501                	sext.w	a0,a0
ffffffffc020449a:	5d8000ef          	jal	ra,ffffffffc0204a72 <hash32>
ffffffffc020449e:	02051793          	slli	a5,a0,0x20
ffffffffc02044a2:	01c7d513          	srli	a0,a5,0x1c
ffffffffc02044a6:	0000e797          	auipc	a5,0xe
ffffffffc02044aa:	07278793          	addi	a5,a5,114 # ffffffffc0212518 <hash_list>
ffffffffc02044ae:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc02044b0:	6510                	ld	a2,8(a0)
ffffffffc02044b2:	0d898793          	addi	a5,s3,216
ffffffffc02044b6:	6414                	ld	a3,8(s0)
        nr_process++;
ffffffffc02044b8:	4098                	lw	a4,0(s1)
    prev->next = next->prev = elm;
ffffffffc02044ba:	e21c                	sd	a5,0(a2)
...
ffffffffc02044c6:	0ca9bc23          	sd	a0,216(s3)
    prev->next = next->prev = elm;
ffffffffc02044ca:	e29c                	sd	a5,0(a3)
        nr_process++;
ffffffffc02044cc:	2705                	addiw	a4,a4,1
ffffffffc02044ce:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc02044d0:	0cd9b823          	sd	a3,208(s3)
    elm->prev = prev;
ffffffffc02044d4:	0c89b423          	sd	s0,200(s3)
...
ffffffffc02044e0:	4cc000ef          	jal	ra,ffffffffc02049ac <wakeup_proc>
    ret = proc->pid;
ffffffffc02044e4:	0049a503          	lw	a0,4(s3)
}
ffffffffc02044e8:	70a2                	ld	ra,40(sp)
ffffffffc02044ea:	7402                	ld	s0,32(sp)
ffffffffc02044ec:	64e2                	ld	s1,24(sp)
ffffffffc02044ee:	6942                	ld	s2,16(sp)
ffffffffc02044f0:	69a2                	ld	s3,8(sp)
ffffffffc02044f2:	6a02                	ld	s4,0(sp)
ffffffffc02044f4:	6145                	addi	sp,sp,48
ffffffffc02044f6:	8082                	ret
        last_pid = 1;
ffffffffc02044f8:	4785                	li	a5,1
ffffffffc02044fa:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02044fe:	4505                	li	a0,1
ffffffffc0204500:	00007317          	auipc	t1,0x7
ffffffffc0204504:	b5c30313          	addi	t1,t1,-1188 # ffffffffc020b05c <next_safe.0>
    return listelm->next;
ffffffffc0204508:	00012417          	auipc	s0,0x12
ffffffffc020450c:	02040413          	addi	s0,s0,32 # ffffffffc0216528 <proc_list>
ffffffffc0204510:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
...
ffffffffc0204520:	088e0063          	beq	t3,s0,ffffffffc02045a0 <do_fork+0x226>
ffffffffc0204524:	88ae                	mv	a7,a1
ffffffffc0204526:	87f2                	mv	a5,t3
ffffffffc0204528:	6609                	lui	a2,0x2
ffffffffc020452a:	a811                	j	ffffffffc020453e <do_fork+0x1c4>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc020452c:	00e6d663          	bge	a3,a4,ffffffffc0204538 <do_fork+0x1be>
ffffffffc0204530:	00c75463          	bge	a4,a2,ffffffffc0204538 <do_fork+0x1be>
ffffffffc0204534:	863a                	mv	a2,a4
ffffffffc0204536:	4885                	li	a7,1
ffffffffc0204538:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020453a:	00878d63          	beq	a5,s0,ffffffffc0204554 <do_fork+0x1da>
            if (proc->pid == last_pid) {
ffffffffc020453e:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc0204542:	fed715e3          	bne	a4,a3,ffffffffc020452c <do_fork+0x1b2>
                if (++ last_pid >= next_safe) {
ffffffffc0204546:	2685                	addiw	a3,a3,1
ffffffffc0204548:	04c6d763          	bge	a3,a2,ffffffffc0204596 <do_fork+0x21c>
ffffffffc020454c:	679c                	ld	a5,8(a5)
ffffffffc020454e:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc0204550:	fe8797e3          	bne	a5,s0,ffffffffc020453e <do_fork+0x1c4>
ffffffffc0204554:	c581                	beqz	a1,ffffffffc020455c <do_fork+0x1e2>
...
ffffffffc0204582:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204584:	ec078ee3          	beqz	a5,ffffffffc0204460 <do_fork+0xe6>
        intr_disable();
ffffffffc0204588:	83afc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc020458c:	4905                	li	s2,1
ffffffffc020458e:	bdc9                	j	ffffffffc0204460 <do_fork+0xe6>
        intr_enable();
ffffffffc0204590:	82cfc0ef          	jal	ra,ffffffffc02005bc <intr_enable>
ffffffffc0204594:	b7a9                	j	ffffffffc02044de <do_fork+0x164>
                    if (last_pid >= MAX_PID) {
ffffffffc0204596:	01d6c363          	blt	a3,t4,ffffffffc020459c <do_fork+0x222>
                        last_pid = 1;
ffffffffc020459a:	4685                	li	a3,1
                    goto repeat;
ffffffffc020459c:	4585                	li	a1,1
ffffffffc020459e:	b749                	j	ffffffffc0204520 <do_fork+0x1a6>
ffffffffc02045a0:	cda9                	beqz	a1,ffffffffc02045fa <do_fork+0x280>
ffffffffc02045a2:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc02045a6:	8536                	mv	a0,a3
ffffffffc02045a8:	b5ed                	j	ffffffffc0204492 <do_fork+0x118>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc02045aa:	0109b683          	ld	a3,16(s3)
    return pa2page(PADDR(kva));
ffffffffc02045ae:	c02007b7          	lui	a5,0xc0200
ffffffffc02045b2:	0af6e163          	bltu	a3,a5,ffffffffc0204654 <do_fork+0x2da>
ffffffffc02045b6:	00012797          	auipc	a5,0x12
ffffffffc02045ba:	fca7b783          	ld	a5,-54(a5) # ffffffffc0216580 <va_pa_offset>
ffffffffc02045be:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc02045c2:	83b1                	srli	a5,a5,0xc
ffffffffc02045c4:	00012717          	auipc	a4,0x12
ffffffffc02045c8:	fa473703          	ld	a4,-92(a4) # ffffffffc0216568 <npage>
ffffffffc02045cc:	06e7f863          	bgeu	a5,a4,ffffffffc020463c <do_fork+0x2c2>
    return &pages[PPN(pa) - nbase];
ffffffffc02045d0:	00003717          	auipc	a4,0x3
ffffffffc02045d4:	a5073703          	ld	a4,-1456(a4) # ffffffffc0207020 <nbase>
ffffffffc02045d8:	8f99                	sub	a5,a5,a4
ffffffffc02045da:	079a                	slli	a5,a5,0x6
ffffffffc02045dc:	00012517          	auipc	a0,0x12
ffffffffc02045e0:	f9453503          	ld	a0,-108(a0) # ffffffffc0216570 <pages>
ffffffffc02045e4:	953e                	add	a0,a0,a5
ffffffffc02045e6:	4589                	li	a1,2
ffffffffc02045e8:	cd6fd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    kfree(proc);
ffffffffc02045ec:	854e                	mv	a0,s3
ffffffffc02045ee:	b10fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc02045f2:	5571                	li	a0,-4
    goto fork_out;
ffffffffc02045f4:	bdd5                	j	ffffffffc02044e8 <do_fork+0x16e>
    int ret = -E_NO_FREE_PROC;
ffffffffc02045f6:	556d                	li	a0,-5
ffffffffc02045f8:	bdc5                	j	ffffffffc02044e8 <do_fork+0x16e>
    return last_pid;
ffffffffc02045fa:	00082503          	lw	a0,0(a6)
ffffffffc02045fe:	bd51                	j	ffffffffc0204492 <do_fork+0x118>
    ret = -E_NO_MEM;
ffffffffc0204600:	5571                	li	a0,-4
    return ret;
ffffffffc0204602:	b5dd                	j	ffffffffc02044e8 <do_fork+0x16e>
    assert(current->mm == NULL);
ffffffffc0204604:	00002697          	auipc	a3,0x2
ffffffffc0204608:	67c68693          	addi	a3,a3,1660 # ffffffffc0206c80 <default_pmm_manager+0xff0>
ffffffffc020460c:	00001617          	auipc	a2,0x1
ffffffffc0204610:	2d460613          	addi	a2,a2,724 # ffffffffc02058e0 <commands+0x738>
ffffffffc0204614:	10700593          	li	a1,263
ffffffffc0204618:	00002517          	auipc	a0,0x2
ffffffffc020461c:	68050513          	addi	a0,a0,1664 # ffffffffc0206c98 <default_pmm_manager+0x1008>
ffffffffc0204620:	e27fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc0204624:	00001617          	auipc	a2,0x1
ffffffffc0204628:	6a460613          	addi	a2,a2,1700 # ffffffffc0205cc8 <default_pmm_manager+0x38>
ffffffffc020462c:	06900593          	li	a1,105
ffffffffc0204630:	00001517          	auipc	a0,0x1
ffffffffc0204634:	6c050513          	addi	a0,a0,1728 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc0204638:	e0ffb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc020463c:	00001617          	auipc	a2,0x1
ffffffffc0204640:	75c60613          	addi	a2,a2,1884 # ffffffffc0205d98 <default_pmm_manager+0x108>
ffffffffc0204644:	06200593          	li	a1,98
ffffffffc0204648:	00001517          	auipc	a0,0x1
ffffffffc020464c:	6a850513          	addi	a0,a0,1704 # ffffffffc0205cf0 <default_pmm_manager+0x60>
ffffffffc0204650:	df7fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return pa2page(PADDR(kva));
ffffffffc0204654:	00001617          	auipc	a2,0x1
ffffffffc0204658:	71c60613          	addi	a2,a2,1820 # ffffffffc0205d70 <default_pmm_manager+0xe0>
ffffffffc020465c:	06e00593          	li	a1,110
ffffffffc0204660:	00001517          	auipc	a0,0x1
ffffffffc0204664:	69050513          	addi	a0,a0,1680 # ffffffffc0205cf0 <default_pmm_manager+0x60>
...
ffffffffc0204672:	f24a                	sd	s2,288(sp)
...
ffffffffc02046b2:	7452                	ld	s0,304(sp)
ffffffffc02046b4:	74b2                	ld	s1,296(sp)
ffffffffc02046b6:	7912                	ld	s2,288(sp)
ffffffffc02046b8:	6131                	addi	sp,sp,320
ffffffffc02046ba:	8082                	ret

ffffffffc02046bc <do_exit>:
do_exit(int error_code) {
ffffffffc02046bc:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc02046be:	00002617          	auipc	a2,0x2
ffffffffc02046c2:	5f260613          	addi	a2,a2,1522 # ffffffffc0206cb0 <default_pmm_manager+0x1020>
ffffffffc02046c6:	16c00593          	li	a1,364
ffffffffc02046ca:	00002517          	auipc	a0,0x2
ffffffffc02046ce:	5ce50513          	addi	a0,a0,1486 # ffffffffc0206c98 <default_pmm_manager+0x1008>
do_exit(int error_code) {
ffffffffc02046d2:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc02046d4:	d73fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02046d8 <proc_init>:
...
ffffffffc02046da:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc02046dc:	00012797          	auipc	a5,0x12
ffffffffc02046e0:	e4c78793          	addi	a5,a5,-436 # ffffffffc0216528 <proc_list>
ffffffffc02046e4:	f406                	sd	ra,40(sp)
ffffffffc02046e6:	f022                	sd	s0,32(sp)
ffffffffc02046e8:	e84a                	sd	s2,16(sp)
ffffffffc02046ea:	e44e                	sd	s3,8(sp)
ffffffffc02046ec:	0000e497          	auipc	s1,0xe
ffffffffc02046f0:	e2c48493          	addi	s1,s1,-468 # ffffffffc0212518 <hash_list>
ffffffffc02046f4:	e79c                	sd	a5,8(a5)
...
ffffffffc0204708:	fef71de3          	bne	a4,a5,ffffffffc0204702 <proc_init+0x2a>
...
ffffffffc0204718:	00a93023          	sd	a0,0(s2)
ffffffffc020471c:	18050d63          	beqz	a0,ffffffffc02048b6 <proc_init+0x1de>
        panic("cannot alloc idleproc.\n");
    }

    // check the proc structure
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc0204720:	07000513          	li	a0,112
ffffffffc0204724:	92afd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc0204728:	07000613          	li	a2,112
ffffffffc020472c:	4581                	li	a1,0
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc020472e:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc0204730:	7c2000ef          	jal	ra,ffffffffc0204ef2 <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc0204734:	00093503          	ld	a0,0(s2)
ffffffffc0204738:	85a2                	mv	a1,s0
ffffffffc020473a:	07000613          	li	a2,112
ffffffffc020473e:	03050513          	addi	a0,a0,48
ffffffffc0204742:	7da000ef          	jal	ra,ffffffffc0204f1c <memcmp>
ffffffffc0204746:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc0204748:	453d                	li	a0,15
ffffffffc020474a:	904fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc020474e:	463d                	li	a2,15
ffffffffc0204750:	4581                	li	a1,0
    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc0204752:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0204754:	79e000ef          	jal	ra,ffffffffc0204ef2 <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc0204758:	00093503          	ld	a0,0(s2)
ffffffffc020475c:	463d                	li	a2,15
ffffffffc020475e:	85a2                	mv	a1,s0
ffffffffc0204760:	0b450513          	addi	a0,a0,180
ffffffffc0204764:	7b8000ef          	jal	ra,ffffffffc0204f1c <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204768:	00093783          	ld	a5,0(s2)
ffffffffc020476c:	00012717          	auipc	a4,0x12
ffffffffc0204770:	dec73703          	ld	a4,-532(a4) # ffffffffc0216558 <boot_cr3>
ffffffffc0204774:	77d4                	ld	a3,168(a5)
ffffffffc0204776:	0ee68463          	beq	a3,a4,ffffffffc020485e <proc_init+0x186>
...
ffffffffc0204796:	75c000ef          	jal	ra,ffffffffc0204ef2 <memset>
...
ffffffffc02047c0:	54458593          	addi	a1,a1,1348 # ffffffffc0206d00 <default_pmm_manager+0x1070>
...
ffffffffc02047d2:	ded7b123          	sd	a3,-542(a5) # ffffffffc02165b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047d6:	e97ff0ef          	jal	ra,ffffffffc020466c <kernel_thread>
ffffffffc02047da:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc02047dc:	0ea05963          	blez	a0,ffffffffc02048ce <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID) {
ffffffffc02047e0:	6789                	lui	a5,0x2
ffffffffc02047e2:	fff5071b          	addiw	a4,a0,-1
ffffffffc02047e6:	17f9                	addi	a5,a5,-2
ffffffffc02047e8:	2501                	sext.w	a0,a0
ffffffffc02047ea:	02e7e363          	bltu	a5,a4,ffffffffc0204810 <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc02047ee:	45a9                	li	a1,10
ffffffffc02047f0:	282000ef          	jal	ra,ffffffffc0204a72 <hash32>
ffffffffc02047f4:	02051793          	slli	a5,a0,0x20
ffffffffc02047f8:	01c7d693          	srli	a3,a5,0x1c
ffffffffc02047fc:	96a6                	add	a3,a3,s1
ffffffffc02047fe:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc0204800:	a029                	j	ffffffffc020480a <proc_init+0x132>
            if (proc->pid == pid) {
ffffffffc0204802:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc0204806:	0a870563          	beq	a4,s0,ffffffffc02048b0 <proc_init+0x1d8>
    return listelm->next;
ffffffffc020480a:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020480c:	fef69be3          	bne	a3,a5,ffffffffc0204802 <proc_init+0x12a>
    return NULL;
ffffffffc0204810:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204812:	0b478493          	addi	s1,a5,180
...
ffffffffc020481a:	00012417          	auipc	s0,0x12
ffffffffc020481e:	da640413          	addi	s0,s0,-602 # ffffffffc02165c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204822:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0204824:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204826:	6cc000ef          	jal	ra,ffffffffc0204ef2 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020482a:	463d                	li	a2,15
ffffffffc020482c:	00002597          	auipc	a1,0x2
ffffffffc0204830:	50458593          	addi	a1,a1,1284 # ffffffffc0206d30 <default_pmm_manager+0x10a0>
ffffffffc0204834:	8526                	mv	a0,s1
ffffffffc0204836:	6ce000ef          	jal	ra,ffffffffc0204f04 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020483a:	00093783          	ld	a5,0(s2)
ffffffffc020483e:	c7e1                	beqz	a5,ffffffffc0204906 <proc_init+0x22e>
ffffffffc0204840:	43dc                	lw	a5,4(a5)
ffffffffc0204842:	e3f1                	bnez	a5,ffffffffc0204906 <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204844:	601c                	ld	a5,0(s0)
ffffffffc0204846:	c3c5                	beqz	a5,ffffffffc02048e6 <proc_init+0x20e>
ffffffffc0204848:	43d8                	lw	a4,4(a5)
ffffffffc020484a:	4785                	li	a5,1
ffffffffc020484c:	08f71d63          	bne	a4,a5,ffffffffc02048e6 <proc_init+0x20e>
}
...
ffffffffc020485c:	8082                	ret
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc020485e:	73d8                	ld	a4,160(a5)
ffffffffc0204860:	ff09                	bnez	a4,ffffffffc020477a <proc_init+0xa2>
ffffffffc0204862:	f0099ce3          	bnez	s3,ffffffffc020477a <proc_init+0xa2>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc0204866:	6394                	ld	a3,0(a5)
ffffffffc0204868:	577d                	li	a4,-1
ffffffffc020486a:	1702                	slli	a4,a4,0x20
ffffffffc020486c:	f0e697e3          	bne	a3,a4,ffffffffc020477a <proc_init+0xa2>
ffffffffc0204870:	4798                	lw	a4,8(a5)
ffffffffc0204872:	f00714e3          	bnez	a4,ffffffffc020477a <proc_init+0xa2>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc0204876:	6b98                	ld	a4,16(a5)
ffffffffc0204878:	f00711e3          	bnez	a4,ffffffffc020477a <proc_init+0xa2>
ffffffffc020487c:	4f98                	lw	a4,24(a5)
ffffffffc020487e:	2701                	sext.w	a4,a4
ffffffffc0204880:	ee071de3          	bnez	a4,ffffffffc020477a <proc_init+0xa2>
ffffffffc0204884:	7398                	ld	a4,32(a5)
ffffffffc0204886:	ee071ae3          	bnez	a4,ffffffffc020477a <proc_init+0xa2>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc020488a:	7798                	ld	a4,40(a5)
ffffffffc020488c:	ee0717e3          	bnez	a4,ffffffffc020477a <proc_init+0xa2>
ffffffffc0204890:	0b07a703          	lw	a4,176(a5)
ffffffffc0204894:	8d59                	or	a0,a0,a4
ffffffffc0204896:	0005071b          	sext.w	a4,a0
ffffffffc020489a:	ee0710e3          	bnez	a4,ffffffffc020477a <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
...
ffffffffc02048b0:	f2878793          	addi	a5,a5,-216
ffffffffc02048b4:	bfb9                	j	ffffffffc0204812 <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc02048b6:	00002617          	auipc	a2,0x2
ffffffffc02048ba:	41260613          	addi	a2,a2,1042 # ffffffffc0206cc8 <default_pmm_manager+0x1038>
ffffffffc02048be:	18400593          	li	a1,388
ffffffffc02048c2:	00002517          	auipc	a0,0x2
ffffffffc02048c6:	3d650513          	addi	a0,a0,982 # ffffffffc0206c98 <default_pmm_manager+0x1008>
ffffffffc02048ca:	b7dfb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc02048ce:	00002617          	auipc	a2,0x2
ffffffffc02048d2:	44260613          	addi	a2,a2,1090 # ffffffffc0206d10 <default_pmm_manager+0x1080>
ffffffffc02048d6:	1a400593          	li	a1,420
ffffffffc02048da:	00002517          	auipc	a0,0x2
ffffffffc02048de:	3be50513          	addi	a0,a0,958 # ffffffffc0206c98 <default_pmm_manager+0x1008>
ffffffffc02048e2:	b65fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02048e6:	00002697          	auipc	a3,0x2
ffffffffc02048ea:	47a68693          	addi	a3,a3,1146 # ffffffffc0206d60 <default_pmm_manager+0x10d0>
ffffffffc02048ee:	00001617          	auipc	a2,0x1
ffffffffc02048f2:	ff260613          	addi	a2,a2,-14 # ffffffffc02058e0 <commands+0x738>
ffffffffc02048f6:	1ab00593          	li	a1,427
ffffffffc02048fa:	00002517          	auipc	a0,0x2
ffffffffc02048fe:	39e50513          	addi	a0,a0,926 # ffffffffc0206c98 <default_pmm_manager+0x1008>
ffffffffc0204902:	b45fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204906:	00002697          	auipc	a3,0x2
ffffffffc020490a:	43268693          	addi	a3,a3,1074 # ffffffffc0206d38 <default_pmm_manager+0x10a8>
ffffffffc020490e:	00001617          	auipc	a2,0x1
ffffffffc0204912:	fd260613          	addi	a2,a2,-46 # ffffffffc02058e0 <commands+0x738>
ffffffffc0204916:	1aa00593          	li	a1,426
ffffffffc020491a:	00002517          	auipc	a0,0x2
ffffffffc020491e:	37e50513          	addi	a0,a0,894 # ffffffffc0206c98 <default_pmm_manager+0x1008>
ffffffffc0204922:	b25fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204926 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0204926:	1141                	addi	sp,sp,-16
ffffffffc0204928:	e022                	sd	s0,0(sp)
ffffffffc020492a:	e406                	sd	ra,8(sp)
ffffffffc020492c:	00012417          	auipc	s0,0x12
ffffffffc0204930:	c8440413          	addi	s0,s0,-892 # ffffffffc02165b0 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0204934:	6018                	ld	a4,0(s0)
ffffffffc0204936:	4f1c                	lw	a5,24(a4)
ffffffffc0204938:	2781                	sext.w	a5,a5
ffffffffc020493a:	dff5                	beqz	a5,ffffffffc0204936 <cpu_idle+0x10>
            schedule();
ffffffffc020493c:	0a2000ef          	jal	ra,ffffffffc02049de <schedule>
ffffffffc0204940:	bfd5                	j	ffffffffc0204934 <cpu_idle+0xe>

ffffffffc0204942 <switch_to>:
.text
...
ffffffffc0204942:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0204946:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc020494a:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc020494c:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc020494e:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0204952:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0204956:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc020495a:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc020495e:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0204962:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0204966:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc020496a:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc020496e:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0204972:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0204976:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc020497a:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc020497e:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0204980:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0204982:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0204986:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc020498a:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc020498e:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0204992:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0204996:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc020499a:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc020499e:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc02049a2:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc02049a6:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc02049aa:	8082                	ret

ffffffffc02049ac <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc02049ac:	411c                	lw	a5,0(a0)
ffffffffc02049ae:	4705                	li	a4,1
ffffffffc02049b0:	37f9                	addiw	a5,a5,-2
ffffffffc02049b2:	00f77563          	bgeu	a4,a5,ffffffffc02049bc <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc02049b6:	4789                	li	a5,2
ffffffffc02049b8:	c11c                	sw	a5,0(a0)
ffffffffc02049ba:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc02049bc:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02049be:	00002697          	auipc	a3,0x2
ffffffffc02049c2:	3ca68693          	addi	a3,a3,970 # ffffffffc0206d88 <default_pmm_manager+0x10f8>
ffffffffc02049c6:	00001617          	auipc	a2,0x1
ffffffffc02049ca:	f1a60613          	addi	a2,a2,-230 # ffffffffc02058e0 <commands+0x738>
ffffffffc02049ce:	45a5                	li	a1,9
ffffffffc02049d0:	00002517          	auipc	a0,0x2
ffffffffc02049d4:	3f850513          	addi	a0,a0,1016 # ffffffffc0206dc8 <default_pmm_manager+0x1138>
wakeup_proc(struct proc_struct *proc) {
ffffffffc02049d8:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02049da:	a6dfb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02049de <schedule>:
}

void
schedule(void) {
ffffffffc02049de:	1141                	addi	sp,sp,-16
ffffffffc02049e0:	e406                	sd	ra,8(sp)
ffffffffc02049e2:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02049e4:	100027f3          	csrr	a5,sstatus
ffffffffc02049e8:	8b89                	andi	a5,a5,2
ffffffffc02049ea:	4401                	li	s0,0
ffffffffc02049ec:	efbd                	bnez	a5,ffffffffc0204a6a <schedule+0x8c>
    bool intr_flag;
...
ffffffffc02049ee:	00012897          	auipc	a7,0x12
ffffffffc02049f2:	bc28b883          	ld	a7,-1086(a7) # ffffffffc02165b0 <current>
ffffffffc02049f6:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049fa:	00012517          	auipc	a0,0x12
ffffffffc02049fe:	bbe53503          	ld	a0,-1090(a0) # ffffffffc02165b8 <idleproc>
ffffffffc0204a02:	04a88e63          	beq	a7,a0,ffffffffc0204a5e <schedule+0x80>
ffffffffc0204a06:	0c888693          	addi	a3,a7,200
ffffffffc0204a0a:	00012617          	auipc	a2,0x12
ffffffffc0204a0e:	b1e60613          	addi	a2,a2,-1250 # ffffffffc0216528 <proc_list>
        le = last;
ffffffffc0204a12:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc0204a16:	4809                	li	a6,2
ffffffffc0204a18:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0204a1a:	00c78863          	beq	a5,a2,ffffffffc0204a2a <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204a1e:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0204a22:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204a26:	03070163          	beq	a4,a6,ffffffffc0204a48 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc0204a2a:	fef697e3          	bne	a3,a5,ffffffffc0204a18 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a2e:	ed89                	bnez	a1,ffffffffc0204a48 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0204a30:	451c                	lw	a5,8(a0)
ffffffffc0204a32:	2785                	addiw	a5,a5,1
ffffffffc0204a34:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0204a36:	00a88463          	beq	a7,a0,ffffffffc0204a3e <schedule+0x60>
            proc_run(next);
ffffffffc0204a3a:	8d3ff0ef          	jal	ra,ffffffffc020430c <proc_run>
    if (flag) {
ffffffffc0204a3e:	e819                	bnez	s0,ffffffffc0204a54 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc0204a40:	60a2                	ld	ra,8(sp)
ffffffffc0204a42:	6402                	ld	s0,0(sp)
ffffffffc0204a44:	0141                	addi	sp,sp,16
ffffffffc0204a46:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a48:	4198                	lw	a4,0(a1)
ffffffffc0204a4a:	4789                	li	a5,2
ffffffffc0204a4c:	fef712e3          	bne	a4,a5,ffffffffc0204a30 <schedule+0x52>
ffffffffc0204a50:	852e                	mv	a0,a1
ffffffffc0204a52:	bff9                	j	ffffffffc0204a30 <schedule+0x52>
}
ffffffffc0204a54:	6402                	ld	s0,0(sp)
ffffffffc0204a56:	60a2                	ld	ra,8(sp)
ffffffffc0204a58:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0204a5a:	b63fb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204a5e:	00012617          	auipc	a2,0x12
ffffffffc0204a62:	aca60613          	addi	a2,a2,-1334 # ffffffffc0216528 <proc_list>
ffffffffc0204a66:	86b2                	mv	a3,a2
ffffffffc0204a68:	b76d                	j	ffffffffc0204a12 <schedule+0x34>
        intr_disable();
ffffffffc0204a6a:	b59fb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204a6e:	4405                	li	s0,1
ffffffffc0204a70:	bfbd                	j	ffffffffc02049ee <schedule+0x10>

ffffffffc0204a72 <hash32>:
 *
...
ffffffffc0204a72:	9e3707b7          	lui	a5,0x9e370
ffffffffc0204a76:	2785                	addiw	a5,a5,1
ffffffffc0204a78:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0204a7c:	02000793          	li	a5,32
ffffffffc0204a80:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a82:	00f5553b          	srlw	a0,a0,a5
ffffffffc0204a86:	8082                	ret

ffffffffc0204a88 <printnum>:
 * */
static void
...
ffffffffc0204a88:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a8c:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204a8e:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a92:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0204a94:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a98:	f022                	sd	s0,32(sp)
ffffffffc0204a9a:	ec26                	sd	s1,24(sp)
ffffffffc0204a9c:	e84a                	sd	s2,16(sp)
ffffffffc0204a9e:	f406                	sd	ra,40(sp)
ffffffffc0204aa0:	e44e                	sd	s3,8(sp)
ffffffffc0204aa2:	84aa                	mv	s1,a0
ffffffffc0204aa4:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0204aa6:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204aaa:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204aac:	03067e63          	bgeu	a2,a6,ffffffffc0204ae8 <printnum+0x60>
ffffffffc0204ab0:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0204ab2:	00805763          	blez	s0,ffffffffc0204ac0 <printnum+0x38>
ffffffffc0204ab6:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204ab8:	85ca                	mv	a1,s2
ffffffffc0204aba:	854e                	mv	a0,s3
ffffffffc0204abc:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204abe:	fc65                	bnez	s0,ffffffffc0204ab6 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204ac0:	1a02                	slli	s4,s4,0x20
ffffffffc0204ac2:	00002797          	auipc	a5,0x2
ffffffffc0204ac6:	31e78793          	addi	a5,a5,798 # ffffffffc0206de0 <default_pmm_manager+0x1150>
ffffffffc0204aca:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204ace:	9a3e                	add	s4,s4,a5
}
ffffffffc0204ad0:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204ad2:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204ad6:	70a2                	ld	ra,40(sp)
ffffffffc0204ad8:	69a2                	ld	s3,8(sp)
ffffffffc0204ada:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204adc:	85ca                	mv	a1,s2
ffffffffc0204ade:	87a6                	mv	a5,s1
}
ffffffffc0204ae0:	6942                	ld	s2,16(sp)
ffffffffc0204ae2:	64e2                	ld	s1,24(sp)
ffffffffc0204ae4:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204ae6:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204ae8:	03065633          	divu	a2,a2,a6
ffffffffc0204aec:	8722                	mv	a4,s0
ffffffffc0204aee:	f9bff0ef          	jal	ra,ffffffffc0204a88 <printnum>
ffffffffc0204af2:	b7f9                	j	ffffffffc0204ac0 <printnum+0x38>

ffffffffc0204af4 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204af4:	7119                	addi	sp,sp,-128
ffffffffc0204af6:	f4a6                	sd	s1,104(sp)
ffffffffc0204af8:	f0ca                	sd	s2,96(sp)
ffffffffc0204afa:	ecce                	sd	s3,88(sp)
ffffffffc0204afc:	e8d2                	sd	s4,80(sp)
ffffffffc0204afe:	e4d6                	sd	s5,72(sp)
ffffffffc0204b00:	e0da                	sd	s6,64(sp)
ffffffffc0204b02:	fc5e                	sd	s7,56(sp)
ffffffffc0204b04:	f06a                	sd	s10,32(sp)
ffffffffc0204b06:	fc86                	sd	ra,120(sp)
ffffffffc0204b08:	f8a2                	sd	s0,112(sp)
ffffffffc0204b0a:	f862                	sd	s8,48(sp)
ffffffffc0204b0c:	f466                	sd	s9,40(sp)
ffffffffc0204b0e:	ec6e                	sd	s11,24(sp)
ffffffffc0204b10:	892a                	mv	s2,a0
ffffffffc0204b12:	84ae                	mv	s1,a1
ffffffffc0204b14:	8d32                	mv	s10,a2
ffffffffc0204b16:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204b18:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204b1c:	5b7d                	li	s6,-1
ffffffffc0204b1e:	00002a97          	auipc	s5,0x2
ffffffffc0204b22:	2eea8a93          	addi	s5,s5,750 # ffffffffc0206e0c <default_pmm_manager+0x117c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204b26:	00002b97          	auipc	s7,0x2
ffffffffc0204b2a:	4c2b8b93          	addi	s7,s7,1218 # ffffffffc0206fe8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b2e:	000d4503          	lbu	a0,0(s10)
ffffffffc0204b32:	001d0413          	addi	s0,s10,1
ffffffffc0204b36:	01350a63          	beq	a0,s3,ffffffffc0204b4a <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204b3a:	c121                	beqz	a0,ffffffffc0204b7a <vprintfmt+0x86>
            putch(ch, putdat);
...
ffffffffc0204b46:	ff351ae3          	bne	a0,s3,ffffffffc0204b3a <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b4a:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204b4e:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204b52:	4c81                	li	s9,0
ffffffffc0204b54:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204b56:	5c7d                	li	s8,-1
ffffffffc0204b58:	5dfd                	li	s11,-1
ffffffffc0204b5a:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204b5e:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b60:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b64:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b68:	00140d13          	addi	s10,s0,1
ffffffffc0204b6c:	04b56263          	bltu	a0,a1,ffffffffc0204bb0 <vprintfmt+0xbc>
ffffffffc0204b70:	058a                	slli	a1,a1,0x2
ffffffffc0204b72:	95d6                	add	a1,a1,s5
ffffffffc0204b74:	4194                	lw	a3,0(a1)
ffffffffc0204b76:	96d6                	add	a3,a3,s5
...
ffffffffc0204b96:	8082                	ret
            padc = '0';
ffffffffc0204b98:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204b9a:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b9e:	846a                	mv	s0,s10
ffffffffc0204ba0:	00140d13          	addi	s10,s0,1
ffffffffc0204ba4:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204ba8:	0ff5f593          	zext.b	a1,a1
ffffffffc0204bac:	fcb572e3          	bgeu	a0,a1,ffffffffc0204b70 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204bb0:	85a6                	mv	a1,s1
ffffffffc0204bb2:	02500513          	li	a0,37
ffffffffc0204bb6:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204bb8:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204bbc:	8d22                	mv	s10,s0
ffffffffc0204bbe:	f73788e3          	beq	a5,s3,ffffffffc0204b2e <vprintfmt+0x3a>
ffffffffc0204bc2:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204bc6:	1d7d                	addi	s10,s10,-1
ffffffffc0204bc8:	ff379de3          	bne	a5,s3,ffffffffc0204bc2 <vprintfmt+0xce>
ffffffffc0204bcc:	b78d                	j	ffffffffc0204b2e <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204bce:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204bd2:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bd6:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204bd8:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204bdc:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204be0:	02d86463          	bltu	a6,a3,ffffffffc0204c08 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204be4:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204be8:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204bec:	0186873b          	addw	a4,a3,s8
ffffffffc0204bf0:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204bf4:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204bf6:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204bfa:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204bfc:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204c00:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204c04:	fed870e3          	bgeu	a6,a3,ffffffffc0204be4 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204c08:	f40ddce3          	bgez	s11,ffffffffc0204b60 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204c0c:	8de2                	mv	s11,s8
ffffffffc0204c0e:	5c7d                	li	s8,-1
ffffffffc0204c10:	bf81                	j	ffffffffc0204b60 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204c12:	fffdc693          	not	a3,s11
ffffffffc0204c16:	96fd                	srai	a3,a3,0x3f
ffffffffc0204c18:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c1c:	00144603          	lbu	a2,1(s0)
ffffffffc0204c20:	2d81                	sext.w	s11,s11
ffffffffc0204c22:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c24:	bf35                	j	ffffffffc0204b60 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204c26:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c2a:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204c2e:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c30:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204c32:	bfd9                	j	ffffffffc0204c08 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204c34:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c36:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c3a:	01174463          	blt	a4,a7,ffffffffc0204c42 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204c3e:	1a088e63          	beqz	a7,ffffffffc0204dfa <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204c42:	000a3603          	ld	a2,0(s4)
ffffffffc0204c46:	46c1                	li	a3,16
ffffffffc0204c48:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204c4a:	2781                	sext.w	a5,a5
ffffffffc0204c4c:	876e                	mv	a4,s11
ffffffffc0204c4e:	85a6                	mv	a1,s1
ffffffffc0204c50:	854a                	mv	a0,s2
ffffffffc0204c52:	e37ff0ef          	jal	ra,ffffffffc0204a88 <printnum>
            break;
ffffffffc0204c56:	bde1                	j	ffffffffc0204b2e <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204c58:	000a2503          	lw	a0,0(s4)
ffffffffc0204c5c:	85a6                	mv	a1,s1
ffffffffc0204c5e:	0a21                	addi	s4,s4,8
ffffffffc0204c60:	9902                	jalr	s2
            break;
ffffffffc0204c62:	b5f1                	j	ffffffffc0204b2e <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c64:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c66:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c6a:	01174463          	blt	a4,a7,ffffffffc0204c72 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204c6e:	18088163          	beqz	a7,ffffffffc0204df0 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204c72:	000a3603          	ld	a2,0(s4)
ffffffffc0204c76:	46a9                	li	a3,10
ffffffffc0204c78:	8a2e                	mv	s4,a1
ffffffffc0204c7a:	bfc1                	j	ffffffffc0204c4a <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c7c:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c80:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c82:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c84:	bdf1                	j	ffffffffc0204b60 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c86:	85a6                	mv	a1,s1
ffffffffc0204c88:	02500513          	li	a0,37
ffffffffc0204c8c:	9902                	jalr	s2
            break;
ffffffffc0204c8e:	b545                	j	ffffffffc0204b2e <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c90:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204c94:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c96:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c98:	b5e1                	j	ffffffffc0204b60 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204c9a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c9c:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204ca0:	01174463          	blt	a4,a7,ffffffffc0204ca8 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204ca4:	14088163          	beqz	a7,ffffffffc0204de6 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204ca8:	000a3603          	ld	a2,0(s4)
ffffffffc0204cac:	46a1                	li	a3,8
ffffffffc0204cae:	8a2e                	mv	s4,a1
ffffffffc0204cb0:	bf69                	j	ffffffffc0204c4a <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204cb2:	03000513          	li	a0,48
ffffffffc0204cb6:	85a6                	mv	a1,s1
ffffffffc0204cb8:	e03e                	sd	a5,0(sp)
ffffffffc0204cba:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204cbc:	85a6                	mv	a1,s1
ffffffffc0204cbe:	07800513          	li	a0,120
ffffffffc0204cc2:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204cc4:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204cc6:	6782                	ld	a5,0(sp)
ffffffffc0204cc8:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204cca:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204cce:	bfb5                	j	ffffffffc0204c4a <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204cd0:	000a3403          	ld	s0,0(s4)
ffffffffc0204cd4:	008a0713          	addi	a4,s4,8
ffffffffc0204cd8:	e03a                	sd	a4,0(sp)
ffffffffc0204cda:	14040263          	beqz	s0,ffffffffc0204e1e <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204cde:	0fb05763          	blez	s11,ffffffffc0204dcc <vprintfmt+0x2d8>
ffffffffc0204ce2:	02d00693          	li	a3,45
ffffffffc0204ce6:	0cd79163          	bne	a5,a3,ffffffffc0204da8 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cea:	00044783          	lbu	a5,0(s0)
ffffffffc0204cee:	0007851b          	sext.w	a0,a5
ffffffffc0204cf2:	cf85                	beqz	a5,ffffffffc0204d2a <vprintfmt+0x236>
ffffffffc0204cf4:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204cf8:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cfc:	000c4563          	bltz	s8,ffffffffc0204d06 <vprintfmt+0x212>
ffffffffc0204d00:	3c7d                	addiw	s8,s8,-1
ffffffffc0204d02:	036c0263          	beq	s8,s6,ffffffffc0204d26 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204d06:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d08:	0e0c8e63          	beqz	s9,ffffffffc0204e04 <vprintfmt+0x310>
ffffffffc0204d0c:	3781                	addiw	a5,a5,-32
ffffffffc0204d0e:	0ef47b63          	bgeu	s0,a5,ffffffffc0204e04 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204d12:	03f00513          	li	a0,63
ffffffffc0204d16:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d18:	000a4783          	lbu	a5,0(s4)
ffffffffc0204d1c:	3dfd                	addiw	s11,s11,-1
ffffffffc0204d1e:	0a05                	addi	s4,s4,1
ffffffffc0204d20:	0007851b          	sext.w	a0,a5
ffffffffc0204d24:	ffe1                	bnez	a5,ffffffffc0204cfc <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204d26:	01b05963          	blez	s11,ffffffffc0204d38 <vprintfmt+0x244>
...
ffffffffc0204d32:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204d34:	fe0d9be3          	bnez	s11,ffffffffc0204d2a <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204d38:	6a02                	ld	s4,0(sp)
ffffffffc0204d3a:	bbd5                	j	ffffffffc0204b2e <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204d3c:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204d3e:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204d42:	01174463          	blt	a4,a7,ffffffffc0204d4a <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204d46:	08088d63          	beqz	a7,ffffffffc0204de0 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204d4a:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204d4e:	0a044d63          	bltz	s0,ffffffffc0204e08 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204d52:	8622                	mv	a2,s0
ffffffffc0204d54:	8a66                	mv	s4,s9
ffffffffc0204d56:	46a9                	li	a3,10
ffffffffc0204d58:	bdcd                	j	ffffffffc0204c4a <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204d5a:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d5e:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204d60:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204d62:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204d66:	8fb5                	xor	a5,a5,a3
ffffffffc0204d68:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d6c:	02d74163          	blt	a4,a3,ffffffffc0204d8e <vprintfmt+0x29a>
ffffffffc0204d70:	00369793          	slli	a5,a3,0x3
ffffffffc0204d74:	97de                	add	a5,a5,s7
ffffffffc0204d76:	639c                	ld	a5,0(a5)
ffffffffc0204d78:	cb99                	beqz	a5,ffffffffc0204d8e <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204d7a:	86be                	mv	a3,a5
ffffffffc0204d7c:	00000617          	auipc	a2,0x0
ffffffffc0204d80:	1ec60613          	addi	a2,a2,492 # ffffffffc0204f68 <etext+0x28>
ffffffffc0204d84:	85a6                	mv	a1,s1
ffffffffc0204d86:	854a                	mv	a0,s2
ffffffffc0204d88:	0ce000ef          	jal	ra,ffffffffc0204e56 <printfmt>
ffffffffc0204d8c:	b34d                	j	ffffffffc0204b2e <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d8e:	00002617          	auipc	a2,0x2
ffffffffc0204d92:	07260613          	addi	a2,a2,114 # ffffffffc0206e00 <default_pmm_manager+0x1170>
ffffffffc0204d96:	85a6                	mv	a1,s1
ffffffffc0204d98:	854a                	mv	a0,s2
ffffffffc0204d9a:	0bc000ef          	jal	ra,ffffffffc0204e56 <printfmt>
ffffffffc0204d9e:	bb41                	j	ffffffffc0204b2e <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204da0:	00002417          	auipc	s0,0x2
ffffffffc0204da4:	05840413          	addi	s0,s0,88 # ffffffffc0206df8 <default_pmm_manager+0x1168>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204da8:	85e2                	mv	a1,s8
ffffffffc0204daa:	8522                	mv	a0,s0
ffffffffc0204dac:	e43e                	sd	a5,8(sp)
ffffffffc0204dae:	0e2000ef          	jal	ra,ffffffffc0204e90 <strnlen>
ffffffffc0204db2:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204db6:	01b05b63          	blez	s11,ffffffffc0204dcc <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204dba:	67a2                	ld	a5,8(sp)
ffffffffc0204dbc:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204dc0:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204dc2:	85a6                	mv	a1,s1
ffffffffc0204dc4:	8552                	mv	a0,s4
ffffffffc0204dc6:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204dc8:	fe0d9ce3          	bnez	s11,ffffffffc0204dc0 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204dcc:	00044783          	lbu	a5,0(s0)
ffffffffc0204dd0:	00140a13          	addi	s4,s0,1
ffffffffc0204dd4:	0007851b          	sext.w	a0,a5
ffffffffc0204dd8:	d3a5                	beqz	a5,ffffffffc0204d38 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204dda:	05e00413          	li	s0,94
ffffffffc0204dde:	bf39                	j	ffffffffc0204cfc <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204de0:	000a2403          	lw	s0,0(s4)
ffffffffc0204de4:	b7ad                	j	ffffffffc0204d4e <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204de6:	000a6603          	lwu	a2,0(s4)
ffffffffc0204dea:	46a1                	li	a3,8
ffffffffc0204dec:	8a2e                	mv	s4,a1
ffffffffc0204dee:	bdb1                	j	ffffffffc0204c4a <vprintfmt+0x156>
ffffffffc0204df0:	000a6603          	lwu	a2,0(s4)
ffffffffc0204df4:	46a9                	li	a3,10
ffffffffc0204df6:	8a2e                	mv	s4,a1
ffffffffc0204df8:	bd89                	j	ffffffffc0204c4a <vprintfmt+0x156>
ffffffffc0204dfa:	000a6603          	lwu	a2,0(s4)
ffffffffc0204dfe:	46c1                	li	a3,16
ffffffffc0204e00:	8a2e                	mv	s4,a1
ffffffffc0204e02:	b5a1                	j	ffffffffc0204c4a <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204e04:	9902                	jalr	s2
ffffffffc0204e06:	bf09                	j	ffffffffc0204d18 <vprintfmt+0x224>
                putch('-', putdat);
...
ffffffffc0204e10:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204e12:	6782                	ld	a5,0(sp)
ffffffffc0204e14:	8a66                	mv	s4,s9
ffffffffc0204e16:	40800633          	neg	a2,s0
ffffffffc0204e1a:	46a9                	li	a3,10
ffffffffc0204e1c:	b53d                	j	ffffffffc0204c4a <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204e1e:	03b05163          	blez	s11,ffffffffc0204e40 <vprintfmt+0x34c>
ffffffffc0204e22:	02d00693          	li	a3,45
ffffffffc0204e26:	f6d79de3          	bne	a5,a3,ffffffffc0204da0 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204e2a:	00002417          	auipc	s0,0x2
ffffffffc0204e2e:	fce40413          	addi	s0,s0,-50 # ffffffffc0206df8 <default_pmm_manager+0x1168>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204e32:	02800793          	li	a5,40
ffffffffc0204e36:	02800513          	li	a0,40
ffffffffc0204e3a:	00140a13          	addi	s4,s0,1
ffffffffc0204e3e:	bd6d                	j	ffffffffc0204cf8 <vprintfmt+0x204>
ffffffffc0204e40:	00002a17          	auipc	s4,0x2
ffffffffc0204e44:	fb9a0a13          	addi	s4,s4,-71 # ffffffffc0206df9 <default_pmm_manager+0x1169>
ffffffffc0204e48:	02800513          	li	a0,40
ffffffffc0204e4c:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204e50:	05e00413          	li	s0,94
ffffffffc0204e54:	b565                	j	ffffffffc0204cfc <vprintfmt+0x208>

ffffffffc0204e56 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e56:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204e58:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e5c:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e5e:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e60:	ec06                	sd	ra,24(sp)
ffffffffc0204e62:	f83a                	sd	a4,48(sp)
ffffffffc0204e64:	fc3e                	sd	a5,56(sp)
ffffffffc0204e66:	e0c2                	sd	a6,64(sp)
ffffffffc0204e68:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204e6a:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e6c:	c89ff0ef          	jal	ra,ffffffffc0204af4 <vprintfmt>
}
ffffffffc0204e70:	60e2                	ld	ra,24(sp)
ffffffffc0204e72:	6161                	addi	sp,sp,80
ffffffffc0204e74:	8082                	ret

ffffffffc0204e76 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0204e76:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc0204e7a:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204e7c:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204e7e:	cb81                	beqz	a5,ffffffffc0204e8e <strlen+0x18>
        cnt ++;
ffffffffc0204e80:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e82:	00a707b3          	add	a5,a4,a0
ffffffffc0204e86:	0007c783          	lbu	a5,0(a5)
ffffffffc0204e8a:	fbfd                	bnez	a5,ffffffffc0204e80 <strlen+0xa>
...
ffffffffc0204e90:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e92:	e589                	bnez	a1,ffffffffc0204e9c <strnlen+0xc>
ffffffffc0204e94:	a811                	j	ffffffffc0204ea8 <strnlen+0x18>
        cnt ++;
ffffffffc0204e96:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e98:	00f58863          	beq	a1,a5,ffffffffc0204ea8 <strnlen+0x18>
ffffffffc0204e9c:	00f50733          	add	a4,a0,a5
ffffffffc0204ea0:	00074703          	lbu	a4,0(a4)
ffffffffc0204ea4:	fb6d                	bnez	a4,ffffffffc0204e96 <strnlen+0x6>
ffffffffc0204ea6:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204ea8:	852e                	mv	a0,a1
ffffffffc0204eaa:	8082                	ret

ffffffffc0204eac <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0204eac:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204eae:	0005c703          	lbu	a4,0(a1)
ffffffffc0204eb2:	0785                	addi	a5,a5,1
ffffffffc0204eb4:	0585                	addi	a1,a1,1
ffffffffc0204eb6:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204eba:	fb75                	bnez	a4,ffffffffc0204eae <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204ec2:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204ec6:	cb89                	beqz	a5,ffffffffc0204ed8 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204ec8:	0505                	addi	a0,a0,1
ffffffffc0204eca:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204ecc:	fee789e3          	beq	a5,a4,ffffffffc0204ebe <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204ed0:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204ed4:	9d19                	subw	a0,a0,a4
ffffffffc0204ed6:	8082                	ret
ffffffffc0204ed8:	4501                	li	a0,0
ffffffffc0204eda:	bfed                	j	ffffffffc0204ed4 <strcmp+0x16>

ffffffffc0204edc <strchr>:
...
ffffffffc0204ee0:	c799                	beqz	a5,ffffffffc0204eee <strchr+0x12>
        if (*s == c) {
ffffffffc0204ee2:	00f58763          	beq	a1,a5,ffffffffc0204ef0 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204ee6:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204eea:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204eec:	fbfd                	bnez	a5,ffffffffc0204ee2 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204ef2:	ca01                	beqz	a2,ffffffffc0204f02 <memset+0x10>
ffffffffc0204ef4:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204ef6:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204ef8:	0785                	addi	a5,a5,1
ffffffffc0204efa:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204efe:	fec79de3          	bne	a5,a2,ffffffffc0204ef8 <memset+0x6>
    }
    return s;
...
ffffffffc0204f04 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204f04:	ca19                	beqz	a2,ffffffffc0204f1a <memcpy+0x16>
ffffffffc0204f06:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204f08:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204f0a:	0005c703          	lbu	a4,0(a1)
ffffffffc0204f0e:	0585                	addi	a1,a1,1
ffffffffc0204f10:	0785                	addi	a5,a5,1
ffffffffc0204f12:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204f16:	fec59ae3          	bne	a1,a2,ffffffffc0204f0a <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204f1c:	c205                	beqz	a2,ffffffffc0204f3c <memcmp+0x20>
ffffffffc0204f1e:	962e                	add	a2,a2,a1
ffffffffc0204f20:	a019                	j	ffffffffc0204f26 <memcmp+0xa>
ffffffffc0204f22:	00c58d63          	beq	a1,a2,ffffffffc0204f3c <memcmp+0x20>
        if (*s1 != *s2) {
ffffffffc0204f26:	00054783          	lbu	a5,0(a0)
ffffffffc0204f2a:	0005c703          	lbu	a4,0(a1)
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
ffffffffc0204f2e:	0505                	addi	a0,a0,1
ffffffffc0204f30:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204f32:	fee788e3          	beq	a5,a4,ffffffffc0204f22 <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204f36:	40e7853b          	subw	a0,a5,a4
