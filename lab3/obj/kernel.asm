...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	63f030ef          	jal	ra,ffffffffc0203eec <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	609030ef          	jal	ra,ffffffffc0203eec <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	2ec50513          	addi	a0,a0,748 # ffffffffc02043f0 <etext+0x28>
void print_kerninfo(void) {
...
ffffffffc020011e:	2f650513          	addi	a0,a0,758 # ffffffffc0204410 <etext+0x48>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	2a258593          	addi	a1,a1,674 # ffffffffc02043c8 <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	30250513          	addi	a0,a0,770 # ffffffffc0204430 <etext+0x68>
...
ffffffffc0200146:	30e50513          	addi	a0,a0,782 # ffffffffc0204450 <etext+0x88>
...
ffffffffc020015a:	31a50513          	addi	a0,a0,794 # ffffffffc0204470 <etext+0xa8>
...
ffffffffc0200188:	30c50513          	addi	a0,a0,780 # ffffffffc0204490 <etext+0xc8>
}
...
ffffffffc0200196:	32e60613          	addi	a2,a2,814 # ffffffffc02044c0 <etext+0xf8>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	33a50513          	addi	a0,a0,826 # ffffffffc02044d8 <etext+0x110>
void print_stackframe(void) {
...
ffffffffc02001b2:	34260613          	addi	a2,a2,834 # ffffffffc02044f0 <etext+0x128>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	35a58593          	addi	a1,a1,858 # ffffffffc0204510 <etext+0x148>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	35a50513          	addi	a0,a0,858 # ffffffffc0204518 <etext+0x150>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	35c60613          	addi	a2,a2,860 # ffffffffc0204528 <etext+0x160>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	37c58593          	addi	a1,a1,892 # ffffffffc0204550 <etext+0x188>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	33c50513          	addi	a0,a0,828 # ffffffffc0204518 <etext+0x150>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	37860613          	addi	a2,a2,888 # ffffffffc0204560 <etext+0x198>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	39058593          	addi	a1,a1,912 # ffffffffc0204580 <etext+0x1b8>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	32050513          	addi	a0,a0,800 # ffffffffc0204518 <etext+0x150>
...
ffffffffc0200236:	35e50513          	addi	a0,a0,862 # ffffffffc0204590 <etext+0x1c8>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	36450513          	addi	a0,a0,868 # ffffffffc02045b8 <etext+0x1f0>
...
ffffffffc020026e:	3b6c0c13          	addi	s8,s8,950 # ffffffffc0204620 <commands>
        if ((buf = readline("")) != NULL) {
ffffffffc0200272:	00005917          	auipc	s2,0x5
ffffffffc0200276:	7be90913          	addi	s2,s2,1982 # ffffffffc0205a30 <default_pmm_manager+0x928>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020027a:	00004497          	auipc	s1,0x4
ffffffffc020027e:	36648493          	addi	s1,s1,870 # ffffffffc02045e0 <etext+0x218>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	364b0b13          	addi	s6,s6,868 # ffffffffc02045e8 <etext+0x220>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	284a0a13          	addi	s4,s4,644 # ffffffffc0204510 <etext+0x148>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	7d7030ef          	jal	ra,ffffffffc020426e <readline>
...
ffffffffc02002b2:	372d0d13          	addi	s10,s10,882 # ffffffffc0204620 <commands>
        argv[argc ++] = buf;
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	0ae040ef          	jal	ra,ffffffffc020436a <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	09a040ef          	jal	ra,ffffffffc020436a <strcmp>
...
ffffffffc020030e:	07a040ef          	jal	ra,ffffffffc0204388 <strchr>
...
ffffffffc020034c:	03c040ef          	jal	ra,ffffffffc0204388 <strchr>
...
ffffffffc020036a:	2a250513          	addi	a0,a0,674 # ffffffffc0204608 <etext+0x240>
...
ffffffffc02003a6:	2c650513          	addi	a0,a0,710 # ffffffffc0204668 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02003bc:	1c850513          	addi	a0,a0,456 # ffffffffc0205580 <default_pmm_manager+0x478>
...
ffffffffc02007c2:	36270713          	addi	a4,a4,866 # ffffffffc0204b20 <commands+0x500>
...
ffffffffc02007d4:	30050513          	addi	a0,a0,768 # ffffffffc0204ad0 <commands+0x4b0>
ffffffffc02007d8:	8e3ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02007dc:	00004517          	auipc	a0,0x4
ffffffffc02007e0:	2d450513          	addi	a0,a0,724 # ffffffffc0204ab0 <commands+0x490>
ffffffffc02007e4:	8d7ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02007e8:	00004517          	auipc	a0,0x4
ffffffffc02007ec:	28850513          	addi	a0,a0,648 # ffffffffc0204a70 <commands+0x450>
ffffffffc02007f0:	8cbff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02007f4:	00004517          	auipc	a0,0x4
ffffffffc02007f8:	29c50513          	addi	a0,a0,668 # ffffffffc0204a90 <commands+0x470>
...
ffffffffc020082a:	2da50513          	addi	a0,a0,730 # ffffffffc0204b00 <commands+0x4e0>
...
ffffffffc020083e:	2b650513          	addi	a0,a0,694 # ffffffffc0204af0 <commands+0x4d0>
}
...
ffffffffc0200860:	4ac70713          	addi	a4,a4,1196 # ffffffffc0204d08 <commands+0x6e8>
...
ffffffffc0200872:	48250513          	addi	a0,a0,1154 # ffffffffc0204cf0 <commands+0x6d0>
...
ffffffffc0200894:	2c050513          	addi	a0,a0,704 # ffffffffc0204b50 <commands+0x530>
}
...
ffffffffc02008a8:	2cc50513          	addi	a0,a0,716 # ffffffffc0204b70 <commands+0x550>
ffffffffc02008ac:	b7f5                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Illegal instruction\n");
ffffffffc02008ae:	00004517          	auipc	a0,0x4
ffffffffc02008b2:	2e250513          	addi	a0,a0,738 # ffffffffc0204b90 <commands+0x570>
ffffffffc02008b6:	b7cd                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Breakpoint\n");
ffffffffc02008b8:	00004517          	auipc	a0,0x4
ffffffffc02008bc:	2f050513          	addi	a0,a0,752 # ffffffffc0204ba8 <commands+0x588>
ffffffffc02008c0:	bfe1                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load address misaligned\n");
ffffffffc02008c2:	00004517          	auipc	a0,0x4
ffffffffc02008c6:	2f650513          	addi	a0,a0,758 # ffffffffc0204bb8 <commands+0x598>
ffffffffc02008ca:	b7f9                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc02008cc:	00004517          	auipc	a0,0x4
ffffffffc02008d0:	30c50513          	addi	a0,a0,780 # ffffffffc0204bd8 <commands+0x5b8>
...
ffffffffc02008ee:	30660613          	addi	a2,a2,774 # ffffffffc0204bf0 <commands+0x5d0>
ffffffffc02008f2:	0ca00593          	li	a1,202
ffffffffc02008f6:	00004517          	auipc	a0,0x4
ffffffffc02008fa:	dea50513          	addi	a0,a0,-534 # ffffffffc02046e0 <commands+0xc0>
ffffffffc02008fe:	a77ff0ef          	jal	ra,ffffffffc0200374 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc0200902:	00004517          	auipc	a0,0x4
ffffffffc0200906:	30e50513          	addi	a0,a0,782 # ffffffffc0204c10 <commands+0x5f0>
ffffffffc020090a:	b779                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc020090c:	00004517          	auipc	a0,0x4
ffffffffc0200910:	31c50513          	addi	a0,a0,796 # ffffffffc0204c28 <commands+0x608>
...
ffffffffc0200998:	25c60613          	addi	a2,a2,604 # ffffffffc0204bf0 <commands+0x5d0>
ffffffffc020099c:	0ea00593          	li	a1,234
ffffffffc02009a0:	00004517          	auipc	a0,0x4
ffffffffc02009a4:	d4050513          	addi	a0,a0,-704 # ffffffffc02046e0 <commands+0xc0>
...
ffffffffc02009c4:	23060613          	addi	a2,a2,560 # ffffffffc0204bf0 <commands+0x5d0>
ffffffffc02009c8:	0f100593          	li	a1,241
ffffffffc02009cc:	00004517          	auipc	a0,0x4
ffffffffc02009d0:	d1450513          	addi	a0,a0,-748 # ffffffffc02046e0 <commands+0xc0>
...
ffffffffc0200b6e:	6365b583          	ld	a1,1590(a1) # ffffffffc02061a0 <error_string+0x38>
ffffffffc0200b72:	02b70733          	mul	a4,a4,a1
ffffffffc0200b76:	00005617          	auipc	a2,0x5
ffffffffc0200b7a:	63263603          	ld	a2,1586(a2) # ffffffffc02061a8 <nbase>
...
ffffffffc0200dc6:	f8668693          	addi	a3,a3,-122 # ffffffffc0204d48 <commands+0x728>
ffffffffc0200dca:	00004617          	auipc	a2,0x4
ffffffffc0200dce:	f8e60613          	addi	a2,a2,-114 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200dd2:	0f000593          	li	a1,240
ffffffffc0200dd6:	00004517          	auipc	a0,0x4
ffffffffc0200dda:	f9a50513          	addi	a0,a0,-102 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200dde:	d96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200de2:	00004697          	auipc	a3,0x4
ffffffffc0200de6:	02668693          	addi	a3,a3,38 # ffffffffc0204e08 <commands+0x7e8>
ffffffffc0200dea:	00004617          	auipc	a2,0x4
ffffffffc0200dee:	f6e60613          	addi	a2,a2,-146 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200df2:	0bd00593          	li	a1,189
ffffffffc0200df6:	00004517          	auipc	a0,0x4
ffffffffc0200dfa:	f7a50513          	addi	a0,a0,-134 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200dfe:	d76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200e02:	00004697          	auipc	a3,0x4
ffffffffc0200e06:	02e68693          	addi	a3,a3,46 # ffffffffc0204e30 <commands+0x810>
ffffffffc0200e0a:	00004617          	auipc	a2,0x4
ffffffffc0200e0e:	f4e60613          	addi	a2,a2,-178 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200e12:	0be00593          	li	a1,190
ffffffffc0200e16:	00004517          	auipc	a0,0x4
ffffffffc0200e1a:	f5a50513          	addi	a0,a0,-166 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200e1e:	d56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200e22:	00004697          	auipc	a3,0x4
ffffffffc0200e26:	04e68693          	addi	a3,a3,78 # ffffffffc0204e70 <commands+0x850>
ffffffffc0200e2a:	00004617          	auipc	a2,0x4
ffffffffc0200e2e:	f2e60613          	addi	a2,a2,-210 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200e32:	0c000593          	li	a1,192
ffffffffc0200e36:	00004517          	auipc	a0,0x4
ffffffffc0200e3a:	f3a50513          	addi	a0,a0,-198 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200e3e:	d36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200e42:	00004697          	auipc	a3,0x4
ffffffffc0200e46:	0b668693          	addi	a3,a3,182 # ffffffffc0204ef8 <commands+0x8d8>
ffffffffc0200e4a:	00004617          	auipc	a2,0x4
ffffffffc0200e4e:	f0e60613          	addi	a2,a2,-242 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200e52:	0d900593          	li	a1,217
ffffffffc0200e56:	00004517          	auipc	a0,0x4
ffffffffc0200e5a:	f1a50513          	addi	a0,a0,-230 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200e5e:	d16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200e62:	00004697          	auipc	a3,0x4
ffffffffc0200e66:	f4668693          	addi	a3,a3,-186 # ffffffffc0204da8 <commands+0x788>
ffffffffc0200e6a:	00004617          	auipc	a2,0x4
ffffffffc0200e6e:	eee60613          	addi	a2,a2,-274 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200e72:	0d200593          	li	a1,210
ffffffffc0200e76:	00004517          	auipc	a0,0x4
ffffffffc0200e7a:	efa50513          	addi	a0,a0,-262 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200e7e:	cf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 3);
ffffffffc0200e82:	00004697          	auipc	a3,0x4
ffffffffc0200e86:	06668693          	addi	a3,a3,102 # ffffffffc0204ee8 <commands+0x8c8>
ffffffffc0200e8a:	00004617          	auipc	a2,0x4
ffffffffc0200e8e:	ece60613          	addi	a2,a2,-306 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200e92:	0d000593          	li	a1,208
ffffffffc0200e96:	00004517          	auipc	a0,0x4
ffffffffc0200e9a:	eda50513          	addi	a0,a0,-294 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200e9e:	cd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200ea2:	00004697          	auipc	a3,0x4
ffffffffc0200ea6:	02e68693          	addi	a3,a3,46 # ffffffffc0204ed0 <commands+0x8b0>
ffffffffc0200eaa:	00004617          	auipc	a2,0x4
ffffffffc0200eae:	eae60613          	addi	a2,a2,-338 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200eb2:	0cb00593          	li	a1,203
ffffffffc0200eb6:	00004517          	auipc	a0,0x4
ffffffffc0200eba:	eba50513          	addi	a0,a0,-326 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200ebe:	cb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200ec2:	00004697          	auipc	a3,0x4
ffffffffc0200ec6:	fee68693          	addi	a3,a3,-18 # ffffffffc0204eb0 <commands+0x890>
ffffffffc0200eca:	00004617          	auipc	a2,0x4
ffffffffc0200ece:	e8e60613          	addi	a2,a2,-370 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200ed2:	0c200593          	li	a1,194
ffffffffc0200ed6:	00004517          	auipc	a0,0x4
ffffffffc0200eda:	e9a50513          	addi	a0,a0,-358 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200ede:	c96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != NULL);
ffffffffc0200ee2:	00004697          	auipc	a3,0x4
ffffffffc0200ee6:	05e68693          	addi	a3,a3,94 # ffffffffc0204f40 <commands+0x920>
ffffffffc0200eea:	00004617          	auipc	a2,0x4
ffffffffc0200eee:	e6e60613          	addi	a2,a2,-402 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200ef2:	0f800593          	li	a1,248
ffffffffc0200ef6:	00004517          	auipc	a0,0x4
ffffffffc0200efa:	e7a50513          	addi	a0,a0,-390 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200efe:	c76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0200f02:	00004697          	auipc	a3,0x4
ffffffffc0200f06:	02e68693          	addi	a3,a3,46 # ffffffffc0204f30 <commands+0x910>
ffffffffc0200f0a:	00004617          	auipc	a2,0x4
ffffffffc0200f0e:	e4e60613          	addi	a2,a2,-434 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200f12:	0df00593          	li	a1,223
ffffffffc0200f16:	00004517          	auipc	a0,0x4
ffffffffc0200f1a:	e5a50513          	addi	a0,a0,-422 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200f1e:	c56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f22:	00004697          	auipc	a3,0x4
ffffffffc0200f26:	fae68693          	addi	a3,a3,-82 # ffffffffc0204ed0 <commands+0x8b0>
ffffffffc0200f2a:	00004617          	auipc	a2,0x4
ffffffffc0200f2e:	e2e60613          	addi	a2,a2,-466 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200f32:	0dd00593          	li	a1,221
ffffffffc0200f36:	00004517          	auipc	a0,0x4
ffffffffc0200f3a:	e3a50513          	addi	a0,a0,-454 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200f3e:	c36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200f42:	00004697          	auipc	a3,0x4
ffffffffc0200f46:	fce68693          	addi	a3,a3,-50 # ffffffffc0204f10 <commands+0x8f0>
ffffffffc0200f4a:	00004617          	auipc	a2,0x4
ffffffffc0200f4e:	e0e60613          	addi	a2,a2,-498 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200f52:	0dc00593          	li	a1,220
ffffffffc0200f56:	00004517          	auipc	a0,0x4
ffffffffc0200f5a:	e1a50513          	addi	a0,a0,-486 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200f5e:	c16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f62:	00004697          	auipc	a3,0x4
ffffffffc0200f66:	e4668693          	addi	a3,a3,-442 # ffffffffc0204da8 <commands+0x788>
ffffffffc0200f6a:	00004617          	auipc	a2,0x4
ffffffffc0200f6e:	dee60613          	addi	a2,a2,-530 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200f72:	0b900593          	li	a1,185
ffffffffc0200f76:	00004517          	auipc	a0,0x4
ffffffffc0200f7a:	dfa50513          	addi	a0,a0,-518 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200f7e:	bf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f82:	00004697          	auipc	a3,0x4
ffffffffc0200f86:	f4e68693          	addi	a3,a3,-178 # ffffffffc0204ed0 <commands+0x8b0>
ffffffffc0200f8a:	00004617          	auipc	a2,0x4
ffffffffc0200f8e:	dce60613          	addi	a2,a2,-562 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200f92:	0d600593          	li	a1,214
ffffffffc0200f96:	00004517          	auipc	a0,0x4
ffffffffc0200f9a:	dda50513          	addi	a0,a0,-550 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200f9e:	bd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fa2:	00004697          	auipc	a3,0x4
ffffffffc0200fa6:	e4668693          	addi	a3,a3,-442 # ffffffffc0204de8 <commands+0x7c8>
ffffffffc0200faa:	00004617          	auipc	a2,0x4
ffffffffc0200fae:	dae60613          	addi	a2,a2,-594 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200fb2:	0d400593          	li	a1,212
ffffffffc0200fb6:	00004517          	auipc	a0,0x4
ffffffffc0200fba:	dba50513          	addi	a0,a0,-582 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200fbe:	bb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0200fc2:	00004697          	auipc	a3,0x4
ffffffffc0200fc6:	e0668693          	addi	a3,a3,-506 # ffffffffc0204dc8 <commands+0x7a8>
ffffffffc0200fca:	00004617          	auipc	a2,0x4
ffffffffc0200fce:	d8e60613          	addi	a2,a2,-626 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200fd2:	0d300593          	li	a1,211
ffffffffc0200fd6:	00004517          	auipc	a0,0x4
ffffffffc0200fda:	d9a50513          	addi	a0,a0,-614 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200fde:	b96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fe2:	00004697          	auipc	a3,0x4
ffffffffc0200fe6:	e0668693          	addi	a3,a3,-506 # ffffffffc0204de8 <commands+0x7c8>
ffffffffc0200fea:	00004617          	auipc	a2,0x4
ffffffffc0200fee:	d6e60613          	addi	a2,a2,-658 # ffffffffc0204d58 <commands+0x738>
ffffffffc0200ff2:	0bb00593          	li	a1,187
ffffffffc0200ff6:	00004517          	auipc	a0,0x4
ffffffffc0200ffa:	d7a50513          	addi	a0,a0,-646 # ffffffffc0204d70 <commands+0x750>
ffffffffc0200ffe:	b76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(count == 0);
ffffffffc0201002:	00004697          	auipc	a3,0x4
ffffffffc0201006:	08e68693          	addi	a3,a3,142 # ffffffffc0205090 <commands+0xa70>
ffffffffc020100a:	00004617          	auipc	a2,0x4
ffffffffc020100e:	d4e60613          	addi	a2,a2,-690 # ffffffffc0204d58 <commands+0x738>
ffffffffc0201012:	12500593          	li	a1,293
ffffffffc0201016:	00004517          	auipc	a0,0x4
ffffffffc020101a:	d5a50513          	addi	a0,a0,-678 # ffffffffc0204d70 <commands+0x750>
ffffffffc020101e:	b56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0201022:	00004697          	auipc	a3,0x4
ffffffffc0201026:	f0e68693          	addi	a3,a3,-242 # ffffffffc0204f30 <commands+0x910>
ffffffffc020102a:	00004617          	auipc	a2,0x4
ffffffffc020102e:	d2e60613          	addi	a2,a2,-722 # ffffffffc0204d58 <commands+0x738>
ffffffffc0201032:	11a00593          	li	a1,282
ffffffffc0201036:	00004517          	auipc	a0,0x4
ffffffffc020103a:	d3a50513          	addi	a0,a0,-710 # ffffffffc0204d70 <commands+0x750>
ffffffffc020103e:	b36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201042:	00004697          	auipc	a3,0x4
ffffffffc0201046:	e8e68693          	addi	a3,a3,-370 # ffffffffc0204ed0 <commands+0x8b0>
ffffffffc020104a:	00004617          	auipc	a2,0x4
ffffffffc020104e:	d0e60613          	addi	a2,a2,-754 # ffffffffc0204d58 <commands+0x738>
ffffffffc0201052:	11800593          	li	a1,280
ffffffffc0201056:	00004517          	auipc	a0,0x4
ffffffffc020105a:	d1a50513          	addi	a0,a0,-742 # ffffffffc0204d70 <commands+0x750>
ffffffffc020105e:	b16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201062:	00004697          	auipc	a3,0x4
ffffffffc0201066:	e2e68693          	addi	a3,a3,-466 # ffffffffc0204e90 <commands+0x870>
ffffffffc020106a:	00004617          	auipc	a2,0x4
ffffffffc020106e:	cee60613          	addi	a2,a2,-786 # ffffffffc0204d58 <commands+0x738>
ffffffffc0201072:	0c100593          	li	a1,193
ffffffffc0201076:	00004517          	auipc	a0,0x4
ffffffffc020107a:	cfa50513          	addi	a0,a0,-774 # ffffffffc0204d70 <commands+0x750>
ffffffffc020107e:	af6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201082:	00004697          	auipc	a3,0x4
ffffffffc0201086:	fce68693          	addi	a3,a3,-50 # ffffffffc0205050 <commands+0xa30>
ffffffffc020108a:	00004617          	auipc	a2,0x4
ffffffffc020108e:	cce60613          	addi	a2,a2,-818 # ffffffffc0204d58 <commands+0x738>
ffffffffc0201092:	11200593          	li	a1,274
ffffffffc0201096:	00004517          	auipc	a0,0x4
ffffffffc020109a:	cda50513          	addi	a0,a0,-806 # ffffffffc0204d70 <commands+0x750>
ffffffffc020109e:	ad6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02010a2:	00004697          	auipc	a3,0x4
ffffffffc02010a6:	f8e68693          	addi	a3,a3,-114 # ffffffffc0205030 <commands+0xa10>
ffffffffc02010aa:	00004617          	auipc	a2,0x4
ffffffffc02010ae:	cae60613          	addi	a2,a2,-850 # ffffffffc0204d58 <commands+0x738>
ffffffffc02010b2:	11000593          	li	a1,272
ffffffffc02010b6:	00004517          	auipc	a0,0x4
ffffffffc02010ba:	cba50513          	addi	a0,a0,-838 # ffffffffc0204d70 <commands+0x750>
ffffffffc02010be:	ab6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02010c2:	00004697          	auipc	a3,0x4
ffffffffc02010c6:	f4668693          	addi	a3,a3,-186 # ffffffffc0205008 <commands+0x9e8>
ffffffffc02010ca:	00004617          	auipc	a2,0x4
ffffffffc02010ce:	c8e60613          	addi	a2,a2,-882 # ffffffffc0204d58 <commands+0x738>
ffffffffc02010d2:	10e00593          	li	a1,270
ffffffffc02010d6:	00004517          	auipc	a0,0x4
ffffffffc02010da:	c9a50513          	addi	a0,a0,-870 # ffffffffc0204d70 <commands+0x750>
ffffffffc02010de:	a96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02010e2:	00004697          	auipc	a3,0x4
ffffffffc02010e6:	efe68693          	addi	a3,a3,-258 # ffffffffc0204fe0 <commands+0x9c0>
ffffffffc02010ea:	00004617          	auipc	a2,0x4
ffffffffc02010ee:	c6e60613          	addi	a2,a2,-914 # ffffffffc0204d58 <commands+0x738>
ffffffffc02010f2:	10d00593          	li	a1,269
ffffffffc02010f6:	00004517          	auipc	a0,0x4
ffffffffc02010fa:	c7a50513          	addi	a0,a0,-902 # ffffffffc0204d70 <commands+0x750>
ffffffffc02010fe:	a76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201102:	00004697          	auipc	a3,0x4
ffffffffc0201106:	ece68693          	addi	a3,a3,-306 # ffffffffc0204fd0 <commands+0x9b0>
ffffffffc020110a:	00004617          	auipc	a2,0x4
ffffffffc020110e:	c4e60613          	addi	a2,a2,-946 # ffffffffc0204d58 <commands+0x738>
ffffffffc0201112:	10800593          	li	a1,264
ffffffffc0201116:	00004517          	auipc	a0,0x4
ffffffffc020111a:	c5a50513          	addi	a0,a0,-934 # ffffffffc0204d70 <commands+0x750>
ffffffffc020111e:	a56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201122:	00004697          	auipc	a3,0x4
ffffffffc0201126:	dae68693          	addi	a3,a3,-594 # ffffffffc0204ed0 <commands+0x8b0>
ffffffffc020112a:	00004617          	auipc	a2,0x4
ffffffffc020112e:	c2e60613          	addi	a2,a2,-978 # ffffffffc0204d58 <commands+0x738>
ffffffffc0201132:	10700593          	li	a1,263
ffffffffc0201136:	00004517          	auipc	a0,0x4
ffffffffc020113a:	c3a50513          	addi	a0,a0,-966 # ffffffffc0204d70 <commands+0x750>
ffffffffc020113e:	a36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201142:	00004697          	auipc	a3,0x4
ffffffffc0201146:	e6e68693          	addi	a3,a3,-402 # ffffffffc0204fb0 <commands+0x990>
ffffffffc020114a:	00004617          	auipc	a2,0x4
ffffffffc020114e:	c0e60613          	addi	a2,a2,-1010 # ffffffffc0204d58 <commands+0x738>
ffffffffc0201152:	10600593          	li	a1,262
ffffffffc0201156:	00004517          	auipc	a0,0x4
ffffffffc020115a:	c1a50513          	addi	a0,a0,-998 # ffffffffc0204d70 <commands+0x750>
ffffffffc020115e:	a16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201162:	00004697          	auipc	a3,0x4
ffffffffc0201166:	e1e68693          	addi	a3,a3,-482 # ffffffffc0204f80 <commands+0x960>
ffffffffc020116a:	00004617          	auipc	a2,0x4
ffffffffc020116e:	bee60613          	addi	a2,a2,-1042 # ffffffffc0204d58 <commands+0x738>
ffffffffc0201172:	10500593          	li	a1,261
ffffffffc0201176:	00004517          	auipc	a0,0x4
ffffffffc020117a:	bfa50513          	addi	a0,a0,-1030 # ffffffffc0204d70 <commands+0x750>
ffffffffc020117e:	9f6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201182:	00004697          	auipc	a3,0x4
ffffffffc0201186:	de668693          	addi	a3,a3,-538 # ffffffffc0204f68 <commands+0x948>
ffffffffc020118a:	00004617          	auipc	a2,0x4
ffffffffc020118e:	bce60613          	addi	a2,a2,-1074 # ffffffffc0204d58 <commands+0x738>
ffffffffc0201192:	10400593          	li	a1,260
ffffffffc0201196:	00004517          	auipc	a0,0x4
ffffffffc020119a:	bda50513          	addi	a0,a0,-1062 # ffffffffc0204d70 <commands+0x750>
ffffffffc020119e:	9d6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011a2:	00004697          	auipc	a3,0x4
ffffffffc02011a6:	d2e68693          	addi	a3,a3,-722 # ffffffffc0204ed0 <commands+0x8b0>
ffffffffc02011aa:	00004617          	auipc	a2,0x4
ffffffffc02011ae:	bae60613          	addi	a2,a2,-1106 # ffffffffc0204d58 <commands+0x738>
ffffffffc02011b2:	0fe00593          	li	a1,254
ffffffffc02011b6:	00004517          	auipc	a0,0x4
ffffffffc02011ba:	bba50513          	addi	a0,a0,-1094 # ffffffffc0204d70 <commands+0x750>
ffffffffc02011be:	9b6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!PageProperty(p0));
ffffffffc02011c2:	00004697          	auipc	a3,0x4
ffffffffc02011c6:	d8e68693          	addi	a3,a3,-626 # ffffffffc0204f50 <commands+0x930>
ffffffffc02011ca:	00004617          	auipc	a2,0x4
ffffffffc02011ce:	b8e60613          	addi	a2,a2,-1138 # ffffffffc0204d58 <commands+0x738>
ffffffffc02011d2:	0f900593          	li	a1,249
ffffffffc02011d6:	00004517          	auipc	a0,0x4
ffffffffc02011da:	b9a50513          	addi	a0,a0,-1126 # ffffffffc0204d70 <commands+0x750>
ffffffffc02011de:	996ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02011e2:	00004697          	auipc	a3,0x4
ffffffffc02011e6:	e8e68693          	addi	a3,a3,-370 # ffffffffc0205070 <commands+0xa50>
ffffffffc02011ea:	00004617          	auipc	a2,0x4
ffffffffc02011ee:	b6e60613          	addi	a2,a2,-1170 # ffffffffc0204d58 <commands+0x738>
ffffffffc02011f2:	11700593          	li	a1,279
ffffffffc02011f6:	00004517          	auipc	a0,0x4
ffffffffc02011fa:	b7a50513          	addi	a0,a0,-1158 # ffffffffc0204d70 <commands+0x750>
ffffffffc02011fe:	976ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == 0);
ffffffffc0201202:	00004697          	auipc	a3,0x4
ffffffffc0201206:	e9e68693          	addi	a3,a3,-354 # ffffffffc02050a0 <commands+0xa80>
ffffffffc020120a:	00004617          	auipc	a2,0x4
ffffffffc020120e:	b4e60613          	addi	a2,a2,-1202 # ffffffffc0204d58 <commands+0x738>
ffffffffc0201212:	12600593          	li	a1,294
ffffffffc0201216:	00004517          	auipc	a0,0x4
ffffffffc020121a:	b5a50513          	addi	a0,a0,-1190 # ffffffffc0204d70 <commands+0x750>
ffffffffc020121e:	956ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == nr_free_pages());
ffffffffc0201222:	00004697          	auipc	a3,0x4
ffffffffc0201226:	b6668693          	addi	a3,a3,-1178 # ffffffffc0204d88 <commands+0x768>
ffffffffc020122a:	00004617          	auipc	a2,0x4
ffffffffc020122e:	b2e60613          	addi	a2,a2,-1234 # ffffffffc0204d58 <commands+0x738>
ffffffffc0201232:	0f300593          	li	a1,243
ffffffffc0201236:	00004517          	auipc	a0,0x4
ffffffffc020123a:	b3a50513          	addi	a0,a0,-1222 # ffffffffc0204d70 <commands+0x750>
ffffffffc020123e:	936ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201242:	00004697          	auipc	a3,0x4
ffffffffc0201246:	b8668693          	addi	a3,a3,-1146 # ffffffffc0204dc8 <commands+0x7a8>
ffffffffc020124a:	00004617          	auipc	a2,0x4
ffffffffc020124e:	b0e60613          	addi	a2,a2,-1266 # ffffffffc0204d58 <commands+0x738>
ffffffffc0201252:	0ba00593          	li	a1,186
ffffffffc0201256:	00004517          	auipc	a0,0x4
ffffffffc020125a:	b1a50513          	addi	a0,a0,-1254 # ffffffffc0204d70 <commands+0x750>
...
ffffffffc020139e:	d1e68693          	addi	a3,a3,-738 # ffffffffc02050b8 <commands+0xa98>
ffffffffc02013a2:	00004617          	auipc	a2,0x4
ffffffffc02013a6:	9b660613          	addi	a2,a2,-1610 # ffffffffc0204d58 <commands+0x738>
ffffffffc02013aa:	08300593          	li	a1,131
ffffffffc02013ae:	00004517          	auipc	a0,0x4
ffffffffc02013b2:	9c250513          	addi	a0,a0,-1598 # ffffffffc0204d70 <commands+0x750>
ffffffffc02013b6:	fbffe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc02013ba:	00004697          	auipc	a3,0x4
ffffffffc02013be:	cf668693          	addi	a3,a3,-778 # ffffffffc02050b0 <commands+0xa90>
ffffffffc02013c2:	00004617          	auipc	a2,0x4
ffffffffc02013c6:	99660613          	addi	a2,a2,-1642 # ffffffffc0204d58 <commands+0x738>
ffffffffc02013ca:	08000593          	li	a1,128
ffffffffc02013ce:	00004517          	auipc	a0,0x4
ffffffffc02013d2:	9a250513          	addi	a0,a0,-1630 # ffffffffc0204d70 <commands+0x750>
...
ffffffffc0201476:	c3e68693          	addi	a3,a3,-962 # ffffffffc02050b0 <commands+0xa90>
ffffffffc020147a:	00004617          	auipc	a2,0x4
ffffffffc020147e:	8de60613          	addi	a2,a2,-1826 # ffffffffc0204d58 <commands+0x738>
ffffffffc0201482:	06200593          	li	a1,98
ffffffffc0201486:	00004517          	auipc	a0,0x4
ffffffffc020148a:	8ea50513          	addi	a0,a0,-1814 # ffffffffc0204d70 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc020154c:	b9868693          	addi	a3,a3,-1128 # ffffffffc02050e0 <commands+0xac0>
ffffffffc0201550:	00004617          	auipc	a2,0x4
ffffffffc0201554:	80860613          	addi	a2,a2,-2040 # ffffffffc0204d58 <commands+0x738>
ffffffffc0201558:	04900593          	li	a1,73
ffffffffc020155c:	00004517          	auipc	a0,0x4
ffffffffc0201560:	81450513          	addi	a0,a0,-2028 # ffffffffc0204d70 <commands+0x750>
ffffffffc0201564:	e11fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc0201568:	00004697          	auipc	a3,0x4
ffffffffc020156c:	b4868693          	addi	a3,a3,-1208 # ffffffffc02050b0 <commands+0xa90>
ffffffffc0201570:	00003617          	auipc	a2,0x3
ffffffffc0201574:	7e860613          	addi	a2,a2,2024 # ffffffffc0204d58 <commands+0x738>
ffffffffc0201578:	04600593          	li	a1,70
ffffffffc020157c:	00003517          	auipc	a0,0x3
ffffffffc0201580:	7f450513          	addi	a0,a0,2036 # ffffffffc0204d70 <commands+0x750>
...
ffffffffc020158e:	bb660613          	addi	a2,a2,-1098 # ffffffffc0205140 <default_pmm_manager+0x38>
ffffffffc0201592:	06500593          	li	a1,101
ffffffffc0201596:	00004517          	auipc	a0,0x4
ffffffffc020159a:	bca50513          	addi	a0,a0,-1078 # ffffffffc0205160 <default_pmm_manager+0x58>
static inline struct Page *pa2page(uintptr_t pa) {
...
ffffffffc02015aa:	bca60613          	addi	a2,a2,-1078 # ffffffffc0205170 <default_pmm_manager+0x68>
ffffffffc02015ae:	07000593          	li	a1,112
ffffffffc02015b2:	00004517          	auipc	a0,0x4
ffffffffc02015b6:	bae50513          	addi	a0,a0,-1106 # ffffffffc0205160 <default_pmm_manager+0x58>
static inline struct Page *pte2page(pte_t pte) {
...
ffffffffc0201722:	a82b3b03          	ld	s6,-1406(s6) # ffffffffc02061a0 <error_string+0x38>
...
ffffffffc0201760:	43f020ef          	jal	ra,ffffffffc020439e <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02017d0:	9d4b3b03          	ld	s6,-1580(s6) # ffffffffc02061a0 <error_string+0x38>
...
ffffffffc0201802:	39d020ef          	jal	ra,ffffffffc020439e <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201862:	93a60613          	addi	a2,a2,-1734 # ffffffffc0205198 <default_pmm_manager+0x90>
ffffffffc0201866:	10200593          	li	a1,258
ffffffffc020186a:	00004517          	auipc	a0,0x4
ffffffffc020186e:	95650513          	addi	a0,a0,-1706 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc0201872:	b03fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201876:	00004617          	auipc	a2,0x4
ffffffffc020187a:	92260613          	addi	a2,a2,-1758 # ffffffffc0205198 <default_pmm_manager+0x90>
ffffffffc020187e:	10f00593          	li	a1,271
ffffffffc0201882:	00004517          	auipc	a0,0x4
ffffffffc0201886:	93e50513          	addi	a0,a0,-1730 # ffffffffc02051c0 <default_pmm_manager+0xb8>
...
ffffffffc0201894:	90860613          	addi	a2,a2,-1784 # ffffffffc0205198 <default_pmm_manager+0x90>
ffffffffc0201898:	10b00593          	li	a1,267
ffffffffc020189c:	00004517          	auipc	a0,0x4
ffffffffc02018a0:	92450513          	addi	a0,a0,-1756 # ffffffffc02051c0 <default_pmm_manager+0xb8>
...
ffffffffc02018ae:	8ee60613          	addi	a2,a2,-1810 # ffffffffc0205198 <default_pmm_manager+0x90>
ffffffffc02018b2:	0ff00593          	li	a1,255
ffffffffc02018b6:	00004517          	auipc	a0,0x4
ffffffffc02018ba:	90a50513          	addi	a0,a0,-1782 # ffffffffc02051c0 <default_pmm_manager+0xb8>
...
ffffffffc02019f8:	7ac43403          	ld	s0,1964(s0) # ffffffffc02061a0 <error_string+0x38>
...
ffffffffc0201aba:	65278793          	addi	a5,a5,1618 # ffffffffc0205108 <default_pmm_manager>
...
ffffffffc0201ac8:	70c50513          	addi	a0,a0,1804 # ffffffffc02051d0 <default_pmm_manager+0xc8>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201b24:	6c850513          	addi	a0,a0,1736 # ffffffffc02051e8 <default_pmm_manager+0xe0>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201b34:	6e850513          	addi	a0,a0,1768 # ffffffffc0205218 <default_pmm_manager+0x110>
...
ffffffffc0201b4e:	6e650513          	addi	a0,a0,1766 # ffffffffc0205230 <default_pmm_manager+0x128>
...
ffffffffc0201bda:	6aa50513          	addi	a0,a0,1706 # ffffffffc0205280 <default_pmm_manager+0x178>
...
ffffffffc0201dfe:	3a6cbc83          	ld	s9,934(s9) # ffffffffc02061a0 <error_string+0x38>
...
ffffffffc0201ea2:	6ca50513          	addi	a0,a0,1738 # ffffffffc0205568 <default_pmm_manager+0x460>
...
ffffffffc0201f58:	74c58593          	addi	a1,a1,1868 # ffffffffc02056a0 <default_pmm_manager+0x598>
ffffffffc0201f5c:	10000513          	li	a0,256
ffffffffc0201f60:	3f8020ef          	jal	ra,ffffffffc0204358 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	3fe020ef          	jal	ra,ffffffffc020436a <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb94>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	37c020ef          	jal	ra,ffffffffc0204322 <strlen>
...
ffffffffc020209c:	68050513          	addi	a0,a0,1664 # ffffffffc0205718 <default_pmm_manager+0x610>
}
...
ffffffffc02021a2:	42a68693          	addi	a3,a3,1066 # ffffffffc02055c8 <default_pmm_manager+0x4c0>
ffffffffc02021a6:	00003617          	auipc	a2,0x3
ffffffffc02021aa:	bb260613          	addi	a2,a2,-1102 # ffffffffc0204d58 <commands+0x738>
ffffffffc02021ae:	1ce00593          	li	a1,462
ffffffffc02021b2:	00003517          	auipc	a0,0x3
ffffffffc02021b6:	00e50513          	addi	a0,a0,14 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc02021ba:	9bafe0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc02021be:	00003697          	auipc	a3,0x3
ffffffffc02021c2:	3ca68693          	addi	a3,a3,970 # ffffffffc0205588 <default_pmm_manager+0x480>
ffffffffc02021c6:	00003617          	auipc	a2,0x3
ffffffffc02021ca:	b9260613          	addi	a2,a2,-1134 # ffffffffc0204d58 <commands+0x738>
ffffffffc02021ce:	1cd00593          	li	a1,461
ffffffffc02021d2:	00003517          	auipc	a0,0x3
ffffffffc02021d6:	fee50513          	addi	a0,a0,-18 # ffffffffc02051c0 <default_pmm_manager+0xb8>
...
ffffffffc02021e4:	fb860613          	addi	a2,a2,-72 # ffffffffc0205198 <default_pmm_manager+0x90>
ffffffffc02021e8:	1cd00593          	li	a1,461
ffffffffc02021ec:	00003517          	auipc	a0,0x3
ffffffffc02021f0:	fd450513          	addi	a0,a0,-44 # ffffffffc02051c0 <default_pmm_manager+0xb8>
...
ffffffffc0202200:	05c60613          	addi	a2,a2,92 # ffffffffc0205258 <default_pmm_manager+0x150>
ffffffffc0202204:	07700593          	li	a1,119
ffffffffc0202208:	00003517          	auipc	a0,0x3
ffffffffc020220c:	fb850513          	addi	a0,a0,-72 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc0202210:	964fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202214:	00003617          	auipc	a2,0x3
ffffffffc0202218:	04460613          	addi	a2,a2,68 # ffffffffc0205258 <default_pmm_manager+0x150>
ffffffffc020221c:	0bd00593          	li	a1,189
ffffffffc0202220:	00003517          	auipc	a0,0x3
ffffffffc0202224:	fa050513          	addi	a0,a0,-96 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc0202228:	94cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc020222c:	00003697          	auipc	a3,0x3
ffffffffc0202230:	09468693          	addi	a3,a3,148 # ffffffffc02052c0 <default_pmm_manager+0x1b8>
ffffffffc0202234:	00003617          	auipc	a2,0x3
ffffffffc0202238:	b2460613          	addi	a2,a2,-1244 # ffffffffc0204d58 <commands+0x738>
ffffffffc020223c:	19300593          	li	a1,403
ffffffffc0202240:	00003517          	auipc	a0,0x3
ffffffffc0202244:	f8050513          	addi	a0,a0,-128 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc0202248:	92cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020224c:	00003697          	auipc	a3,0x3
ffffffffc0202250:	05468693          	addi	a3,a3,84 # ffffffffc02052a0 <default_pmm_manager+0x198>
ffffffffc0202254:	00003617          	auipc	a2,0x3
ffffffffc0202258:	b0460613          	addi	a2,a2,-1276 # ffffffffc0204d58 <commands+0x738>
ffffffffc020225c:	19200593          	li	a1,402
ffffffffc0202260:	00003517          	auipc	a0,0x3
ffffffffc0202264:	f6050513          	addi	a0,a0,-160 # ffffffffc02051c0 <default_pmm_manager+0xb8>
...
ffffffffc0202274:	0e068693          	addi	a3,a3,224 # ffffffffc0205350 <default_pmm_manager+0x248>
ffffffffc0202278:	00003617          	auipc	a2,0x3
ffffffffc020227c:	ae060613          	addi	a2,a2,-1312 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202280:	19a00593          	li	a1,410
ffffffffc0202284:	00003517          	auipc	a0,0x3
ffffffffc0202288:	f3c50513          	addi	a0,a0,-196 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc020228c:	8e8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202290:	00003697          	auipc	a3,0x3
ffffffffc0202294:	09068693          	addi	a3,a3,144 # ffffffffc0205320 <default_pmm_manager+0x218>
ffffffffc0202298:	00003617          	auipc	a2,0x3
ffffffffc020229c:	ac060613          	addi	a2,a2,-1344 # ffffffffc0204d58 <commands+0x738>
ffffffffc02022a0:	19800593          	li	a1,408
ffffffffc02022a4:	00003517          	auipc	a0,0x3
ffffffffc02022a8:	f1c50513          	addi	a0,a0,-228 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc02022ac:	8c8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc02022b0:	00003697          	auipc	a3,0x3
ffffffffc02022b4:	04868693          	addi	a3,a3,72 # ffffffffc02052f8 <default_pmm_manager+0x1f0>
ffffffffc02022b8:	00003617          	auipc	a2,0x3
ffffffffc02022bc:	aa060613          	addi	a2,a2,-1376 # ffffffffc0204d58 <commands+0x738>
ffffffffc02022c0:	19400593          	li	a1,404
ffffffffc02022c4:	00003517          	auipc	a0,0x3
ffffffffc02022c8:	efc50513          	addi	a0,a0,-260 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc02022cc:	8a8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02022d0:	00003697          	auipc	a3,0x3
ffffffffc02022d4:	10868693          	addi	a3,a3,264 # ffffffffc02053d8 <default_pmm_manager+0x2d0>
ffffffffc02022d8:	00003617          	auipc	a2,0x3
ffffffffc02022dc:	a8060613          	addi	a2,a2,-1408 # ffffffffc0204d58 <commands+0x738>
ffffffffc02022e0:	1a300593          	li	a1,419
ffffffffc02022e4:	00003517          	auipc	a0,0x3
ffffffffc02022e8:	edc50513          	addi	a0,a0,-292 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc02022ec:	888fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02022f0:	00003697          	auipc	a3,0x3
ffffffffc02022f4:	18868693          	addi	a3,a3,392 # ffffffffc0205478 <default_pmm_manager+0x370>
ffffffffc02022f8:	00003617          	auipc	a2,0x3
ffffffffc02022fc:	a6060613          	addi	a2,a2,-1440 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202300:	1a800593          	li	a1,424
ffffffffc0202304:	00003517          	auipc	a0,0x3
ffffffffc0202308:	ebc50513          	addi	a0,a0,-324 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc020230c:	868fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202310:	00003697          	auipc	a3,0x3
ffffffffc0202314:	0a068693          	addi	a3,a3,160 # ffffffffc02053b0 <default_pmm_manager+0x2a8>
ffffffffc0202318:	00003617          	auipc	a2,0x3
ffffffffc020231c:	a4060613          	addi	a2,a2,-1472 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202320:	1a000593          	li	a1,416
ffffffffc0202324:	00003517          	auipc	a0,0x3
ffffffffc0202328:	e9c50513          	addi	a0,a0,-356 # ffffffffc02051c0 <default_pmm_manager+0xb8>
...
ffffffffc0202336:	e6660613          	addi	a2,a2,-410 # ffffffffc0205198 <default_pmm_manager+0x90>
ffffffffc020233a:	19f00593          	li	a1,415
ffffffffc020233e:	00003517          	auipc	a0,0x3
ffffffffc0202342:	e8250513          	addi	a0,a0,-382 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc0202346:	82efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020234a:	00003697          	auipc	a3,0x3
ffffffffc020234e:	0c668693          	addi	a3,a3,198 # ffffffffc0205410 <default_pmm_manager+0x308>
ffffffffc0202352:	00003617          	auipc	a2,0x3
ffffffffc0202356:	a0660613          	addi	a2,a2,-1530 # ffffffffc0204d58 <commands+0x738>
ffffffffc020235a:	1ad00593          	li	a1,429
ffffffffc020235e:	00003517          	auipc	a0,0x3
ffffffffc0202362:	e6250513          	addi	a0,a0,-414 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc0202366:	80efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020236a:	00003697          	auipc	a3,0x3
ffffffffc020236e:	16e68693          	addi	a3,a3,366 # ffffffffc02054d8 <default_pmm_manager+0x3d0>
ffffffffc0202372:	00003617          	auipc	a2,0x3
ffffffffc0202376:	9e660613          	addi	a2,a2,-1562 # ffffffffc0204d58 <commands+0x738>
ffffffffc020237a:	1ac00593          	li	a1,428
ffffffffc020237e:	00003517          	auipc	a0,0x3
ffffffffc0202382:	e4250513          	addi	a0,a0,-446 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc0202386:	feffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020238a:	00003697          	auipc	a3,0x3
ffffffffc020238e:	13668693          	addi	a3,a3,310 # ffffffffc02054c0 <default_pmm_manager+0x3b8>
ffffffffc0202392:	00003617          	auipc	a2,0x3
ffffffffc0202396:	9c660613          	addi	a2,a2,-1594 # ffffffffc0204d58 <commands+0x738>
ffffffffc020239a:	1ab00593          	li	a1,427
ffffffffc020239e:	00003517          	auipc	a0,0x3
ffffffffc02023a2:	e2250513          	addi	a0,a0,-478 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc02023a6:	fcffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc02023aa:	00003697          	auipc	a3,0x3
ffffffffc02023ae:	0e668693          	addi	a3,a3,230 # ffffffffc0205490 <default_pmm_manager+0x388>
ffffffffc02023b2:	00003617          	auipc	a2,0x3
ffffffffc02023b6:	9a660613          	addi	a2,a2,-1626 # ffffffffc0204d58 <commands+0x738>
ffffffffc02023ba:	1aa00593          	li	a1,426
ffffffffc02023be:	00003517          	auipc	a0,0x3
ffffffffc02023c2:	e0250513          	addi	a0,a0,-510 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc02023c6:	faffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc02023ca:	00003697          	auipc	a3,0x3
ffffffffc02023ce:	27e68693          	addi	a3,a3,638 # ffffffffc0205648 <default_pmm_manager+0x540>
ffffffffc02023d2:	00003617          	auipc	a2,0x3
ffffffffc02023d6:	98660613          	addi	a2,a2,-1658 # ffffffffc0204d58 <commands+0x738>
ffffffffc02023da:	1d800593          	li	a1,472
ffffffffc02023de:	00003517          	auipc	a0,0x3
ffffffffc02023e2:	de250513          	addi	a0,a0,-542 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc02023e6:	f8ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02023ea:	00003697          	auipc	a3,0x3
ffffffffc02023ee:	07668693          	addi	a3,a3,118 # ffffffffc0205460 <default_pmm_manager+0x358>
ffffffffc02023f2:	00003617          	auipc	a2,0x3
ffffffffc02023f6:	96660613          	addi	a2,a2,-1690 # ffffffffc0204d58 <commands+0x738>
ffffffffc02023fa:	1a700593          	li	a1,423
ffffffffc02023fe:	00003517          	auipc	a0,0x3
ffffffffc0202402:	dc250513          	addi	a0,a0,-574 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc0202406:	f6ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_W);
ffffffffc020240a:	00003697          	auipc	a3,0x3
ffffffffc020240e:	04668693          	addi	a3,a3,70 # ffffffffc0205450 <default_pmm_manager+0x348>
ffffffffc0202412:	00003617          	auipc	a2,0x3
ffffffffc0202416:	94660613          	addi	a2,a2,-1722 # ffffffffc0204d58 <commands+0x738>
ffffffffc020241a:	1a600593          	li	a1,422
ffffffffc020241e:	00003517          	auipc	a0,0x3
ffffffffc0202422:	da250513          	addi	a0,a0,-606 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc0202426:	f4ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020242a:	00003697          	auipc	a3,0x3
ffffffffc020242e:	11e68693          	addi	a3,a3,286 # ffffffffc0205548 <default_pmm_manager+0x440>
ffffffffc0202432:	00003617          	auipc	a2,0x3
ffffffffc0202436:	92660613          	addi	a2,a2,-1754 # ffffffffc0204d58 <commands+0x738>
ffffffffc020243a:	1e800593          	li	a1,488
ffffffffc020243e:	00003517          	auipc	a0,0x3
ffffffffc0202442:	d8250513          	addi	a0,a0,-638 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc0202446:	f2ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020244a:	00003697          	auipc	a3,0x3
ffffffffc020244e:	ff668693          	addi	a3,a3,-10 # ffffffffc0205440 <default_pmm_manager+0x338>
ffffffffc0202452:	00003617          	auipc	a2,0x3
ffffffffc0202456:	90660613          	addi	a2,a2,-1786 # ffffffffc0204d58 <commands+0x738>
ffffffffc020245a:	1a500593          	li	a1,421
ffffffffc020245e:	00003517          	auipc	a0,0x3
ffffffffc0202462:	d6250513          	addi	a0,a0,-670 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc0202466:	f0ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020246a:	00003697          	auipc	a3,0x3
ffffffffc020246e:	f2e68693          	addi	a3,a3,-210 # ffffffffc0205398 <default_pmm_manager+0x290>
ffffffffc0202472:	00003617          	auipc	a2,0x3
ffffffffc0202476:	8e660613          	addi	a2,a2,-1818 # ffffffffc0204d58 <commands+0x738>
ffffffffc020247a:	1b200593          	li	a1,434
ffffffffc020247e:	00003517          	auipc	a0,0x3
ffffffffc0202482:	d4250513          	addi	a0,a0,-702 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc0202486:	eeffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020248a:	00003697          	auipc	a3,0x3
ffffffffc020248e:	06668693          	addi	a3,a3,102 # ffffffffc02054f0 <default_pmm_manager+0x3e8>
ffffffffc0202492:	00003617          	auipc	a2,0x3
ffffffffc0202496:	8c660613          	addi	a2,a2,-1850 # ffffffffc0204d58 <commands+0x738>
ffffffffc020249a:	1af00593          	li	a1,431
ffffffffc020249e:	00003517          	auipc	a0,0x3
ffffffffc02024a2:	d2250513          	addi	a0,a0,-734 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc02024a6:	ecffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02024aa:	00003697          	auipc	a3,0x3
ffffffffc02024ae:	ed668693          	addi	a3,a3,-298 # ffffffffc0205380 <default_pmm_manager+0x278>
ffffffffc02024b2:	00003617          	auipc	a2,0x3
ffffffffc02024b6:	8a660613          	addi	a2,a2,-1882 # ffffffffc0204d58 <commands+0x738>
ffffffffc02024ba:	1ae00593          	li	a1,430
ffffffffc02024be:	00003517          	auipc	a0,0x3
ffffffffc02024c2:	d0250513          	addi	a0,a0,-766 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc02024c6:	eaffd0ef          	jal	ra,ffffffffc0200374 <__panic>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc02024ca:	00003617          	auipc	a2,0x3
ffffffffc02024ce:	cce60613          	addi	a2,a2,-818 # ffffffffc0205198 <default_pmm_manager+0x90>
ffffffffc02024d2:	06a00593          	li	a1,106
ffffffffc02024d6:	00003517          	auipc	a0,0x3
ffffffffc02024da:	c8a50513          	addi	a0,a0,-886 # ffffffffc0205160 <default_pmm_manager+0x58>
ffffffffc02024de:	e97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02024e2:	00003697          	auipc	a3,0x3
ffffffffc02024e6:	03e68693          	addi	a3,a3,62 # ffffffffc0205520 <default_pmm_manager+0x418>
ffffffffc02024ea:	00003617          	auipc	a2,0x3
ffffffffc02024ee:	86e60613          	addi	a2,a2,-1938 # ffffffffc0204d58 <commands+0x738>
ffffffffc02024f2:	1b900593          	li	a1,441
ffffffffc02024f6:	00003517          	auipc	a0,0x3
ffffffffc02024fa:	cca50513          	addi	a0,a0,-822 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc02024fe:	e77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202502:	00003697          	auipc	a3,0x3
ffffffffc0202506:	fd668693          	addi	a3,a3,-42 # ffffffffc02054d8 <default_pmm_manager+0x3d0>
ffffffffc020250a:	00003617          	auipc	a2,0x3
ffffffffc020250e:	84e60613          	addi	a2,a2,-1970 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202512:	1b700593          	li	a1,439
ffffffffc0202516:	00003517          	auipc	a0,0x3
ffffffffc020251a:	caa50513          	addi	a0,a0,-854 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc020251e:	e57fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202522:	00003697          	auipc	a3,0x3
ffffffffc0202526:	fe668693          	addi	a3,a3,-26 # ffffffffc0205508 <default_pmm_manager+0x400>
ffffffffc020252a:	00003617          	auipc	a2,0x3
ffffffffc020252e:	82e60613          	addi	a2,a2,-2002 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202532:	1b600593          	li	a1,438
ffffffffc0202536:	00003517          	auipc	a0,0x3
ffffffffc020253a:	c8a50513          	addi	a0,a0,-886 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc020253e:	e37fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202542:	00003697          	auipc	a3,0x3
ffffffffc0202546:	f9668693          	addi	a3,a3,-106 # ffffffffc02054d8 <default_pmm_manager+0x3d0>
ffffffffc020254a:	00003617          	auipc	a2,0x3
ffffffffc020254e:	80e60613          	addi	a2,a2,-2034 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202552:	1b300593          	li	a1,435
ffffffffc0202556:	00003517          	auipc	a0,0x3
ffffffffc020255a:	c6a50513          	addi	a0,a0,-918 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc020255e:	e17fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202562:	00003697          	auipc	a3,0x3
ffffffffc0202566:	0ce68693          	addi	a3,a3,206 # ffffffffc0205630 <default_pmm_manager+0x528>
ffffffffc020256a:	00002617          	auipc	a2,0x2
ffffffffc020256e:	7ee60613          	addi	a2,a2,2030 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202572:	1d700593          	li	a1,471
ffffffffc0202576:	00003517          	auipc	a0,0x3
ffffffffc020257a:	c4a50513          	addi	a0,a0,-950 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc020257e:	df7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202582:	00003697          	auipc	a3,0x3
ffffffffc0202586:	07668693          	addi	a3,a3,118 # ffffffffc02055f8 <default_pmm_manager+0x4f0>
ffffffffc020258a:	00002617          	auipc	a2,0x2
ffffffffc020258e:	7ce60613          	addi	a2,a2,1998 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202592:	1d600593          	li	a1,470
ffffffffc0202596:	00003517          	auipc	a0,0x3
ffffffffc020259a:	c2a50513          	addi	a0,a0,-982 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc020259e:	dd7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc02025a2:	00003697          	auipc	a3,0x3
ffffffffc02025a6:	03e68693          	addi	a3,a3,62 # ffffffffc02055e0 <default_pmm_manager+0x4d8>
ffffffffc02025aa:	00002617          	auipc	a2,0x2
ffffffffc02025ae:	7ae60613          	addi	a2,a2,1966 # ffffffffc0204d58 <commands+0x738>
ffffffffc02025b2:	1d200593          	li	a1,466
ffffffffc02025b6:	00003517          	auipc	a0,0x3
ffffffffc02025ba:	c0a50513          	addi	a0,a0,-1014 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc02025be:	db7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02025c2:	00003697          	auipc	a3,0x3
ffffffffc02025c6:	f8668693          	addi	a3,a3,-122 # ffffffffc0205548 <default_pmm_manager+0x440>
ffffffffc02025ca:	00002617          	auipc	a2,0x2
ffffffffc02025ce:	78e60613          	addi	a2,a2,1934 # ffffffffc0204d58 <commands+0x738>
ffffffffc02025d2:	1c000593          	li	a1,448
ffffffffc02025d6:	00003517          	auipc	a0,0x3
ffffffffc02025da:	bea50513          	addi	a0,a0,-1046 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc02025de:	d97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02025e2:	00003697          	auipc	a3,0x3
ffffffffc02025e6:	d9e68693          	addi	a3,a3,-610 # ffffffffc0205380 <default_pmm_manager+0x278>
ffffffffc02025ea:	00002617          	auipc	a2,0x2
ffffffffc02025ee:	76e60613          	addi	a2,a2,1902 # ffffffffc0204d58 <commands+0x738>
ffffffffc02025f2:	19b00593          	li	a1,411
ffffffffc02025f6:	00003517          	auipc	a0,0x3
ffffffffc02025fa:	bca50513          	addi	a0,a0,-1078 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc02025fe:	d77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc0202602:	00003617          	auipc	a2,0x3
ffffffffc0202606:	b9660613          	addi	a2,a2,-1130 # ffffffffc0205198 <default_pmm_manager+0x90>
ffffffffc020260a:	19e00593          	li	a1,414
ffffffffc020260e:	00003517          	auipc	a0,0x3
ffffffffc0202612:	bb250513          	addi	a0,a0,-1102 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc0202616:	d5ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020261a:	00003697          	auipc	a3,0x3
ffffffffc020261e:	d7e68693          	addi	a3,a3,-642 # ffffffffc0205398 <default_pmm_manager+0x290>
ffffffffc0202622:	00002617          	auipc	a2,0x2
ffffffffc0202626:	73660613          	addi	a2,a2,1846 # ffffffffc0204d58 <commands+0x738>
ffffffffc020262a:	19c00593          	li	a1,412
ffffffffc020262e:	00003517          	auipc	a0,0x3
ffffffffc0202632:	b9250513          	addi	a0,a0,-1134 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc0202636:	d3ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020263a:	00003697          	auipc	a3,0x3
ffffffffc020263e:	dd668693          	addi	a3,a3,-554 # ffffffffc0205410 <default_pmm_manager+0x308>
ffffffffc0202642:	00002617          	auipc	a2,0x2
ffffffffc0202646:	71660613          	addi	a2,a2,1814 # ffffffffc0204d58 <commands+0x738>
ffffffffc020264a:	1a400593          	li	a1,420
ffffffffc020264e:	00003517          	auipc	a0,0x3
ffffffffc0202652:	b7250513          	addi	a0,a0,-1166 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc0202656:	d1ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020265a:	00003697          	auipc	a3,0x3
ffffffffc020265e:	09668693          	addi	a3,a3,150 # ffffffffc02056f0 <default_pmm_manager+0x5e8>
ffffffffc0202662:	00002617          	auipc	a2,0x2
ffffffffc0202666:	6f660613          	addi	a2,a2,1782 # ffffffffc0204d58 <commands+0x738>
ffffffffc020266a:	1e000593          	li	a1,480
ffffffffc020266e:	00003517          	auipc	a0,0x3
ffffffffc0202672:	b5250513          	addi	a0,a0,-1198 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc0202676:	cfffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020267a:	00003697          	auipc	a3,0x3
ffffffffc020267e:	03e68693          	addi	a3,a3,62 # ffffffffc02056b8 <default_pmm_manager+0x5b0>
ffffffffc0202682:	00002617          	auipc	a2,0x2
ffffffffc0202686:	6d660613          	addi	a2,a2,1750 # ffffffffc0204d58 <commands+0x738>
ffffffffc020268a:	1dd00593          	li	a1,477
ffffffffc020268e:	00003517          	auipc	a0,0x3
ffffffffc0202692:	b3250513          	addi	a0,a0,-1230 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc0202696:	cdffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 2);
ffffffffc020269a:	00003697          	auipc	a3,0x3
ffffffffc020269e:	fee68693          	addi	a3,a3,-18 # ffffffffc0205688 <default_pmm_manager+0x580>
ffffffffc02026a2:	00002617          	auipc	a2,0x2
ffffffffc02026a6:	6b660613          	addi	a2,a2,1718 # ffffffffc0204d58 <commands+0x738>
ffffffffc02026aa:	1d900593          	li	a1,473
ffffffffc02026ae:	00003517          	auipc	a0,0x3
ffffffffc02026b2:	b1250513          	addi	a0,a0,-1262 # ffffffffc02051c0 <default_pmm_manager+0xb8>
...
ffffffffc0202724:	01868693          	addi	a3,a3,24 # ffffffffc0205738 <default_pmm_manager+0x630>
ffffffffc0202728:	00002617          	auipc	a2,0x2
ffffffffc020272c:	63060613          	addi	a2,a2,1584 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202730:	17a00593          	li	a1,378
ffffffffc0202734:	00003517          	auipc	a0,0x3
ffffffffc0202738:	a8c50513          	addi	a0,a0,-1396 # ffffffffc02051c0 <default_pmm_manager+0xb8>
...
ffffffffc02027a4:	a006b683          	ld	a3,-1536(a3) # ffffffffc02061a0 <error_string+0x38>
...
ffffffffc02027dc:	f7868693          	addi	a3,a3,-136 # ffffffffc0205750 <default_pmm_manager+0x648>
ffffffffc02027e0:	00002617          	auipc	a2,0x2
ffffffffc02027e4:	57860613          	addi	a2,a2,1400 # ffffffffc0204d58 <commands+0x738>
ffffffffc02027e8:	1f000593          	li	a1,496
ffffffffc02027ec:	00003517          	auipc	a0,0x3
ffffffffc02027f0:	9d450513          	addi	a0,a0,-1580 # ffffffffc02051c0 <default_pmm_manager+0xb8>
...
ffffffffc02027fe:	99e60613          	addi	a2,a2,-1634 # ffffffffc0205198 <default_pmm_manager+0x90>
ffffffffc0202802:	06a00593          	li	a1,106
ffffffffc0202806:	00003517          	auipc	a0,0x3
ffffffffc020280a:	95a50513          	addi	a0,a0,-1702 # ffffffffc0205160 <default_pmm_manager+0x58>
ffffffffc020280e:	b67fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(base != NULL);
ffffffffc0202812:	00003697          	auipc	a3,0x3
ffffffffc0202816:	f5e68693          	addi	a3,a3,-162 # ffffffffc0205770 <default_pmm_manager+0x668>
ffffffffc020281a:	00002617          	auipc	a2,0x2
ffffffffc020281e:	53e60613          	addi	a2,a2,1342 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202822:	1f300593          	li	a1,499
ffffffffc0202826:	00003517          	auipc	a0,0x3
ffffffffc020282a:	99a50513          	addi	a0,a0,-1638 # ffffffffc02051c0 <default_pmm_manager+0xb8>
...
ffffffffc02028c6:	99660613          	addi	a2,a2,-1642 # ffffffffc0205258 <default_pmm_manager+0x150>
ffffffffc02028ca:	06c00593          	li	a1,108
ffffffffc02028ce:	00003517          	auipc	a0,0x3
ffffffffc02028d2:	89250513          	addi	a0,a0,-1902 # ffffffffc0205160 <default_pmm_manager+0x58>
ffffffffc02028d6:	a9ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(ptr != NULL);
ffffffffc02028da:	00003697          	auipc	a3,0x3
ffffffffc02028de:	ea668693          	addi	a3,a3,-346 # ffffffffc0205780 <default_pmm_manager+0x678>
ffffffffc02028e2:	00002617          	auipc	a2,0x2
ffffffffc02028e6:	47660613          	addi	a2,a2,1142 # ffffffffc0204d58 <commands+0x738>
ffffffffc02028ea:	1fa00593          	li	a1,506
ffffffffc02028ee:	00003517          	auipc	a0,0x3
ffffffffc02028f2:	8d250513          	addi	a0,a0,-1838 # ffffffffc02051c0 <default_pmm_manager+0xb8>
ffffffffc02028f6:	a7ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0 && n < 1024 * 0124);
ffffffffc02028fa:	00003697          	auipc	a3,0x3
ffffffffc02028fe:	e5668693          	addi	a3,a3,-426 # ffffffffc0205750 <default_pmm_manager+0x648>
ffffffffc0202902:	00002617          	auipc	a2,0x2
ffffffffc0202906:	45660613          	addi	a2,a2,1110 # ffffffffc0204d58 <commands+0x738>
ffffffffc020290a:	1f900593          	li	a1,505
ffffffffc020290e:	00003517          	auipc	a0,0x3
ffffffffc0202912:	8b250513          	addi	a0,a0,-1870 # ffffffffc02051c0 <default_pmm_manager+0xb8>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	3de010ef          	jal	ra,ffffffffc0203d14 <swapfs_init>
...
ffffffffc0202994:	e3050513          	addi	a0,a0,-464 # ffffffffc02057c0 <default_pmm_manager+0x6b8>
    return listelm->next;
...
ffffffffc02029e4:	df850513          	addi	a0,a0,-520 # ffffffffc02057d8 <default_pmm_manager+0x6d0>
ffffffffc02029e8:	ed2fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc02029ec:	2c7000ef          	jal	ra,ffffffffc02034b2 <mm_create>
...
ffffffffc0202a20:	2db000ef          	jal	ra,ffffffffc02034fa <vma_create>
...
ffffffffc0202a2c:	33d000ef          	jal	ra,ffffffffc0203568 <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc0202a30:	00003517          	auipc	a0,0x3
ffffffffc0202a34:	e1850513          	addi	a0,a0,-488 # ffffffffc0205848 <default_pmm_manager+0x740>
...
ffffffffc0202a50:	e4c50513          	addi	a0,a0,-436 # ffffffffc0205898 <default_pmm_manager+0x790>
...
ffffffffc0202ac4:	e6050513          	addi	a0,a0,-416 # ffffffffc0205920 <default_pmm_manager+0x818>
...
ffffffffc0202ba0:	60cc0c13          	addi	s8,s8,1548 # ffffffffc02061a8 <nbase>
...
ffffffffc0202c10:	dbc50513          	addi	a0,a0,-580 # ffffffffc02059c8 <default_pmm_manager+0x8c0>
...
ffffffffc0202c36:	203000ef          	jal	ra,ffffffffc0203638 <mm_destroy>
...
ffffffffc0202c62:	d9a50513          	addi	a0,a0,-614 # ffffffffc02059f8 <default_pmm_manager+0x8f0>
ffffffffc0202c66:	c54fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202c6a:	00003517          	auipc	a0,0x3
ffffffffc0202c6e:	dae50513          	addi	a0,a0,-594 # ffffffffc0205a18 <default_pmm_manager+0x910>
...
ffffffffc0202c80:	0cc68693          	addi	a3,a3,204 # ffffffffc0204d48 <commands+0x728>
ffffffffc0202c84:	00002617          	auipc	a2,0x2
ffffffffc0202c88:	0d460613          	addi	a2,a2,212 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202c8c:	0ba00593          	li	a1,186
ffffffffc0202c90:	00003517          	auipc	a0,0x3
ffffffffc0202c94:	b2050513          	addi	a0,a0,-1248 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202c98:	edcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202c9c:	00003697          	auipc	a3,0x3
ffffffffc0202ca0:	d0468693          	addi	a3,a3,-764 # ffffffffc02059a0 <default_pmm_manager+0x898>
ffffffffc0202ca4:	00002617          	auipc	a2,0x2
ffffffffc0202ca8:	0b460613          	addi	a2,a2,180 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202cac:	0fa00593          	li	a1,250
ffffffffc0202cb0:	00003517          	auipc	a0,0x3
ffffffffc0202cb4:	b0050513          	addi	a0,a0,-1280 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202cb8:	ebcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202cbc:	00002617          	auipc	a2,0x2
ffffffffc0202cc0:	4b460613          	addi	a2,a2,1204 # ffffffffc0205170 <default_pmm_manager+0x68>
ffffffffc0202cc4:	07000593          	li	a1,112
ffffffffc0202cc8:	00002517          	auipc	a0,0x2
ffffffffc0202ccc:	49850513          	addi	a0,a0,1176 # ffffffffc0205160 <default_pmm_manager+0x58>
ffffffffc0202cd0:	ea4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202cd4:	00002617          	auipc	a2,0x2
ffffffffc0202cd8:	46c60613          	addi	a2,a2,1132 # ffffffffc0205140 <default_pmm_manager+0x38>
ffffffffc0202cdc:	06500593          	li	a1,101
ffffffffc0202ce0:	00002517          	auipc	a0,0x2
ffffffffc0202ce4:	48050513          	addi	a0,a0,1152 # ffffffffc0205160 <default_pmm_manager+0x58>
ffffffffc0202ce8:	e8cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202cec:	00003697          	auipc	a3,0x3
ffffffffc0202cf0:	bec68693          	addi	a3,a3,-1044 # ffffffffc02058d8 <default_pmm_manager+0x7d0>
ffffffffc0202cf4:	00002617          	auipc	a2,0x2
ffffffffc0202cf8:	06460613          	addi	a2,a2,100 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202cfc:	0db00593          	li	a1,219
ffffffffc0202d00:	00003517          	auipc	a0,0x3
ffffffffc0202d04:	ab050513          	addi	a0,a0,-1360 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202d08:	e6cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202d0c:	00003697          	auipc	a3,0x3
ffffffffc0202d10:	bb468693          	addi	a3,a3,-1100 # ffffffffc02058c0 <default_pmm_manager+0x7b8>
ffffffffc0202d14:	00002617          	auipc	a2,0x2
ffffffffc0202d18:	04460613          	addi	a2,a2,68 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202d1c:	0da00593          	li	a1,218
ffffffffc0202d20:	00003517          	auipc	a0,0x3
ffffffffc0202d24:	a9050513          	addi	a0,a0,-1392 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202d28:	e4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202d2c:	00003617          	auipc	a2,0x3
ffffffffc0202d30:	a6460613          	addi	a2,a2,-1436 # ffffffffc0205790 <default_pmm_manager+0x688>
ffffffffc0202d34:	02700593          	li	a1,39
ffffffffc0202d38:	00003517          	auipc	a0,0x3
ffffffffc0202d3c:	a7850513          	addi	a0,a0,-1416 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202d40:	e34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202d44:	00003697          	auipc	a3,0x3
ffffffffc0202d48:	c4468693          	addi	a3,a3,-956 # ffffffffc0205988 <default_pmm_manager+0x880>
ffffffffc0202d4c:	00002617          	auipc	a2,0x2
ffffffffc0202d50:	00c60613          	addi	a2,a2,12 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202d54:	0f900593          	li	a1,249
ffffffffc0202d58:	00003517          	auipc	a0,0x3
ffffffffc0202d5c:	a5850513          	addi	a0,a0,-1448 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202d60:	e14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d64:	00003697          	auipc	a3,0x3
ffffffffc0202d68:	c1468693          	addi	a3,a3,-1004 # ffffffffc0205978 <default_pmm_manager+0x870>
ffffffffc0202d6c:	00002617          	auipc	a2,0x2
ffffffffc0202d70:	fec60613          	addi	a2,a2,-20 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202d74:	09d00593          	li	a1,157
ffffffffc0202d78:	00003517          	auipc	a0,0x3
ffffffffc0202d7c:	a3850513          	addi	a0,a0,-1480 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202d80:	df4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d84:	00003697          	auipc	a3,0x3
ffffffffc0202d88:	bf468693          	addi	a3,a3,-1036 # ffffffffc0205978 <default_pmm_manager+0x870>
ffffffffc0202d8c:	00002617          	auipc	a2,0x2
ffffffffc0202d90:	fcc60613          	addi	a2,a2,-52 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202d94:	09f00593          	li	a1,159
ffffffffc0202d98:	00003517          	auipc	a0,0x3
ffffffffc0202d9c:	a1850513          	addi	a0,a0,-1512 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202da0:	dd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert( nr_free == 0);         
ffffffffc0202da4:	00002697          	auipc	a3,0x2
ffffffffc0202da8:	18c68693          	addi	a3,a3,396 # ffffffffc0204f30 <commands+0x910>
ffffffffc0202dac:	00002617          	auipc	a2,0x2
ffffffffc0202db0:	fac60613          	addi	a2,a2,-84 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202db4:	0f100593          	li	a1,241
ffffffffc0202db8:	00003517          	auipc	a0,0x3
ffffffffc0202dbc:	9f850513          	addi	a0,a0,-1544 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202dc0:	db4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(ret==0);
ffffffffc0202dc4:	00003697          	auipc	a3,0x3
ffffffffc0202dc8:	c2c68693          	addi	a3,a3,-980 # ffffffffc02059f0 <default_pmm_manager+0x8e8>
ffffffffc0202dcc:	00002617          	auipc	a2,0x2
ffffffffc0202dd0:	f8c60613          	addi	a2,a2,-116 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202dd4:	10000593          	li	a1,256
ffffffffc0202dd8:	00003517          	auipc	a0,0x3
ffffffffc0202ddc:	9d850513          	addi	a0,a0,-1576 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202de0:	d94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0202de4:	00003697          	auipc	a3,0x3
ffffffffc0202de8:	a4468693          	addi	a3,a3,-1468 # ffffffffc0205828 <default_pmm_manager+0x720>
ffffffffc0202dec:	00002617          	auipc	a2,0x2
ffffffffc0202df0:	f6c60613          	addi	a2,a2,-148 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202df4:	0ca00593          	li	a1,202
ffffffffc0202df8:	00003517          	auipc	a0,0x3
ffffffffc0202dfc:	9b850513          	addi	a0,a0,-1608 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202e00:	d74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(vma != NULL);
ffffffffc0202e04:	00003697          	auipc	a3,0x3
ffffffffc0202e08:	a3468693          	addi	a3,a3,-1484 # ffffffffc0205838 <default_pmm_manager+0x730>
ffffffffc0202e0c:	00002617          	auipc	a2,0x2
ffffffffc0202e10:	f4c60613          	addi	a2,a2,-180 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202e14:	0cd00593          	li	a1,205
ffffffffc0202e18:	00003517          	auipc	a0,0x3
ffffffffc0202e1c:	99850513          	addi	a0,a0,-1640 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202e20:	d54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0202e24:	00003697          	auipc	a3,0x3
ffffffffc0202e28:	a5c68693          	addi	a3,a3,-1444 # ffffffffc0205880 <default_pmm_manager+0x778>
ffffffffc0202e2c:	00002617          	auipc	a2,0x2
ffffffffc0202e30:	f2c60613          	addi	a2,a2,-212 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202e34:	0d500593          	li	a1,213
ffffffffc0202e38:	00003517          	auipc	a0,0x3
ffffffffc0202e3c:	97850513          	addi	a0,a0,-1672 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202e40:	d34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(total == nr_free_pages());
ffffffffc0202e44:	00002697          	auipc	a3,0x2
ffffffffc0202e48:	f4468693          	addi	a3,a3,-188 # ffffffffc0204d88 <commands+0x768>
ffffffffc0202e4c:	00002617          	auipc	a2,0x2
ffffffffc0202e50:	f0c60613          	addi	a2,a2,-244 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202e54:	0bd00593          	li	a1,189
ffffffffc0202e58:	00003517          	auipc	a0,0x3
ffffffffc0202e5c:	95850513          	addi	a0,a0,-1704 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202e60:	d14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e64:	00003697          	auipc	a3,0x3
ffffffffc0202e68:	af468693          	addi	a3,a3,-1292 # ffffffffc0205958 <default_pmm_manager+0x850>
ffffffffc0202e6c:	00002617          	auipc	a2,0x2
ffffffffc0202e70:	eec60613          	addi	a2,a2,-276 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202e74:	09500593          	li	a1,149
ffffffffc0202e78:	00003517          	auipc	a0,0x3
ffffffffc0202e7c:	93850513          	addi	a0,a0,-1736 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202e80:	cf4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e84:	00003697          	auipc	a3,0x3
ffffffffc0202e88:	ad468693          	addi	a3,a3,-1324 # ffffffffc0205958 <default_pmm_manager+0x850>
ffffffffc0202e8c:	00002617          	auipc	a2,0x2
ffffffffc0202e90:	ecc60613          	addi	a2,a2,-308 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202e94:	09700593          	li	a1,151
ffffffffc0202e98:	00003517          	auipc	a0,0x3
ffffffffc0202e9c:	91850513          	addi	a0,a0,-1768 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202ea0:	cd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ea4:	00003697          	auipc	a3,0x3
ffffffffc0202ea8:	ac468693          	addi	a3,a3,-1340 # ffffffffc0205968 <default_pmm_manager+0x860>
ffffffffc0202eac:	00002617          	auipc	a2,0x2
ffffffffc0202eb0:	eac60613          	addi	a2,a2,-340 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202eb4:	09900593          	li	a1,153
ffffffffc0202eb8:	00003517          	auipc	a0,0x3
ffffffffc0202ebc:	8f850513          	addi	a0,a0,-1800 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202ec0:	cb4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ec4:	00003697          	auipc	a3,0x3
ffffffffc0202ec8:	aa468693          	addi	a3,a3,-1372 # ffffffffc0205968 <default_pmm_manager+0x860>
ffffffffc0202ecc:	00002617          	auipc	a2,0x2
ffffffffc0202ed0:	e8c60613          	addi	a2,a2,-372 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202ed4:	09b00593          	li	a1,155
ffffffffc0202ed8:	00003517          	auipc	a0,0x3
ffffffffc0202edc:	8d850513          	addi	a0,a0,-1832 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202ee0:	c94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202ee4:	00003697          	auipc	a3,0x3
ffffffffc0202ee8:	a6468693          	addi	a3,a3,-1436 # ffffffffc0205948 <default_pmm_manager+0x840>
ffffffffc0202eec:	00002617          	auipc	a2,0x2
ffffffffc0202ef0:	e6c60613          	addi	a2,a2,-404 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202ef4:	09100593          	li	a1,145
ffffffffc0202ef8:	00003517          	auipc	a0,0x3
ffffffffc0202efc:	8b850513          	addi	a0,a0,-1864 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202f00:	c74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202f04:	00003697          	auipc	a3,0x3
ffffffffc0202f08:	a4468693          	addi	a3,a3,-1468 # ffffffffc0205948 <default_pmm_manager+0x840>
ffffffffc0202f0c:	00002617          	auipc	a2,0x2
ffffffffc0202f10:	e4c60613          	addi	a2,a2,-436 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202f14:	09300593          	li	a1,147
ffffffffc0202f18:	00003517          	auipc	a0,0x3
ffffffffc0202f1c:	89850513          	addi	a0,a0,-1896 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202f20:	c54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(mm != NULL);
ffffffffc0202f24:	00003697          	auipc	a3,0x3
ffffffffc0202f28:	8dc68693          	addi	a3,a3,-1828 # ffffffffc0205800 <default_pmm_manager+0x6f8>
ffffffffc0202f2c:	00002617          	auipc	a2,0x2
ffffffffc0202f30:	e2c60613          	addi	a2,a2,-468 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202f34:	0c200593          	li	a1,194
ffffffffc0202f38:	00003517          	auipc	a0,0x3
ffffffffc0202f3c:	87850513          	addi	a0,a0,-1928 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202f40:	c34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0202f44:	00003697          	auipc	a3,0x3
ffffffffc0202f48:	8cc68693          	addi	a3,a3,-1844 # ffffffffc0205810 <default_pmm_manager+0x708>
ffffffffc0202f4c:	00002617          	auipc	a2,0x2
ffffffffc0202f50:	e0c60613          	addi	a2,a2,-500 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202f54:	0c500593          	li	a1,197
ffffffffc0202f58:	00003517          	auipc	a0,0x3
ffffffffc0202f5c:	85850513          	addi	a0,a0,-1960 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
ffffffffc0202f60:	c14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0202f64:	00003697          	auipc	a3,0x3
ffffffffc0202f68:	99468693          	addi	a3,a3,-1644 # ffffffffc02058f8 <default_pmm_manager+0x7f0>
ffffffffc0202f6c:	00002617          	auipc	a2,0x2
ffffffffc0202f70:	dec60613          	addi	a2,a2,-532 # ffffffffc0204d58 <commands+0x738>
ffffffffc0202f74:	0e800593          	li	a1,232
ffffffffc0202f78:	00003517          	auipc	a0,0x3
ffffffffc0202f7c:	83850513          	addi	a0,a0,-1992 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
...
ffffffffc0202fc8:	ad4b0b13          	addi	s6,s6,-1324 # ffffffffc0205a98 <default_pmm_manager+0x990>
                    cprintf("SWAP: failed to save\n");
ffffffffc0202fcc:	00003b97          	auipc	s7,0x3
ffffffffc0202fd0:	ab4b8b93          	addi	s7,s7,-1356 # ffffffffc0205a80 <default_pmm_manager+0x978>
...
ffffffffc0203040:	5a7000ef          	jal	ra,ffffffffc0203de6 <swapfs_write>
...
ffffffffc0203082:	9ba50513          	addi	a0,a0,-1606 # ffffffffc0205a38 <default_pmm_manager+0x930>
...
ffffffffc0203094:	9d868693          	addi	a3,a3,-1576 # ffffffffc0205a68 <default_pmm_manager+0x960>
ffffffffc0203098:	00002617          	auipc	a2,0x2
ffffffffc020309c:	cc060613          	addi	a2,a2,-832 # ffffffffc0204d58 <commands+0x738>
ffffffffc02030a0:	06600593          	li	a1,102
ffffffffc02030a4:	00002517          	auipc	a0,0x2
ffffffffc02030a8:	70c50513          	addi	a0,a0,1804 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
...
ffffffffc02030de:	46f000ef          	jal	ra,ffffffffc0203d4c <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02030e2:	00093583          	ld	a1,0(s2)
ffffffffc02030e6:	8626                	mv	a2,s1
ffffffffc02030e8:	00003517          	auipc	a0,0x3
ffffffffc02030ec:	a0050513          	addi	a0,a0,-1536 # ffffffffc0205ae8 <default_pmm_manager+0x9e0>
...
ffffffffc020310e:	9ce68693          	addi	a3,a3,-1586 # ffffffffc0205ad8 <default_pmm_manager+0x9d0>
ffffffffc0203112:	00002617          	auipc	a2,0x2
ffffffffc0203116:	c4660613          	addi	a2,a2,-954 # ffffffffc0204d58 <commands+0x738>
ffffffffc020311a:	07c00593          	li	a1,124
ffffffffc020311e:	00002517          	auipc	a0,0x2
ffffffffc0203122:	69250513          	addi	a0,a0,1682 # ffffffffc02057b0 <default_pmm_manager+0x6a8>
...
ffffffffc0203210:	76c68693          	addi	a3,a3,1900 # ffffffffc0205978 <default_pmm_manager+0x870>
ffffffffc0203214:	00002617          	auipc	a2,0x2
ffffffffc0203218:	b4460613          	addi	a2,a2,-1212 # ffffffffc0204d58 <commands+0x738>
ffffffffc020321c:	09300593          	li	a1,147
ffffffffc0203220:	00003517          	auipc	a0,0x3
ffffffffc0203224:	90850513          	addi	a0,a0,-1784 # ffffffffc0205b28 <default_pmm_manager+0xa20>
ffffffffc0203228:	94cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==6);
ffffffffc020322c:	00003697          	auipc	a3,0x3
ffffffffc0203230:	94c68693          	addi	a3,a3,-1716 # ffffffffc0205b78 <default_pmm_manager+0xa70>
ffffffffc0203234:	00002617          	auipc	a2,0x2
ffffffffc0203238:	b2460613          	addi	a2,a2,-1244 # ffffffffc0204d58 <commands+0x738>
ffffffffc020323c:	0aa00593          	li	a1,170
ffffffffc0203240:	00003517          	auipc	a0,0x3
ffffffffc0203244:	8e850513          	addi	a0,a0,-1816 # ffffffffc0205b28 <default_pmm_manager+0xa20>
ffffffffc0203248:	92cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc020324c:	00003697          	auipc	a3,0x3
ffffffffc0203250:	90468693          	addi	a3,a3,-1788 # ffffffffc0205b50 <default_pmm_manager+0xa48>
ffffffffc0203254:	00002617          	auipc	a2,0x2
ffffffffc0203258:	b0460613          	addi	a2,a2,-1276 # ffffffffc0204d58 <commands+0x738>
ffffffffc020325c:	0a800593          	li	a1,168
ffffffffc0203260:	00003517          	auipc	a0,0x3
ffffffffc0203264:	8c850513          	addi	a0,a0,-1848 # ffffffffc0205b28 <default_pmm_manager+0xa20>
ffffffffc0203268:	90cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020326c:	00003697          	auipc	a3,0x3
ffffffffc0203270:	8d468693          	addi	a3,a3,-1836 # ffffffffc0205b40 <default_pmm_manager+0xa38>
ffffffffc0203274:	00002617          	auipc	a2,0x2
ffffffffc0203278:	ae460613          	addi	a2,a2,-1308 # ffffffffc0204d58 <commands+0x738>
ffffffffc020327c:	0a700593          	li	a1,167
ffffffffc0203280:	00003517          	auipc	a0,0x3
ffffffffc0203284:	8a850513          	addi	a0,a0,-1880 # ffffffffc0205b28 <default_pmm_manager+0xa20>
ffffffffc0203288:	8ecfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020328c:	00003697          	auipc	a3,0x3
ffffffffc0203290:	8b468693          	addi	a3,a3,-1868 # ffffffffc0205b40 <default_pmm_manager+0xa38>
ffffffffc0203294:	00002617          	auipc	a2,0x2
ffffffffc0203298:	ac460613          	addi	a2,a2,-1340 # ffffffffc0204d58 <commands+0x738>
ffffffffc020329c:	0a500593          	li	a1,165
ffffffffc02032a0:	00003517          	auipc	a0,0x3
ffffffffc02032a4:	88850513          	addi	a0,a0,-1912 # ffffffffc0205b28 <default_pmm_manager+0xa20>
ffffffffc02032a8:	8ccfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032ac:	00003697          	auipc	a3,0x3
ffffffffc02032b0:	89468693          	addi	a3,a3,-1900 # ffffffffc0205b40 <default_pmm_manager+0xa38>
ffffffffc02032b4:	00002617          	auipc	a2,0x2
ffffffffc02032b8:	aa460613          	addi	a2,a2,-1372 # ffffffffc0204d58 <commands+0x738>
ffffffffc02032bc:	0a300593          	li	a1,163
ffffffffc02032c0:	00003517          	auipc	a0,0x3
ffffffffc02032c4:	86850513          	addi	a0,a0,-1944 # ffffffffc0205b28 <default_pmm_manager+0xa20>
ffffffffc02032c8:	8acfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032cc:	00003697          	auipc	a3,0x3
ffffffffc02032d0:	87468693          	addi	a3,a3,-1932 # ffffffffc0205b40 <default_pmm_manager+0xa38>
ffffffffc02032d4:	00002617          	auipc	a2,0x2
ffffffffc02032d8:	a8460613          	addi	a2,a2,-1404 # ffffffffc0204d58 <commands+0x738>
ffffffffc02032dc:	0a100593          	li	a1,161
ffffffffc02032e0:	00003517          	auipc	a0,0x3
ffffffffc02032e4:	84850513          	addi	a0,a0,-1976 # ffffffffc0205b28 <default_pmm_manager+0xa20>
ffffffffc02032e8:	88cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032ec:	00003697          	auipc	a3,0x3
ffffffffc02032f0:	85468693          	addi	a3,a3,-1964 # ffffffffc0205b40 <default_pmm_manager+0xa38>
ffffffffc02032f4:	00002617          	auipc	a2,0x2
ffffffffc02032f8:	a6460613          	addi	a2,a2,-1436 # ffffffffc0204d58 <commands+0x738>
ffffffffc02032fc:	09f00593          	li	a1,159
ffffffffc0203300:	00003517          	auipc	a0,0x3
ffffffffc0203304:	82850513          	addi	a0,a0,-2008 # ffffffffc0205b28 <default_pmm_manager+0xa20>
ffffffffc0203308:	86cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020330c:	00003697          	auipc	a3,0x3
ffffffffc0203310:	83468693          	addi	a3,a3,-1996 # ffffffffc0205b40 <default_pmm_manager+0xa38>
ffffffffc0203314:	00002617          	auipc	a2,0x2
ffffffffc0203318:	a4460613          	addi	a2,a2,-1468 # ffffffffc0204d58 <commands+0x738>
ffffffffc020331c:	09d00593          	li	a1,157
ffffffffc0203320:	00003517          	auipc	a0,0x3
ffffffffc0203324:	80850513          	addi	a0,a0,-2040 # ffffffffc0205b28 <default_pmm_manager+0xa20>
ffffffffc0203328:	84cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020332c:	00003697          	auipc	a3,0x3
ffffffffc0203330:	81468693          	addi	a3,a3,-2028 # ffffffffc0205b40 <default_pmm_manager+0xa38>
ffffffffc0203334:	00002617          	auipc	a2,0x2
ffffffffc0203338:	a2460613          	addi	a2,a2,-1500 # ffffffffc0204d58 <commands+0x738>
ffffffffc020333c:	09b00593          	li	a1,155
ffffffffc0203340:	00002517          	auipc	a0,0x2
ffffffffc0203344:	7e850513          	addi	a0,a0,2024 # ffffffffc0205b28 <default_pmm_manager+0xa20>
ffffffffc0203348:	82cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020334c:	00002697          	auipc	a3,0x2
ffffffffc0203350:	62c68693          	addi	a3,a3,1580 # ffffffffc0205978 <default_pmm_manager+0x870>
ffffffffc0203354:	00002617          	auipc	a2,0x2
ffffffffc0203358:	a0460613          	addi	a2,a2,-1532 # ffffffffc0204d58 <commands+0x738>
ffffffffc020335c:	09900593          	li	a1,153
ffffffffc0203360:	00002517          	auipc	a0,0x2
ffffffffc0203364:	7c850513          	addi	a0,a0,1992 # ffffffffc0205b28 <default_pmm_manager+0xa20>
ffffffffc0203368:	80cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020336c:	00002697          	auipc	a3,0x2
ffffffffc0203370:	60c68693          	addi	a3,a3,1548 # ffffffffc0205978 <default_pmm_manager+0x870>
ffffffffc0203374:	00002617          	auipc	a2,0x2
ffffffffc0203378:	9e460613          	addi	a2,a2,-1564 # ffffffffc0204d58 <commands+0x738>
ffffffffc020337c:	09700593          	li	a1,151
ffffffffc0203380:	00002517          	auipc	a0,0x2
ffffffffc0203384:	7a850513          	addi	a0,a0,1960 # ffffffffc0205b28 <default_pmm_manager+0xa20>
ffffffffc0203388:	fedfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020338c:	00002697          	auipc	a3,0x2
ffffffffc0203390:	5ec68693          	addi	a3,a3,1516 # ffffffffc0205978 <default_pmm_manager+0x870>
ffffffffc0203394:	00002617          	auipc	a2,0x2
ffffffffc0203398:	9c460613          	addi	a2,a2,-1596 # ffffffffc0204d58 <commands+0x738>
ffffffffc020339c:	09500593          	li	a1,149
ffffffffc02033a0:	00002517          	auipc	a0,0x2
ffffffffc02033a4:	78850513          	addi	a0,a0,1928 # ffffffffc0205b28 <default_pmm_manager+0xa20>
ffffffffc02033a8:	fcdfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02033ac <_clock_swap_out_victim>:
     list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc02033ac:	7508                	ld	a0,40(a0)
{
ffffffffc02033ae:	1141                	addi	sp,sp,-16
ffffffffc02033b0:	e406                	sd	ra,8(sp)
         assert(head != NULL);
ffffffffc02033b2:	c93d                	beqz	a0,ffffffffc0203428 <_clock_swap_out_victim+0x7c>
     assert(in_tick==0);
ffffffffc02033b4:	ea31                	bnez	a2,ffffffffc0203408 <_clock_swap_out_victim+0x5c>
    return listelm->next;
...
ffffffffc02033c2:	a039                	j	ffffffffc02033d0 <_clock_swap_out_victim+0x24>
        if(page->visited == 0)
ffffffffc02033c4:	fe07b683          	ld	a3,-32(a5)
ffffffffc02033c8:	ce91                	beqz	a3,ffffffffc02033e4 <_clock_swap_out_victim+0x38>
            page->visited = 0;
ffffffffc02033ca:	fe07b023          	sd	zero,-32(a5)
    while (1) {
ffffffffc02033ce:	87ba                	mv	a5,a4
ffffffffc02033d0:	6798                	ld	a4,8(a5)
        if(curr_ptr == head)
ffffffffc02033d2:	fef519e3          	bne	a0,a5,ffffffffc02033c4 <_clock_swap_out_victim+0x18>
            if(curr_ptr == head)
ffffffffc02033d6:	02a70263          	beq	a4,a0,ffffffffc02033fa <_clock_swap_out_victim+0x4e>
    __list_del(listelm->prev, listelm->next);
ffffffffc02033da:	87ba                	mv	a5,a4
        if(page->visited == 0)
ffffffffc02033dc:	fe07b683          	ld	a3,-32(a5)
ffffffffc02033e0:	6718                	ld	a4,8(a4)
ffffffffc02033e2:	f6e5                	bnez	a3,ffffffffc02033ca <_clock_swap_out_victim+0x1e>
ffffffffc02033e4:	6394                	ld	a3,0(a5)
ffffffffc02033e6:	e21c                	sd	a5,0(a2)
        struct Page* page = le2page(curr_ptr, pra_page_link);
ffffffffc02033e8:	fd078793          	addi	a5,a5,-48
            *ptr_page = page;
ffffffffc02033ec:	e19c                	sd	a5,0(a1)
}
ffffffffc02033ee:	60a2                	ld	ra,8(sp)
    prev->next = next;
...
ffffffffc02033fc:	e208                	sd	a0,0(a2)
                *ptr_page = NULL;
ffffffffc02033fe:	0005b023          	sd	zero,0(a1) # 1000 <kern_entry-0xffffffffc01ff000>
}
...
ffffffffc020340c:	79068693          	addi	a3,a3,1936 # ffffffffc0205b98 <default_pmm_manager+0xa90>
ffffffffc0203410:	00002617          	auipc	a2,0x2
ffffffffc0203414:	94860613          	addi	a2,a2,-1720 # ffffffffc0204d58 <commands+0x738>
ffffffffc0203418:	04a00593          	li	a1,74
ffffffffc020341c:	00002517          	auipc	a0,0x2
ffffffffc0203420:	70c50513          	addi	a0,a0,1804 # ffffffffc0205b28 <default_pmm_manager+0xa20>
ffffffffc0203424:	f51fc0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(head != NULL);
ffffffffc0203428:	00002697          	auipc	a3,0x2
ffffffffc020342c:	76068693          	addi	a3,a3,1888 # ffffffffc0205b88 <default_pmm_manager+0xa80>
ffffffffc0203430:	00002617          	auipc	a2,0x2
ffffffffc0203434:	92860613          	addi	a2,a2,-1752 # ffffffffc0204d58 <commands+0x738>
ffffffffc0203438:	04900593          	li	a1,73
ffffffffc020343c:	00002517          	auipc	a0,0x2
ffffffffc0203440:	6ec50513          	addi	a0,a0,1772 # ffffffffc0205b28 <default_pmm_manager+0xa20>
ffffffffc0203444:	f31fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203448 <_clock_map_swappable>:
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc0203448:	0000e797          	auipc	a5,0xe
ffffffffc020344c:	1107b783          	ld	a5,272(a5) # ffffffffc0211558 <curr_ptr>
ffffffffc0203450:	cf89                	beqz	a5,ffffffffc020346a <_clock_map_swappable+0x22>
    list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc0203452:	751c                	ld	a5,40(a0)
ffffffffc0203454:	03060713          	addi	a4,a2,48
}
ffffffffc0203458:	4501                	li	a0,0
    __list_add(elm, listelm->prev, listelm);
ffffffffc020345a:	6394                	ld	a3,0(a5)
    prev->next = next->prev = elm;
ffffffffc020345c:	e398                	sd	a4,0(a5)
ffffffffc020345e:	e698                	sd	a4,8(a3)
    elm->next = next;
ffffffffc0203460:	fe1c                	sd	a5,56(a2)
    page->visited = 1;
ffffffffc0203462:	4785                	li	a5,1
    elm->prev = prev;
ffffffffc0203464:	fa14                	sd	a3,48(a2)
...
ffffffffc0203470:	73c68693          	addi	a3,a3,1852 # ffffffffc0205ba8 <default_pmm_manager+0xaa0>
...
ffffffffc0203494:	75868693          	addi	a3,a3,1880 # ffffffffc0205be8 <default_pmm_manager+0xae0>
...
ffffffffc02034a8:	76450513          	addi	a0,a0,1892 # ffffffffc0205c08 <default_pmm_manager+0xb00>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc02034ba:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02034bc:	abcff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
...
ffffffffc02034ea:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02034ec:	a99ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
}
...
ffffffffc020350c:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020350e:	a6aff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL) {
...
ffffffffc02035dc:	64068693          	addi	a3,a3,1600 # ffffffffc0205c18 <default_pmm_manager+0xb10>
...
ffffffffc02035f0:	61c50513          	addi	a0,a0,1564 # ffffffffc0205c08 <default_pmm_manager+0xb00>
ffffffffc02035f4:	d81fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035f8:	00002697          	auipc	a3,0x2
ffffffffc02035fc:	66068693          	addi	a3,a3,1632 # ffffffffc0205c58 <default_pmm_manager+0xb50>
...
ffffffffc0203610:	5fc50513          	addi	a0,a0,1532 # ffffffffc0205c08 <default_pmm_manager+0xb00>
ffffffffc0203614:	d61fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203618:	00002697          	auipc	a3,0x2
ffffffffc020361c:	62068693          	addi	a3,a3,1568 # ffffffffc0205c38 <default_pmm_manager+0xb30>
...
ffffffffc0203630:	5dc50513          	addi	a0,a0,1500 # ffffffffc0205c08 <default_pmm_manager+0xb00>
...
ffffffffc0203654:	9deff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
...
ffffffffc0203668:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020366a:	9c8ff06f          	j	ffffffffc0202832 <kfree>
...
ffffffffc0203682:	810fe0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
...
check_vma_struct(void) {
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc0203688:	80afe0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
...
ffffffffc02036d6:	8a2ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
...
ffffffffc02036fa:	51250513          	addi	a0,a0,1298 # ffffffffc0205c08 <default_pmm_manager+0xb00>
ffffffffc02036fe:	c77fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203702:	883ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
...
ffffffffc020374e:	4be50513          	addi	a0,a0,1214 # ffffffffc0205c08 <default_pmm_manager+0xb00>
...
ffffffffc020380e:	56e50513          	addi	a0,a0,1390 # ffffffffc0205d78 <default_pmm_manager+0xc70>
ffffffffc0203812:	8a9fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203816:	00002697          	auipc	a3,0x2
ffffffffc020381a:	58a68693          	addi	a3,a3,1418 # ffffffffc0205da0 <default_pmm_manager+0xc98>
...
ffffffffc020382e:	3de50513          	addi	a0,a0,990 # ffffffffc0205c08 <default_pmm_manager+0xb00>
ffffffffc0203832:	b43fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
...
ffffffffc0203860:	e33fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203864:	3caa1163          	bne	s4,a0,ffffffffc0203c26 <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc0203868:	00002517          	auipc	a0,0x2
ffffffffc020386c:	57850513          	addi	a0,a0,1400 # ffffffffc0205de0 <default_pmm_manager+0xcd8>
ffffffffc0203870:	84bfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
...
ffffffffc02038c8:	eb1fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
...
ffffffffc020392e:	feffd0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
...
ffffffffc020394a:	86273703          	ld	a4,-1950(a4) # ffffffffc02061a8 <nbase>
...
ffffffffc0203964:	ceffd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
...
ffffffffc02039ae:	48650513          	addi	a0,a0,1158 # ffffffffc0205e30 <default_pmm_manager+0xd28>
ffffffffc02039b2:	f08fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039b6:	cddfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
...
ffffffffc02039d6:	47e50513          	addi	a0,a0,1150 # ffffffffc0205e50 <default_pmm_manager+0xd48>
}
ffffffffc02039da:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc02039dc:	edefc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02039e0:	da4ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc02039e4:	b5d1                	j	ffffffffc02038a8 <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc02039e6:	00002697          	auipc	a3,0x2
ffffffffc02039ea:	2aa68693          	addi	a3,a3,682 # ffffffffc0205c90 <default_pmm_manager+0xb88>
...
ffffffffc02039fe:	20e50513          	addi	a0,a0,526 # ffffffffc0205c08 <default_pmm_manager+0xb00>
ffffffffc0203a02:	973fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203a06:	00002697          	auipc	a3,0x2
ffffffffc0203a0a:	34268693          	addi	a3,a3,834 # ffffffffc0205d48 <default_pmm_manager+0xc40>
...
ffffffffc0203a1e:	1ee50513          	addi	a0,a0,494 # ffffffffc0205c08 <default_pmm_manager+0xb00>
ffffffffc0203a22:	953fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203a26:	00002697          	auipc	a3,0x2
ffffffffc0203a2a:	2f268693          	addi	a3,a3,754 # ffffffffc0205d18 <default_pmm_manager+0xc10>
...
ffffffffc0203a3e:	1ce50513          	addi	a0,a0,462 # ffffffffc0205c08 <default_pmm_manager+0xb00>
ffffffffc0203a42:	933fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203a46:	00002697          	auipc	a3,0x2
ffffffffc0203a4a:	23268693          	addi	a3,a3,562 # ffffffffc0205c78 <default_pmm_manager+0xb70>
...
ffffffffc0203a5e:	1ae50513          	addi	a0,a0,430 # ffffffffc0205c08 <default_pmm_manager+0xb00>
ffffffffc0203a62:	913fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203a66:	00002697          	auipc	a3,0x2
ffffffffc0203a6a:	26268693          	addi	a3,a3,610 # ffffffffc0205cc8 <default_pmm_manager+0xbc0>
...
ffffffffc0203a7e:	18e50513          	addi	a0,a0,398 # ffffffffc0205c08 <default_pmm_manager+0xb00>
ffffffffc0203a82:	8f3fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203a86:	00002697          	auipc	a3,0x2
ffffffffc0203a8a:	25268693          	addi	a3,a3,594 # ffffffffc0205cd8 <default_pmm_manager+0xbd0>
...
ffffffffc0203a9e:	16e50513          	addi	a0,a0,366 # ffffffffc0205c08 <default_pmm_manager+0xb00>
ffffffffc0203aa2:	8d3fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203aa6:	00002697          	auipc	a3,0x2
ffffffffc0203aaa:	24268693          	addi	a3,a3,578 # ffffffffc0205ce8 <default_pmm_manager+0xbe0>
...
ffffffffc0203abe:	14e50513          	addi	a0,a0,334 # ffffffffc0205c08 <default_pmm_manager+0xb00>
ffffffffc0203ac2:	8b3fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203ac6:	00002697          	auipc	a3,0x2
ffffffffc0203aca:	23268693          	addi	a3,a3,562 # ffffffffc0205cf8 <default_pmm_manager+0xbf0>
...
ffffffffc0203ade:	12e50513          	addi	a0,a0,302 # ffffffffc0205c08 <default_pmm_manager+0xb00>
ffffffffc0203ae2:	893fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203ae6:	00002697          	auipc	a3,0x2
ffffffffc0203aea:	22268693          	addi	a3,a3,546 # ffffffffc0205d08 <default_pmm_manager+0xc00>
...
ffffffffc0203afe:	10e50513          	addi	a0,a0,270 # ffffffffc0205c08 <default_pmm_manager+0xb00>
...
ffffffffc0203b1e:	0ee50513          	addi	a0,a0,238 # ffffffffc0205c08 <default_pmm_manager+0xb00>
ffffffffc0203b22:	853fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203b26:	00002697          	auipc	a3,0x2
ffffffffc0203b2a:	34268693          	addi	a3,a3,834 # ffffffffc0205e68 <default_pmm_manager+0xd60>
...
ffffffffc0203b3e:	0ce50513          	addi	a0,a0,206 # ffffffffc0205c08 <default_pmm_manager+0xb00>
    check_mm_struct = mm_create();
...
ffffffffc0203b66:	0a650513          	addi	a0,a0,166 # ffffffffc0205c08 <default_pmm_manager+0xb00>
ffffffffc0203b6a:	80bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203b6e:	00002697          	auipc	a3,0x2
ffffffffc0203b72:	29268693          	addi	a3,a3,658 # ffffffffc0205e00 <default_pmm_manager+0xcf8>
...
ffffffffc0203b86:	08650513          	addi	a0,a0,134 # ffffffffc0205c08 <default_pmm_manager+0xb00>
ffffffffc0203b8a:	feafc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203b8e:	00002697          	auipc	a3,0x2
ffffffffc0203b92:	29268693          	addi	a3,a3,658 # ffffffffc0205e20 <default_pmm_manager+0xd18>
...
ffffffffc0203ba6:	06650513          	addi	a0,a0,102 # ffffffffc0205c08 <default_pmm_manager+0xb00>
...
ffffffffc0203bca:	1f268693          	addi	a3,a3,498 # ffffffffc0205db8 <default_pmm_manager+0xcb0>
...
ffffffffc0203bde:	02e50513          	addi	a0,a0,46 # ffffffffc0205c08 <default_pmm_manager+0xb00>
ffffffffc0203be2:	f92fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203be6:	00002697          	auipc	a3,0x2
ffffffffc0203bea:	1d268693          	addi	a3,a3,466 # ffffffffc0205db8 <default_pmm_manager+0xcb0>
...
ffffffffc0203bfe:	00e50513          	addi	a0,a0,14 # ffffffffc0205c08 <default_pmm_manager+0xb00>
...
ffffffffc0203c1e:	fee50513          	addi	a0,a0,-18 # ffffffffc0205c08 <default_pmm_manager+0xb00>
ffffffffc0203c22:	f52fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c26:	00002697          	auipc	a3,0x2
ffffffffc0203c2a:	19268693          	addi	a3,a3,402 # ffffffffc0205db8 <default_pmm_manager+0xcb0>
...
ffffffffc0203c3e:	fce50513          	addi	a0,a0,-50 # ffffffffc0205c08 <default_pmm_manager+0xb00>
...
ffffffffc0203cac:	d0bfd0ef          	jal	ra,ffffffffc02019b6 <page_insert>
...
ffffffffc0203cb8:	ad8ff0ef          	jal	ra,ffffffffc0202f90 <swap_map_swappable>
            page->pra_vaddr = addr;
...
ffffffffc0203cd8:	9e9fe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
...
ffffffffc0203ce6:	1ce50513          	addi	a0,a0,462 # ffffffffc0205eb0 <default_pmm_manager+0xda8>
...
ffffffffc0203cf8:	18c50513          	addi	a0,a0,396 # ffffffffc0205e80 <default_pmm_manager+0xd78>
...
ffffffffc0203d08:	1d450513          	addi	a0,a0,468 # ffffffffc0205ed8 <default_pmm_manager+0xdd0>
ffffffffc0203d0c:	baefc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
...
ffffffffc0203d3a:	1ca60613          	addi	a2,a2,458 # ffffffffc0205f00 <default_pmm_manager+0xdf8>
ffffffffc0203d3e:	45b5                	li	a1,13
ffffffffc0203d40:	00002517          	auipc	a0,0x2
ffffffffc0203d44:	1e050513          	addi	a0,a0,480 # ffffffffc0205f20 <default_pmm_manager+0xe18>
...
ffffffffc0203d74:	4305b583          	ld	a1,1072(a1) # ffffffffc02061a0 <error_string+0x38>
ffffffffc0203d78:	02b60633          	mul	a2,a2,a1
ffffffffc0203d7c:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203d80:	00002797          	auipc	a5,0x2
ffffffffc0203d84:	4287b783          	ld	a5,1064(a5) # ffffffffc02061a8 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
...
ffffffffc0203dba:	18260613          	addi	a2,a2,386 # ffffffffc0205f38 <default_pmm_manager+0xe30>
ffffffffc0203dbe:	45d1                	li	a1,20
ffffffffc0203dc0:	00002517          	auipc	a0,0x2
ffffffffc0203dc4:	16050513          	addi	a0,a0,352 # ffffffffc0205f20 <default_pmm_manager+0xe18>
...
ffffffffc0203e0e:	3965b583          	ld	a1,918(a1) # ffffffffc02061a0 <error_string+0x38>
ffffffffc0203e12:	02b60633          	mul	a2,a2,a1
ffffffffc0203e16:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e1a:	00002797          	auipc	a5,0x2
ffffffffc0203e1e:	38e7b783          	ld	a5,910(a5) # ffffffffc02061a8 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
...
ffffffffc0203e54:	0e860613          	addi	a2,a2,232 # ffffffffc0205f38 <default_pmm_manager+0xe30>
ffffffffc0203e58:	45e5                	li	a1,25
ffffffffc0203e5a:	00002517          	auipc	a0,0x2
ffffffffc0203e5e:	0c650513          	addi	a0,a0,198 # ffffffffc0205f20 <default_pmm_manager+0xe18>
...
ffffffffc0203ebe:	09e78793          	addi	a5,a5,158 # ffffffffc0205f58 <default_pmm_manager+0xe50>
...
ffffffffc0203f1a:	076a8a93          	addi	s5,s5,118 # ffffffffc0205f8c <default_pmm_manager+0xe84>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203f22:	24ab8b93          	addi	s7,s7,586 # ffffffffc0206168 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
...
ffffffffc0204178:	e1460613          	addi	a2,a2,-492 # ffffffffc0205f88 <default_pmm_manager+0xe80>
...
ffffffffc020418a:	df260613          	addi	a2,a2,-526 # ffffffffc0205f78 <default_pmm_manager+0xe70>
...
ffffffffc020419c:	dd840413          	addi	s0,s0,-552 # ffffffffc0205f70 <default_pmm_manager+0xe68>
...
ffffffffc0204226:	d4e40413          	addi	s0,s0,-690 # ffffffffc0205f70 <default_pmm_manager+0xe68>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
ffffffffc020423c:	d39a0a13          	addi	s4,s4,-711 # ffffffffc0205f71 <default_pmm_manager+0xe69>
...
ffffffffc0204288:	d0450513          	addi	a0,a0,-764 # ffffffffc0205f88 <default_pmm_manager+0xe80>
ffffffffc020428c:	e2ffb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
...
ffffffffc02042a2:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc02042a6:	e4dfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
...
ffffffffc02042b2:	029a5263          	bge	s4,s1,ffffffffc02042d6 <readline+0x68>
        c = getchar();
ffffffffc02042b6:	e3dfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
...
ffffffffc02042c6:	e8a9                	bnez	s1,ffffffffc0204318 <readline+0xaa>
        c = getchar();
ffffffffc02042c8:	e2bfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
...
ffffffffc02042d8:	e19fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i ++] = c;
...
ffffffffc02042ee:	fb651ce3          	bne	a0,s6,ffffffffc02042a6 <readline+0x38>
            cputchar(c);
ffffffffc02042f2:	dfffb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
