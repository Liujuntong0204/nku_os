...
ffffffffc02000b0:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000b2:	68f030ef          	jal	ra,ffffffffc0203f40 <vprintfmt>
    return cnt;
}
...
ffffffffc02000e6:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e8:	659030ef          	jal	ra,ffffffffc0203f40 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc020010c:	34050513          	addi	a0,a0,832 # ffffffffc0204448 <etext+0x2c>
void print_kerninfo(void) {
...
ffffffffc0200122:	34a50513          	addi	a0,a0,842 # ffffffffc0204468 <etext+0x4c>
ffffffffc0200126:	f99ff0ef          	jal	ra,ffffffffc02000be <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc020012a:	00004597          	auipc	a1,0x4
ffffffffc020012e:	2f258593          	addi	a1,a1,754 # ffffffffc020441c <etext>
ffffffffc0200132:	00004517          	auipc	a0,0x4
ffffffffc0200136:	35650513          	addi	a0,a0,854 # ffffffffc0204488 <etext+0x6c>
...
ffffffffc020014a:	36250513          	addi	a0,a0,866 # ffffffffc02044a8 <etext+0x8c>
ffffffffc020014e:	f71ff0ef          	jal	ra,ffffffffc02000be <cprintf>
    cprintf("  end    0x%08x (virtual)\n", end);
ffffffffc0200152:	00011597          	auipc	a1,0x11
ffffffffc0200156:	41a58593          	addi	a1,a1,1050 # ffffffffc021156c <end>
ffffffffc020015a:	00004517          	auipc	a0,0x4
ffffffffc020015e:	36e50513          	addi	a0,a0,878 # ffffffffc02044c8 <etext+0xac>
ffffffffc0200162:	f5dff0ef          	jal	ra,ffffffffc02000be <cprintf>
    cprintf("Kernel executable memory footprint: %dKB\n",
            (end - kern_init + 1023) / 1024);
ffffffffc0200166:	00012597          	auipc	a1,0x12
ffffffffc020016a:	80558593          	addi	a1,a1,-2043 # ffffffffc021196b <end+0x3ff>
...
ffffffffc020018c:	36050513          	addi	a0,a0,864 # ffffffffc02044e8 <etext+0xcc>
}
...
ffffffffc020019a:	38260613          	addi	a2,a2,898 # ffffffffc0204518 <etext+0xfc>
ffffffffc020019e:	04e00593          	li	a1,78
ffffffffc02001a2:	00004517          	auipc	a0,0x4
ffffffffc02001a6:	38e50513          	addi	a0,a0,910 # ffffffffc0204530 <etext+0x114>
void print_stackframe(void) {
...
ffffffffc02001b6:	39660613          	addi	a2,a2,918 # ffffffffc0204548 <etext+0x12c>
ffffffffc02001ba:	00004597          	auipc	a1,0x4
ffffffffc02001be:	3ae58593          	addi	a1,a1,942 # ffffffffc0204568 <etext+0x14c>
ffffffffc02001c2:	00004517          	auipc	a0,0x4
ffffffffc02001c6:	3ae50513          	addi	a0,a0,942 # ffffffffc0204570 <etext+0x154>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d4:	3b060613          	addi	a2,a2,944 # ffffffffc0204580 <etext+0x164>
ffffffffc02001d8:	00004597          	auipc	a1,0x4
ffffffffc02001dc:	3d058593          	addi	a1,a1,976 # ffffffffc02045a8 <etext+0x18c>
ffffffffc02001e0:	00004517          	auipc	a0,0x4
ffffffffc02001e4:	39050513          	addi	a0,a0,912 # ffffffffc0204570 <etext+0x154>
ffffffffc02001e8:	ed7ff0ef          	jal	ra,ffffffffc02000be <cprintf>
ffffffffc02001ec:	00004617          	auipc	a2,0x4
ffffffffc02001f0:	3cc60613          	addi	a2,a2,972 # ffffffffc02045b8 <etext+0x19c>
ffffffffc02001f4:	00004597          	auipc	a1,0x4
ffffffffc02001f8:	3e458593          	addi	a1,a1,996 # ffffffffc02045d8 <etext+0x1bc>
ffffffffc02001fc:	00004517          	auipc	a0,0x4
ffffffffc0200200:	37450513          	addi	a0,a0,884 # ffffffffc0204570 <etext+0x154>
...
ffffffffc020023a:	3b250513          	addi	a0,a0,946 # ffffffffc02045e8 <etext+0x1cc>
kmonitor(struct trapframe *tf) {
...
ffffffffc020025c:	3b850513          	addi	a0,a0,952 # ffffffffc0204610 <etext+0x1f4>
...
ffffffffc0200272:	40ac0c13          	addi	s8,s8,1034 # ffffffffc0204678 <commands>
        if ((buf = readline("")) != NULL) {
ffffffffc0200276:	00006917          	auipc	s2,0x6
ffffffffc020027a:	81290913          	addi	s2,s2,-2030 # ffffffffc0205a88 <default_pmm_manager+0x928>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020027e:	00004497          	auipc	s1,0x4
ffffffffc0200282:	3ba48493          	addi	s1,s1,954 # ffffffffc0204638 <etext+0x21c>
        if (argc == MAXARGS - 1) {
ffffffffc0200286:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200288:	00004b17          	auipc	s6,0x4
ffffffffc020028c:	3b8b0b13          	addi	s6,s6,952 # ffffffffc0204640 <etext+0x224>
        argv[argc ++] = buf;
ffffffffc0200290:	00004a17          	auipc	s4,0x4
ffffffffc0200294:	2d8a0a13          	addi	s4,s4,728 # ffffffffc0204568 <etext+0x14c>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200298:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc020029a:	854a                	mv	a0,s2
ffffffffc020029c:	026040ef          	jal	ra,ffffffffc02042c2 <readline>
...
ffffffffc02002b6:	3c6d0d13          	addi	s10,s10,966 # ffffffffc0204678 <commands>
        argv[argc ++] = buf;
...
ffffffffc02002be:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002c0:	0fe040ef          	jal	ra,ffffffffc02043be <strcmp>
...
ffffffffc02002d2:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d4:	0ea040ef          	jal	ra,ffffffffc02043be <strcmp>
...
ffffffffc0200312:	0ca040ef          	jal	ra,ffffffffc02043dc <strchr>
...
ffffffffc0200350:	08c040ef          	jal	ra,ffffffffc02043dc <strchr>
...
ffffffffc020036e:	2f650513          	addi	a0,a0,758 # ffffffffc0204660 <etext+0x244>
...
ffffffffc02003aa:	31a50513          	addi	a0,a0,794 # ffffffffc02046c0 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02003c0:	21c50513          	addi	a0,a0,540 # ffffffffc02055d8 <default_pmm_manager+0x478>
...
ffffffffc02003fe:	2e650513          	addi	a0,a0,742 # ffffffffc02046e0 <commands+0x68>
    ticks = 0;
...
ffffffffc020042c:	0ff57513          	zext.b	a0,a0
...
ffffffffc02004ba:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004bc:	749030ef          	jal	ra,ffffffffc0204404 <memcpy>
    return 0;
}
...
ffffffffc02004de:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004e0:	725030ef          	jal	ra,ffffffffc0204404 <memcpy>
    return 0;
}
...
ffffffffc020052c:	1d850513          	addi	a0,a0,472 # ffffffffc0204700 <commands+0x88>
ffffffffc0200530:	b8fff0ef          	jal	ra,ffffffffc02000be <cprintf>
    extern struct mm_struct *check_mm_struct;
    print_pgfault(tf);
    if (check_mm_struct != NULL) {
ffffffffc0200534:	00011517          	auipc	a0,0x11
ffffffffc0200538:	02c53503          	ld	a0,44(a0) # ffffffffc0211560 <check_mm_struct>
...
ffffffffc020054a:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc020054c:	74e0306f          	j	ffffffffc0203c9a <do_pgfault>
    panic("unhandled page fault.\n");
ffffffffc0200550:	00004617          	auipc	a2,0x4
ffffffffc0200554:	1d060613          	addi	a2,a2,464 # ffffffffc0204720 <commands+0xa8>
ffffffffc0200558:	07800593          	li	a1,120
ffffffffc020055c:	00004517          	auipc	a0,0x4
ffffffffc0200560:	1dc50513          	addi	a0,a0,476 # ffffffffc0204738 <commands+0xc0>
...
ffffffffc0200570:	48478793          	addi	a5,a5,1156 # ffffffffc02009f0 <__alltraps>
...
ffffffffc0200592:	1c250513          	addi	a0,a0,450 # ffffffffc0204750 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc02005a2:	1ca50513          	addi	a0,a0,458 # ffffffffc0204768 <commands+0xf0>
...
ffffffffc02005b0:	1d450513          	addi	a0,a0,468 # ffffffffc0204780 <commands+0x108>
...
ffffffffc02005be:	1de50513          	addi	a0,a0,478 # ffffffffc0204798 <commands+0x120>
...
ffffffffc02005cc:	1e850513          	addi	a0,a0,488 # ffffffffc02047b0 <commands+0x138>
...
ffffffffc02005da:	1f250513          	addi	a0,a0,498 # ffffffffc02047c8 <commands+0x150>
...
ffffffffc02005e8:	1fc50513          	addi	a0,a0,508 # ffffffffc02047e0 <commands+0x168>
...
ffffffffc02005f6:	20650513          	addi	a0,a0,518 # ffffffffc02047f8 <commands+0x180>
...
ffffffffc0200604:	21050513          	addi	a0,a0,528 # ffffffffc0204810 <commands+0x198>
...
ffffffffc0200612:	21a50513          	addi	a0,a0,538 # ffffffffc0204828 <commands+0x1b0>
...
ffffffffc0200620:	22450513          	addi	a0,a0,548 # ffffffffc0204840 <commands+0x1c8>
...
ffffffffc020062e:	22e50513          	addi	a0,a0,558 # ffffffffc0204858 <commands+0x1e0>
...
ffffffffc020063c:	23850513          	addi	a0,a0,568 # ffffffffc0204870 <commands+0x1f8>
...
ffffffffc020064a:	24250513          	addi	a0,a0,578 # ffffffffc0204888 <commands+0x210>
...
ffffffffc0200658:	24c50513          	addi	a0,a0,588 # ffffffffc02048a0 <commands+0x228>
...
ffffffffc0200666:	25650513          	addi	a0,a0,598 # ffffffffc02048b8 <commands+0x240>
...
ffffffffc0200674:	26050513          	addi	a0,a0,608 # ffffffffc02048d0 <commands+0x258>
...
ffffffffc0200682:	26a50513          	addi	a0,a0,618 # ffffffffc02048e8 <commands+0x270>
...
ffffffffc0200690:	27450513          	addi	a0,a0,628 # ffffffffc0204900 <commands+0x288>
...
ffffffffc020069e:	27e50513          	addi	a0,a0,638 # ffffffffc0204918 <commands+0x2a0>
...
ffffffffc02006ac:	28850513          	addi	a0,a0,648 # ffffffffc0204930 <commands+0x2b8>
...
ffffffffc02006ba:	29250513          	addi	a0,a0,658 # ffffffffc0204948 <commands+0x2d0>
...
ffffffffc02006c8:	29c50513          	addi	a0,a0,668 # ffffffffc0204960 <commands+0x2e8>
...
ffffffffc02006d6:	2a650513          	addi	a0,a0,678 # ffffffffc0204978 <commands+0x300>
...
ffffffffc02006e4:	2b050513          	addi	a0,a0,688 # ffffffffc0204990 <commands+0x318>
...
ffffffffc02006f2:	2ba50513          	addi	a0,a0,698 # ffffffffc02049a8 <commands+0x330>
...
ffffffffc0200700:	2c450513          	addi	a0,a0,708 # ffffffffc02049c0 <commands+0x348>
...
ffffffffc020070e:	2ce50513          	addi	a0,a0,718 # ffffffffc02049d8 <commands+0x360>
...
ffffffffc020071c:	2d850513          	addi	a0,a0,728 # ffffffffc02049f0 <commands+0x378>
...
ffffffffc020072a:	2e250513          	addi	a0,a0,738 # ffffffffc0204a08 <commands+0x390>
...
ffffffffc0200738:	2ec50513          	addi	a0,a0,748 # ffffffffc0204a20 <commands+0x3a8>
...
ffffffffc020074a:	2f250513          	addi	a0,a0,754 # ffffffffc0204a38 <commands+0x3c0>
}
...
ffffffffc020075e:	2f650513          	addi	a0,a0,758 # ffffffffc0204a50 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200776:	2f650513          	addi	a0,a0,758 # ffffffffc0204a68 <commands+0x3f0>
...
ffffffffc0200786:	2fe50513          	addi	a0,a0,766 # ffffffffc0204a80 <commands+0x408>
...
ffffffffc0200796:	30650513          	addi	a0,a0,774 # ffffffffc0204a98 <commands+0x420>
...
ffffffffc02007aa:	30a50513          	addi	a0,a0,778 # ffffffffc0204ab0 <commands+0x438>
}
...
ffffffffc02007be:	06f76c63          	bltu	a4,a5,ffffffffc0200836 <interrupt_handler+0x82>
ffffffffc02007c2:	00004717          	auipc	a4,0x4
ffffffffc02007c6:	3b670713          	addi	a4,a4,950 # ffffffffc0204b78 <commands+0x500>
...
ffffffffc02007d8:	35450513          	addi	a0,a0,852 # ffffffffc0204b28 <commands+0x4b0>
ffffffffc02007dc:	8e3ff06f          	j	ffffffffc02000be <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02007e0:	00004517          	auipc	a0,0x4
ffffffffc02007e4:	32850513          	addi	a0,a0,808 # ffffffffc0204b08 <commands+0x490>
ffffffffc02007e8:	8d7ff06f          	j	ffffffffc02000be <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02007ec:	00004517          	auipc	a0,0x4
ffffffffc02007f0:	2dc50513          	addi	a0,a0,732 # ffffffffc0204ac8 <commands+0x450>
ffffffffc02007f4:	8cbff06f          	j	ffffffffc02000be <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02007f8:	00004517          	auipc	a0,0x4
ffffffffc02007fc:	2f050513          	addi	a0,a0,752 # ffffffffc0204ae8 <commands+0x470>
...
ffffffffc0200808:	c05ff0ef          	jal	ra,ffffffffc020040c <clock_set_next_event>
            if (++ticks % TICK_NUM == 0) {
ffffffffc020080c:	00011697          	auipc	a3,0x11
ffffffffc0200810:	cf468693          	addi	a3,a3,-780 # ffffffffc0211500 <ticks>
ffffffffc0200814:	629c                	ld	a5,0(a3)
ffffffffc0200816:	06400713          	li	a4,100
ffffffffc020081a:	0785                	addi	a5,a5,1
ffffffffc020081c:	02e7f733          	remu	a4,a5,a4
ffffffffc0200820:	e29c                	sd	a5,0(a3)
ffffffffc0200822:	cb19                	beqz	a4,ffffffffc0200838 <interrupt_handler+0x84>
            break;
        default:
            print_trapframe(tf);
            break;
...
ffffffffc0200826:	0141                	addi	sp,sp,16
ffffffffc0200828:	8082                	ret
            cprintf("Supervisor external interrupt\n");
ffffffffc020082a:	00004517          	auipc	a0,0x4
ffffffffc020082e:	32e50513          	addi	a0,a0,814 # ffffffffc0204b58 <commands+0x4e0>
ffffffffc0200832:	88dff06f          	j	ffffffffc02000be <cprintf>
            print_trapframe(tf);
ffffffffc0200836:	bf31                	j	ffffffffc0200752 <print_trapframe>
}
ffffffffc0200838:	60a2                	ld	ra,8(sp)
    cprintf("%d ticks\n", TICK_NUM);
ffffffffc020083a:	06400593          	li	a1,100
ffffffffc020083e:	00004517          	auipc	a0,0x4
ffffffffc0200842:	30a50513          	addi	a0,a0,778 # ffffffffc0204b48 <commands+0x4d0>
}
ffffffffc0200846:	0141                	addi	sp,sp,16
    cprintf("%d ticks\n", TICK_NUM);
ffffffffc0200848:	877ff06f          	j	ffffffffc02000be <cprintf>

ffffffffc020084c <exception_handler>:


void exception_handler(struct trapframe *tf) {
    int ret;
    switch (tf->cause) {
ffffffffc020084c:	11853783          	ld	a5,280(a0)
void exception_handler(struct trapframe *tf) {
ffffffffc0200850:	1101                	addi	sp,sp,-32
ffffffffc0200852:	e822                	sd	s0,16(sp)
ffffffffc0200854:	ec06                	sd	ra,24(sp)
ffffffffc0200856:	e426                	sd	s1,8(sp)
ffffffffc0200858:	473d                	li	a4,15
ffffffffc020085a:	842a                	mv	s0,a0
ffffffffc020085c:	14f76a63          	bltu	a4,a5,ffffffffc02009b0 <exception_handler+0x164>
ffffffffc0200860:	00004717          	auipc	a4,0x4
ffffffffc0200864:	50070713          	addi	a4,a4,1280 # ffffffffc0204d60 <commands+0x6e8>
...
ffffffffc0200876:	4d650513          	addi	a0,a0,1238 # ffffffffc0204d48 <commands+0x6d0>
ffffffffc020087a:	845ff0ef          	jal	ra,ffffffffc02000be <cprintf>
            if ((ret = pgfault_handler(tf)) != 0) {
ffffffffc020087e:	8522                	mv	a0,s0
ffffffffc0200880:	c79ff0ef          	jal	ra,ffffffffc02004f8 <pgfault_handler>
ffffffffc0200884:	84aa                	mv	s1,a0
ffffffffc0200886:	12051b63          	bnez	a0,ffffffffc02009bc <exception_handler+0x170>
            break;
        default:
            print_trapframe(tf);
            break;
...
ffffffffc020088c:	6442                	ld	s0,16(sp)
...
ffffffffc0200898:	31450513          	addi	a0,a0,788 # ffffffffc0204ba8 <commands+0x530>
}
...
ffffffffc02008a4:	81bff06f          	j	ffffffffc02000be <cprintf>
ffffffffc02008a8:	00004517          	auipc	a0,0x4
ffffffffc02008ac:	32050513          	addi	a0,a0,800 # ffffffffc0204bc8 <commands+0x550>
ffffffffc02008b0:	b7f5                	j	ffffffffc020089c <exception_handler+0x50>
            cprintf("Illegal instruction\n");
ffffffffc02008b2:	00004517          	auipc	a0,0x4
ffffffffc02008b6:	33650513          	addi	a0,a0,822 # ffffffffc0204be8 <commands+0x570>
ffffffffc02008ba:	b7cd                	j	ffffffffc020089c <exception_handler+0x50>
            cprintf("Breakpoint\n");
ffffffffc02008bc:	00004517          	auipc	a0,0x4
ffffffffc02008c0:	34450513          	addi	a0,a0,836 # ffffffffc0204c00 <commands+0x588>
ffffffffc02008c4:	bfe1                	j	ffffffffc020089c <exception_handler+0x50>
            cprintf("Load address misaligned\n");
ffffffffc02008c6:	00004517          	auipc	a0,0x4
ffffffffc02008ca:	34a50513          	addi	a0,a0,842 # ffffffffc0204c10 <commands+0x598>
ffffffffc02008ce:	b7f9                	j	ffffffffc020089c <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc02008d0:	00004517          	auipc	a0,0x4
ffffffffc02008d4:	36050513          	addi	a0,a0,864 # ffffffffc0204c30 <commands+0x5b8>
ffffffffc02008d8:	fe6ff0ef          	jal	ra,ffffffffc02000be <cprintf>
            if ((ret = pgfault_handler(tf)) != 0) {
ffffffffc02008dc:	8522                	mv	a0,s0
ffffffffc02008de:	c1bff0ef          	jal	ra,ffffffffc02004f8 <pgfault_handler>
ffffffffc02008e2:	84aa                	mv	s1,a0
ffffffffc02008e4:	d15d                	beqz	a0,ffffffffc020088a <exception_handler+0x3e>
                print_trapframe(tf);
ffffffffc02008e6:	8522                	mv	a0,s0
ffffffffc02008e8:	e6bff0ef          	jal	ra,ffffffffc0200752 <print_trapframe>
                panic("handle pgfault failed. %e\n", ret);
ffffffffc02008ec:	86a6                	mv	a3,s1
ffffffffc02008ee:	00004617          	auipc	a2,0x4
ffffffffc02008f2:	35a60613          	addi	a2,a2,858 # ffffffffc0204c48 <commands+0x5d0>
ffffffffc02008f6:	0ca00593          	li	a1,202
ffffffffc02008fa:	00004517          	auipc	a0,0x4
ffffffffc02008fe:	e3e50513          	addi	a0,a0,-450 # ffffffffc0204738 <commands+0xc0>
ffffffffc0200902:	a77ff0ef          	jal	ra,ffffffffc0200378 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc0200906:	00004517          	auipc	a0,0x4
ffffffffc020090a:	36250513          	addi	a0,a0,866 # ffffffffc0204c68 <commands+0x5f0>
ffffffffc020090e:	b779                	j	ffffffffc020089c <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc0200910:	00004517          	auipc	a0,0x4
ffffffffc0200914:	37050513          	addi	a0,a0,880 # ffffffffc0204c80 <commands+0x608>
ffffffffc0200918:	fa6ff0ef          	jal	ra,ffffffffc02000be <cprintf>
            if ((ret = pgfault_handler(tf)) != 0) {
ffffffffc020091c:	8522                	mv	a0,s0
ffffffffc020091e:	bdbff0ef          	jal	ra,ffffffffc02004f8 <pgfault_handler>
ffffffffc0200922:	84aa                	mv	s1,a0
ffffffffc0200924:	d13d                	beqz	a0,ffffffffc020088a <exception_handler+0x3e>
                print_trapframe(tf);
ffffffffc0200926:	8522                	mv	a0,s0
ffffffffc0200928:	e2bff0ef          	jal	ra,ffffffffc0200752 <print_trapframe>
                panic("handle pgfault failed. %e\n", ret);
ffffffffc020092c:	86a6                	mv	a3,s1
ffffffffc020092e:	00004617          	auipc	a2,0x4
ffffffffc0200932:	31a60613          	addi	a2,a2,794 # ffffffffc0204c48 <commands+0x5d0>
ffffffffc0200936:	0d400593          	li	a1,212
ffffffffc020093a:	00004517          	auipc	a0,0x4
ffffffffc020093e:	dfe50513          	addi	a0,a0,-514 # ffffffffc0204738 <commands+0xc0>
ffffffffc0200942:	a37ff0ef          	jal	ra,ffffffffc0200378 <__panic>
            cprintf("Environment call from U-mode\n");
ffffffffc0200946:	00004517          	auipc	a0,0x4
ffffffffc020094a:	35250513          	addi	a0,a0,850 # ffffffffc0204c98 <commands+0x620>
ffffffffc020094e:	b7b9                	j	ffffffffc020089c <exception_handler+0x50>
            cprintf("Environment call from S-mode\n");
ffffffffc0200950:	00004517          	auipc	a0,0x4
ffffffffc0200954:	36850513          	addi	a0,a0,872 # ffffffffc0204cb8 <commands+0x640>
ffffffffc0200958:	b791                	j	ffffffffc020089c <exception_handler+0x50>
            cprintf("Environment call from H-mode\n");
ffffffffc020095a:	00004517          	auipc	a0,0x4
ffffffffc020095e:	37e50513          	addi	a0,a0,894 # ffffffffc0204cd8 <commands+0x660>
ffffffffc0200962:	bf2d                	j	ffffffffc020089c <exception_handler+0x50>
            cprintf("Environment call from M-mode\n");
ffffffffc0200964:	00004517          	auipc	a0,0x4
ffffffffc0200968:	39450513          	addi	a0,a0,916 # ffffffffc0204cf8 <commands+0x680>
ffffffffc020096c:	bf05                	j	ffffffffc020089c <exception_handler+0x50>
            cprintf("Instruction page fault\n");
ffffffffc020096e:	00004517          	auipc	a0,0x4
ffffffffc0200972:	3aa50513          	addi	a0,a0,938 # ffffffffc0204d18 <commands+0x6a0>
ffffffffc0200976:	b71d                	j	ffffffffc020089c <exception_handler+0x50>
            cprintf("Load page fault\n");
ffffffffc0200978:	00004517          	auipc	a0,0x4
ffffffffc020097c:	3b850513          	addi	a0,a0,952 # ffffffffc0204d30 <commands+0x6b8>
ffffffffc0200980:	f3eff0ef          	jal	ra,ffffffffc02000be <cprintf>
            if ((ret = pgfault_handler(tf)) != 0) {
ffffffffc0200984:	8522                	mv	a0,s0
ffffffffc0200986:	b73ff0ef          	jal	ra,ffffffffc02004f8 <pgfault_handler>
ffffffffc020098a:	84aa                	mv	s1,a0
ffffffffc020098c:	ee050fe3          	beqz	a0,ffffffffc020088a <exception_handler+0x3e>
                print_trapframe(tf);
ffffffffc0200990:	8522                	mv	a0,s0
ffffffffc0200992:	dc1ff0ef          	jal	ra,ffffffffc0200752 <print_trapframe>
                panic("handle pgfault failed. %e\n", ret);
ffffffffc0200996:	86a6                	mv	a3,s1
ffffffffc0200998:	00004617          	auipc	a2,0x4
ffffffffc020099c:	2b060613          	addi	a2,a2,688 # ffffffffc0204c48 <commands+0x5d0>
ffffffffc02009a0:	0ea00593          	li	a1,234
ffffffffc02009a4:	00004517          	auipc	a0,0x4
ffffffffc02009a8:	d9450513          	addi	a0,a0,-620 # ffffffffc0204738 <commands+0xc0>
ffffffffc02009ac:	9cdff0ef          	jal	ra,ffffffffc0200378 <__panic>
            print_trapframe(tf);
...
ffffffffc02009b8:	6105                	addi	sp,sp,32
            print_trapframe(tf);
ffffffffc02009ba:	bb61                	j	ffffffffc0200752 <print_trapframe>
                print_trapframe(tf);
ffffffffc02009bc:	8522                	mv	a0,s0
ffffffffc02009be:	d95ff0ef          	jal	ra,ffffffffc0200752 <print_trapframe>
                panic("handle pgfault failed. %e\n", ret);
ffffffffc02009c2:	86a6                	mv	a3,s1
ffffffffc02009c4:	00004617          	auipc	a2,0x4
ffffffffc02009c8:	28460613          	addi	a2,a2,644 # ffffffffc0204c48 <commands+0x5d0>
ffffffffc02009cc:	0f100593          	li	a1,241
ffffffffc02009d0:	00004517          	auipc	a0,0x4
ffffffffc02009d4:	d6850513          	addi	a0,a0,-664 # ffffffffc0204738 <commands+0xc0>
ffffffffc02009d8:	9a1ff0ef          	jal	ra,ffffffffc0200378 <__panic>

ffffffffc02009dc <trap>:
...
ffffffffc02009dc:	11853783          	ld	a5,280(a0)
ffffffffc02009e0:	0007c363          	bltz	a5,ffffffffc02009e6 <trap+0xa>
        // interrupts
        interrupt_handler(tf);
    } else {
        // exceptions
        exception_handler(tf);
ffffffffc02009e4:	b5a5                	j	ffffffffc020084c <exception_handler>
        interrupt_handler(tf);
ffffffffc02009e6:	b3f9                	j	ffffffffc02007b4 <interrupt_handler>
	...
...
ffffffffc0200a50:	850a                	mv	a0,sp
    jal trap
ffffffffc0200a52:	f8bff0ef          	jal	ra,ffffffffc02009dc <trap>
...
ffffffffc0200dde:	d9aff0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
...
ffffffffc0200dfe:	d7aff0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
...
ffffffffc0200e1e:	d5aff0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
...
ffffffffc02013b6:	fc3fe0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(n > 0);
...
ffffffffc02013d6:	fa3fe0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc020148e:	e406                	sd	ra,8(sp)
    assert(n > 0);
ffffffffc0201490:	ee9fe0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc0201564:	e15fe0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(n > 0);
...
ffffffffc0201584:	df5fe0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc020159e:	e406                	sd	ra,8(sp)
        panic("pa2page called with invalid pa");
ffffffffc02015a0:	dd9fe0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc02015ba:	e406                	sd	ra,8(sp)
        panic("pte2page called with invalid pte");
ffffffffc02015bc:	dbdfe0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc0201620:	dbf1                	beqz	a5,ffffffffc02015f4 <alloc_pages+0x34>
        intr_disable();
ffffffffc0201622:	ed1fe0ef          	jal	ra,ffffffffc02004f2 <intr_disable>
...
ffffffffc0201630:	842a                	mv	s0,a0
        intr_enable();
ffffffffc0201632:	ebbfe0ef          	jal	ra,ffffffffc02004ec <intr_enable>
        swap_out(check_mm_struct, n, 0);
...
ffffffffc0201670:	84ae                	mv	s1,a1
        intr_disable();
ffffffffc0201672:	e81fe0ef          	jal	ra,ffffffffc02004f2 <intr_disable>
    { pmm_manager->free_pages(base, n); }
...
ffffffffc020168c:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc020168e:	e5ffe06f          	j	ffffffffc02004ec <intr_enable>
...
ffffffffc02016aa:	e022                	sd	s0,0(sp)
        intr_disable();
ffffffffc02016ac:	e47fe0ef          	jal	ra,ffffffffc02004f2 <intr_disable>
    { ret = pmm_manager->nr_free_pages(); }
...
ffffffffc02016bc:	842a                	mv	s0,a0
        intr_enable();
ffffffffc02016be:	e2ffe0ef          	jal	ra,ffffffffc02004ec <intr_enable>
    local_intr_restore(intr_flag);
    return ret;
}
...
ffffffffc0201872:	b07fe0ef          	jal	ra,ffffffffc0200378 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
...
ffffffffc020188a:	aeffe0ef          	jal	ra,ffffffffc0200378 <__panic>
    	memset(KADDR(pa), 0, PGSIZE);
...
ffffffffc02018a4:	ad5fe0ef          	jal	ra,ffffffffc0200378 <__panic>
        memset(KADDR(pa), 0, PGSIZE);
...
ffffffffc02018be:	abbfe0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc0201998:	b5bfe0ef          	jal	ra,ffffffffc02004f2 <intr_disable>
...
ffffffffc02019aa:	9782                	jalr	a5
        intr_enable();
ffffffffc02019ac:	b41fe0ef          	jal	ra,ffffffffc02004ec <intr_enable>
...
ffffffffc0201a92:	bfd9                	j	ffffffffc0201a68 <page_insert+0xb2>
        intr_disable();
ffffffffc0201a94:	a5ffe0ef          	jal	ra,ffffffffc02004f2 <intr_disable>
...
ffffffffc0201aa6:	9782                	jalr	a5
        intr_enable();
ffffffffc0201aa8:	a45fe0ef          	jal	ra,ffffffffc02004ec <intr_enable>
...
ffffffffc0201aec:	e86a                	sd	s10,16(sp)
    cprintf("memory management: %s\n", pmm_manager->name);
ffffffffc0201aee:	dd0fe0ef          	jal	ra,ffffffffc02000be <cprintf>
    pmm_manager->init();
...
ffffffffc0201b28:	00f9b023          	sd	a5,0(s3)
    cprintf("membegin %llx memend %llx mem_size %llx\n",mem_begin, mem_end, mem_size);
ffffffffc0201b2c:	d92fe0ef          	jal	ra,ffffffffc02000be <cprintf>
...
ffffffffc0201b38:	d86fe0ef          	jal	ra,ffffffffc02000be <cprintf>
...
ffffffffc0201bde:	ce0fe0ef          	jal	ra,ffffffffc02000be <cprintf>
    boot_pgdir = (pte_t*)boot_page_table_sv39;
...
ffffffffc0201ea6:	a18fe0ef          	jal	ra,ffffffffc02000be <cprintf>
...
ffffffffc02020a0:	6165                	addi	sp,sp,112
    cprintf("check_boot_pgdir() succeeded!\n");
ffffffffc02020a2:	81cfe06f          	j	ffffffffc02000be <cprintf>
...
ffffffffc02020d6:	bcc5                	j	ffffffffc0201bc6 <pmm_init+0x110>
        intr_disable();
ffffffffc02020d8:	c1afe0ef          	jal	ra,ffffffffc02004f2 <intr_disable>
    { ret = pmm_manager->nr_free_pages(); }
...
ffffffffc02020e4:	842a                	mv	s0,a0
        intr_enable();
ffffffffc02020e6:	c06fe0ef          	jal	ra,ffffffffc02004ec <intr_enable>
ffffffffc02020ea:	b63d                	j	ffffffffc0201c18 <pmm_init+0x162>
        intr_disable();
ffffffffc02020ec:	c06fe0ef          	jal	ra,ffffffffc02004f2 <intr_disable>
...
ffffffffc02020f8:	8c2a                	mv	s8,a0
        intr_enable();
ffffffffc02020fa:	bf2fe0ef          	jal	ra,ffffffffc02004ec <intr_enable>
ffffffffc02020fe:	b3c1                	j	ffffffffc0201ebe <pmm_init+0x408>
        intr_disable();
ffffffffc0202100:	bf2fe0ef          	jal	ra,ffffffffc02004f2 <intr_disable>
...
ffffffffc020210c:	8a2a                	mv	s4,a0
        intr_enable();
ffffffffc020210e:	bdefe0ef          	jal	ra,ffffffffc02004ec <intr_enable>
ffffffffc0202112:	b361                	j	ffffffffc0201e9a <pmm_init+0x3e4>
ffffffffc0202114:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0202116:	bdcfe0ef          	jal	ra,ffffffffc02004f2 <intr_disable>
    { pmm_manager->free_pages(base, n); }
...
ffffffffc0202124:	9782                	jalr	a5
        intr_enable();
ffffffffc0202126:	bc6fe0ef          	jal	ra,ffffffffc02004ec <intr_enable>
ffffffffc020212a:	bb91                	j	ffffffffc0201e7e <pmm_init+0x3c8>
ffffffffc020212c:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc020212e:	bc4fe0ef          	jal	ra,ffffffffc02004f2 <intr_disable>
...
ffffffffc020213c:	9782                	jalr	a5
        intr_enable();
ffffffffc020213e:	baefe0ef          	jal	ra,ffffffffc02004ec <intr_enable>
ffffffffc0202142:	b319                	j	ffffffffc0201e48 <pmm_init+0x392>
        intr_disable();
ffffffffc0202144:	baefe0ef          	jal	ra,ffffffffc02004f2 <intr_disable>
    { ret = pmm_manager->nr_free_pages(); }
...
ffffffffc0202150:	842a                	mv	s0,a0
        intr_enable();
ffffffffc0202152:	b9afe0ef          	jal	ra,ffffffffc02004ec <intr_enable>
ffffffffc0202156:	b71d                	j	ffffffffc020207c <pmm_init+0x5c6>
ffffffffc0202158:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc020215a:	b98fe0ef          	jal	ra,ffffffffc02004f2 <intr_disable>
    { pmm_manager->free_pages(base, n); }
...
ffffffffc0202168:	9782                	jalr	a5
        intr_enable();
ffffffffc020216a:	b82fe0ef          	jal	ra,ffffffffc02004ec <intr_enable>
ffffffffc020216e:	bdcd                	j	ffffffffc0202060 <pmm_init+0x5aa>
ffffffffc0202170:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0202172:	b80fe0ef          	jal	ra,ffffffffc02004f2 <intr_disable>
...
ffffffffc0202180:	9782                	jalr	a5
        intr_enable();
ffffffffc0202182:	b6afe0ef          	jal	ra,ffffffffc02004ec <intr_enable>
ffffffffc0202186:	b555                	j	ffffffffc020202a <pmm_init+0x574>
        intr_disable();
ffffffffc0202188:	b6afe0ef          	jal	ra,ffffffffc02004f2 <intr_disable>
...
ffffffffc0202196:	9782                	jalr	a5
        intr_enable();
ffffffffc0202198:	b54fe0ef          	jal	ra,ffffffffc02004ec <intr_enable>
...
ffffffffc02021ba:	9befe0ef          	jal	ra,ffffffffc0200378 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
...
ffffffffc02021da:	99efe0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc02021f4:	984fe0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc0202210:	968fe0ef          	jal	ra,ffffffffc0200378 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
...
ffffffffc0202228:	950fe0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
...
ffffffffc0202248:	930fe0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
...
ffffffffc0202268:	910fe0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc020228c:	8ecfe0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
...
ffffffffc02022ac:	8ccfe0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
...
ffffffffc02022cc:	8acfe0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
...
ffffffffc0202346:	832fe0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
...
ffffffffc0202366:	812fe0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(page_ref(p2) == 0);
...
ffffffffc0202386:	ff3fd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(page_ref(p1) == 2);
...
ffffffffc02024de:	e9bfd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
...
ffffffffc02024fe:	e7bfd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(page_ref(p2) == 0);
...
ffffffffc020251e:	e5bfd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(page_ref(p1) == 0);
...
ffffffffc0202616:	d63fd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(page_ref(p1) == 1);
...
ffffffffc0202636:	d43fd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
...
ffffffffc0202656:	d23fd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(strlen((const char *)0x100) == 0);
...
ffffffffc020273c:	c3dfd0ef          	jal	ra,ffffffffc0200378 <__panic>
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc020275a:	bf69                	j	ffffffffc02026f4 <pgdir_alloc_page+0x34>
        intr_disable();
ffffffffc020275c:	d97fd0ef          	jal	ra,ffffffffc02004f2 <intr_disable>
    { pmm_manager->free_pages(base, n); }
...
ffffffffc0202770:	4401                	li	s0,0
        intr_enable();
ffffffffc0202772:	d7bfd0ef          	jal	ra,ffffffffc02004ec <intr_enable>
...
ffffffffc02027f4:	b85fd0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc020280e:	b6bfd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(base != NULL);
...
ffffffffc020282e:	b4bfd0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc02028a0:	c53fd0ef          	jal	ra,ffffffffc02004f2 <intr_disable>
...
ffffffffc02028b6:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc02028b8:	c35fd06f          	j	ffffffffc02004ec <intr_enable>
...
ffffffffc02028d6:	aa3fd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(ptr != NULL);
...
ffffffffc02028f6:	a83fd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(n > 0 && n < 1024 * 0124);
...
ffffffffc0202916:	a63fd0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc02029a8:	baf72623          	sw	a5,-1108(a4) # ffffffffc0211550 <swap_init_ok>
          cprintf("SWAP: manager = %s\n", sm->name);
ffffffffc02029ac:	f12fd0ef          	jal	ra,ffffffffc02000be <cprintf>
...
ffffffffc02029e8:	ed6fd0ef          	jal	ra,ffffffffc02000be <cprintf>
...
ffffffffc0202a5c:	e62fd0ef          	jal	ra,ffffffffc02000be <cprintf>
...
ffffffffc0202ac8:	df6fd0ef          	jal	ra,ffffffffc02000be <cprintf>
...
ffffffffc0202c14:	caafd0ef          	jal	ra,ffffffffc02000be <cprintf>
...
ffffffffc0202c66:	c58fd0ef          	jal	ra,ffffffffc02000be <cprintf>
     //assert(count == 0);
...
ffffffffc0202c98:	ee0fd0ef          	jal	ra,ffffffffc0200378 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
...
ffffffffc0202cb8:	ec0fd0ef          	jal	ra,ffffffffc0200378 <__panic>
        panic("pte2page called with invalid pte");
...
ffffffffc0202cd0:	ea8fd0ef          	jal	ra,ffffffffc0200378 <__panic>
        panic("pa2page called with invalid pa");
...
ffffffffc0202d40:	e38fd0ef          	jal	ra,ffffffffc0200378 <__panic>
         assert(check_ptep[i] != NULL);
...
ffffffffc0202d60:	e18fd0ef          	jal	ra,ffffffffc0200378 <__panic>
     assert(pgfault_num==4);
...
ffffffffc0202d80:	df8fd0ef          	jal	ra,ffffffffc0200378 <__panic>
     assert(pgfault_num==4);
...
ffffffffc02030ac:	accfd0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc02030f2:	fcdfc0ef          	jal	ra,ffffffffc02000be <cprintf>
}
...
ffffffffc0203126:	a52fd0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc0203202:	09100593          	li	a1,145
...
ffffffffc020320e:	96afd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(pgfault_num==6);
...
ffffffffc0203222:	0a800593          	li	a1,168
...
ffffffffc020322e:	94afd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
...
ffffffffc0203242:	0a600593          	li	a1,166
...
ffffffffc020324e:	92afd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(pgfault_num==5);
...
ffffffffc0203262:	0a500593          	li	a1,165
...
ffffffffc020326e:	90afd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(pgfault_num==5);
...
ffffffffc0203282:	0a300593          	li	a1,163
...
ffffffffc020328e:	8eafd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(pgfault_num==5);
...
ffffffffc02032a2:	0a100593          	li	a1,161
...
ffffffffc02032ae:	8cafd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(pgfault_num==5);
...
ffffffffc02032c2:	09f00593          	li	a1,159
...
ffffffffc02032ce:	8aafd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(pgfault_num==5);
...
ffffffffc02032e2:	09d00593          	li	a1,157
...
ffffffffc02032ee:	88afd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(pgfault_num==5);
...
ffffffffc0203302:	09b00593          	li	a1,155
...
ffffffffc020330e:	86afd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(pgfault_num==5);
...
ffffffffc0203322:	09900593          	li	a1,153
...
ffffffffc020332e:	84afd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(pgfault_num==4);
...
ffffffffc0203342:	09700593          	li	a1,151
...
ffffffffc020334e:	82afd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(pgfault_num==4);
...
ffffffffc0203362:	09500593          	li	a1,149
...
ffffffffc020336e:	80afd0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(pgfault_num==4);
...
ffffffffc0203382:	09300593          	li	a1,147
...
ffffffffc020338e:	febfc0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc02033b4:	89b2                	mv	s3,a2
      cprintf("curr_ptr %p\n",curr_ptr);
ffffffffc02033b6:	d09fc0ef          	jal	ra,ffffffffc02000be <cprintf>
        cprintf("head %p\n",head);
...
ffffffffc0203410:	caffc0ef          	jal	ra,ffffffffc02000be <cprintf>
            list_del(curr_ptr);
...
ffffffffc020344a:	f2ffc0ef          	jal	ra,ffffffffc0200378 <__panic>
         assert(head != NULL);
...
ffffffffc020346a:	f0ffc0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc0203476:	c7658593          	addi	a1,a1,-906 # ffffffffc02110e8 <pra_list_head1>
...
ffffffffc020348c:	0cb7b823          	sd	a1,208(a5) # ffffffffc0211558 <curr_ptr>
     cprintf(" mm->sm_priv %x in f_mm\n",mm->sm_priv);
ffffffffc0203490:	c2ffc0ef          	jal	ra,ffffffffc02000be <cprintf>
}
...
ffffffffc02034d0:	03600593          	li	a1,54
...
ffffffffc02034dc:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02034de:	e9bfc0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc0203500:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc0203502:	e77fc0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc0203648:	d31fc0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(prev->vm_end <= next->vm_start);
...
ffffffffc0203668:	d11fc0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(prev->vm_start < prev->vm_end);
...
ffffffffc0203688:	cf1fc0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc02037a6:	bd3fc0ef          	jal	ra,ffffffffc0200378 <__panic>
    return listelm->next;
...
ffffffffc0203866:	859fc0ef          	jal	ra,ffffffffc02000be <cprintf>
        }
...
ffffffffc0203886:	af3fc0ef          	jal	ra,ffffffffc0200378 <__panic>
    for (i =4; i>=0; i--) {
...
ffffffffc02038c4:	ffafc0ef          	jal	ra,ffffffffc02000be <cprintf>
...
ffffffffc0203a06:	eb8fc0ef          	jal	ra,ffffffffc02000be <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
...
ffffffffc0203a2e:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203a30:	e8efc06f          	j	ffffffffc02000be <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
...
ffffffffc0203a56:	923fc0ef          	jal	ra,ffffffffc0200378 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
...
ffffffffc0203a76:	903fc0ef          	jal	ra,ffffffffc0200378 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
...
ffffffffc0203a96:	8e3fc0ef          	jal	ra,ffffffffc0200378 <__panic>
        assert(le != &(mm->mmap_list));
...
ffffffffc0203ab6:	8c3fc0ef          	jal	ra,ffffffffc0200378 <__panic>
        assert(vma1 != NULL);
...
ffffffffc0203ad6:	8a3fc0ef          	jal	ra,ffffffffc0200378 <__panic>
        assert(vma2 != NULL);
...
ffffffffc0203af6:	883fc0ef          	jal	ra,ffffffffc0200378 <__panic>
        assert(vma3 == NULL);
...
ffffffffc0203b16:	863fc0ef          	jal	ra,ffffffffc0200378 <__panic>
        assert(vma4 == NULL);
...
ffffffffc0203b36:	843fc0ef          	jal	ra,ffffffffc0200378 <__panic>
        assert(vma5 == NULL);
...
ffffffffc0203b56:	823fc0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(pgdir[0] == 0);
...
ffffffffc0203b76:	803fc0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(check_mm_struct != NULL);
...
ffffffffc0203b9a:	9c07b523          	sd	zero,-1590(a5) # ffffffffc0211560 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203b9e:	fdafc0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(vma != NULL);
...
ffffffffc0203bbe:	fbafc0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(find_vma(mm, addr) == vma);
...
ffffffffc0203bde:	f9afc0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(sum == 0);
...
ffffffffc0203bfe:	f7afc0ef          	jal	ra,ffffffffc0200378 <__panic>
        panic("pa2page called with invalid pa");
...
ffffffffc0203c16:	f62fc0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
...
ffffffffc0203c36:	f42fc0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
...
ffffffffc0203c56:	f22fc0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(mm != NULL);
...
ffffffffc0203c76:	f02fc0ef          	jal	ra,ffffffffc0200378 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
...
ffffffffc0203c96:	ee2fc0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc0203d3e:	b80fc0ef          	jal	ra,ffffffffc02000be <cprintf>
    ret = -E_NO_MEM;
...
ffffffffc0203d50:	b6efc0ef          	jal	ra,ffffffffc02000be <cprintf>
    int ret = -E_INVAL;
...
ffffffffc0203d60:	b5efc0ef          	jal	ra,ffffffffc02000be <cprintf>
    ret = -E_NO_MEM;
...
ffffffffc0203d6c:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203d6e:	f2afc0ef          	jal	ra,ffffffffc0200498 <ide_device_valid>
ffffffffc0203d72:	cd01                	beqz	a0,ffffffffc0203d8a <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203d74:	4505                	li	a0,1
ffffffffc0203d76:	f28fc0ef          	jal	ra,ffffffffc020049e <ide_device_size>
}
...
ffffffffc0203d9c:	ddcfc0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc0203e02:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e04:	ea0fc06f          	j	ffffffffc02004a4 <ide_read_secs>
...
ffffffffc0203e1c:	d5cfc0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc0203e36:	d42fc0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc0203e9c:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e9e:	e2afc06f          	j	ffffffffc02004c8 <ide_write_secs>
...
ffffffffc0203eb6:	cc2fc0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc0203ed0:	ca8fc0ef          	jal	ra,ffffffffc0200378 <__panic>
...
ffffffffc02042e0:	ddffb0ef          	jal	ra,ffffffffc02000be <cprintf>
readline(const char *prompt) {
...
ffffffffc02042f6:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc02042fa:	dfdfb0ef          	jal	ra,ffffffffc02000f6 <getchar>
        if (c < 0) {
...
ffffffffc0204306:	029a5263          	bge	s4,s1,ffffffffc020432a <readline+0x68>
        c = getchar();
ffffffffc020430a:	dedfb0ef          	jal	ra,ffffffffc02000f6 <getchar>
        if (c < 0) {
...
ffffffffc020431a:	e8a9                	bnez	s1,ffffffffc020436c <readline+0xaa>
        c = getchar();
ffffffffc020431c:	ddbfb0ef          	jal	ra,ffffffffc02000f6 <getchar>
        if (c < 0) {
...
ffffffffc020432c:	dc9fb0ef          	jal	ra,ffffffffc02000f4 <cputchar>
            buf[i ++] = c;
...
ffffffffc0204342:	fb651ce3          	bne	a0,s6,ffffffffc02042fa <readline+0x38>
            cputchar(c);
ffffffffc0204346:	daffb0ef          	jal	ra,ffffffffc02000f4 <cputchar>
            buf[i] = '\0';
...
ffffffffc020436e:	d87fb0ef          	jal	ra,ffffffffc02000f4 <cputchar>
            i --;
